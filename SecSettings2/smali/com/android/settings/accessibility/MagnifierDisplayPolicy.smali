...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/android/settings/accessibility/MagnifierDisplayPolicy$DisplayInfo;

    invoke-direct {v0}, Lcom/android/settings/accessibility/MagnifierDisplayPolicy$DisplayInfo;-><init>()V

    iput-object v0, p0, Lcom/android/settings/accessibility/MagnifierDisplayPolicy;->mLastDisplayInfo:Lcom/android/settings/accessibility/MagnifierDisplayPolicy$DisplayInfo;

    iput v1, p0, Lcom/android/settings/accessibility/MagnifierDisplayPolicy;->mDefaultWidth:I

    iput v1, p0, Lcom/android/settings/accessibility/MagnifierDisplayPolicy;->mDefaultHeight:I
    ...
    iput v0, p0, Lcom/android/settings/accessibility/MagnifierDisplayPolicy;->mScale:F

    iput v2, p0, Lcom/android/settings/accessibility/MagnifierDisplayPolicy;->mPointerMargin:F

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/settings/accessibility/MagnifierDisplayPolicy;->mOnSizeChangeListener:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/settings/accessibility/MagnifierDisplayPolicy;->mDisplayMetrics:Landroid/util/DisplayMetrics;

    new-instance v0, Lcom/android/settings/accessibility/MagnifierDisplayPolicy$1;

    new-instance v2, Landroid/os/Handler;

    invoke-direct {v2}, Landroid/os/Handler;-><init>()V

    invoke-direct {v0, p0, v2}, Lcom/android/settings/accessibility/MagnifierDisplayPolicy$1;-><init>(Lcom/android/settings/accessibility/MagnifierDisplayPolicy;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/settings/accessibility/MagnifierDisplayPolicy;->mHoverZoomObserver:Landroid/database/ContentObserver;
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/settings/accessibility/MagnifierDisplayPolicy;->mIsHoverZoom:Z
    ...
    iget-object v3, p0, Lcom/android/settings/accessibility/MagnifierDisplayPolicy;->mHoverZoomObserver:Landroid/database/ContentObserver;
    ...
    iput v0, p0, Lcom/android/settings/accessibility/MagnifierDisplayPolicy;->mPointerSize:I
