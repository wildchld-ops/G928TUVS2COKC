...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v3, p0, Lcom/android/settings/AppPicker$AppListAdapter;->this$0:Lcom/android/settings/AppPicker;

    invoke-virtual {v3}, Lcom/android/settings/AppPicker;->getLayoutInflater()Landroid/view/LayoutInflater;
    ...
    new-instance v0, Lcom/android/settings/AppPicker$ViewHolder;

    invoke-direct {v0}, Lcom/android/settings/AppPicker$ViewHolder;-><init>()V
    ...
    iput-object v3, v0, Lcom/android/settings/AppPicker$ViewHolder;->appName:Landroid/widget/TextView;
    ...
    iput-object v3, v0, Lcom/android/settings/AppPicker$ViewHolder;->packageName:Landroid/widget/TextView;
    ...
    iput-object v3, v0, Lcom/android/settings/AppPicker$ViewHolder;->appIcon:Landroid/widget/ImageView;
    ...
    check-cast v2, Lcom/android/settings/AppPicker$MyApplicationInfo;

    iget-object v3, v0, Lcom/android/settings/AppPicker$ViewHolder;->appName:Landroid/widget/TextView;

    iget-object v4, v2, Lcom/android/settings/AppPicker$MyApplicationInfo;->label:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v3, v2, Lcom/android/settings/AppPicker$MyApplicationInfo;->info:Landroid/content/pm/ApplicationInfo;

    if-eqz v3, :cond_1

    iget-object v3, v0, Lcom/android/settings/AppPicker$ViewHolder;->appIcon:Landroid/widget/ImageView;

    invoke-virtual {v3, v5}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object v3, v0, Lcom/android/settings/AppPicker$ViewHolder;->packageName:Landroid/widget/TextView;
    ...
    iget-object v5, p0, Lcom/android/settings/AppPicker$AppListAdapter;->this$0:Lcom/android/settings/AppPicker;
    ...
    check-cast v0, Lcom/android/settings/AppPicker$ViewHolder;
