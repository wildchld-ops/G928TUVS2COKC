...
.method private handleAuthSuccess(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, p2, v4, v7, v7}, Lcom/android/internal/widget/LockPatternUtils;->saveLockPassword(Ljava/lang/String;IZZ)V
...
.method private validatePassword(Ljava/lang/String;)Ljava/lang/String;
    ...
    const v8, 0x7f0a1048    # 1.83518E38f
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v5, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mContext:Landroid/content/Context;

    invoke-direct {v4, v5}, Lcom/android/internal/widget/LockPatternUtils;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    iget-object v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mContext:Landroid/content/Context;

    invoke-static {v4}, Landroid/app/enterprise/sso/GenericSSO;->getInstance(Landroid/content/Context;)Landroid/app/enterprise/sso/GenericSSO;

    move-result-object v4

    iput-object v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mGenericSSO:Landroid/app/enterprise/sso/GenericSSO;
    ...
    iput-object v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mAlarmManager:Landroid/app/AlarmManager;
    ...
    const-string v4, "enterprise.password_old"

    invoke-virtual {v3, v4}, Landroid/content/Intent;->getStringExtra(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iput-object v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mOldEnterprisePassword:Ljava/lang/String;
    ...
    iput-boolean v8, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mIsPasswordChangeEnforced:Z
    ...
    const-string v6, "ChooseLockEnterpriseIdentity: userHandle:"
    ...
    iget v5, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mRequestedQuality:I

    invoke-virtual {v3, v4, v5}, Landroid/content/Intent;->getIntExtra(Ljava/lang/String;I)I

    move-result v4

    iget-object v5, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    iput v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mRequestedQuality:I

    const-string v4, "lockscreen.password_min"

    iget v5, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinLength:I
    ...
    iput v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinLength:I

    const-string v4, "lockscreen.password_max"

    iget v5, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMaxLength:I

    invoke-virtual {v3, v4, v5}, Landroid/content/Intent;->getIntExtra(Ljava/lang/String;I)I

    move-result v4

    iput v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMaxLength:I

    const-string v4, "lockscreen.password_min_letters"

    iget v5, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinLetters:I
    ...
    iput v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinLetters:I

    const-string v4, "lockscreen.password_min_uppercase"

    iget v5, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinUpperCase:I
    ...
    iput v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinUpperCase:I

    const-string v4, "lockscreen.password_min_lowercase"

    iget v5, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinLowerCase:I
    ...
    iput v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinLowerCase:I

    const-string v4, "lockscreen.password_min_numeric"

    iget v5, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinNumeric:I
    ...
    iput v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinNumeric:I

    const-string v4, "lockscreen.password_min_symbols"

    iget v5, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinSymbols:I
    ...
    iput v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinSymbols:I

    const-string v4, "lockscreen.password_min_nonletter"

    iget v5, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinNonLetter:I
    ...
    iput v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinNonLetter:I

    iget-object v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;
    ...
    invoke-virtual {v2, v9}, Landroid/app/admin/DevicePolicyManager;->getSamsungEncryptionStatus(Landroid/content/ComponentName;)Z

    move-result v4

    if-eqz v4, :cond_1

    iget v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mRequestedQuality:I

    const/high16 v5, 0x20000

    if-ne v4, v5, :cond_7

    iput v7, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinLength:I
    ...
    iput-object v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mOldPassword:Ljava/lang/String;

    const/4 v0, 0x4

    iget v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMinLength:I
    ...
    iput-object v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;

    iget-object v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mEDM:Landroid/app/enterprise/EnterpriseDeviceManager;
    ...
    iput-object v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPwdPolicy:Landroid/app/enterprise/PasswordPolicy;

    :cond_3
    iget-object v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPwdPolicy:Landroid/app/enterprise/PasswordPolicy;

    if-eqz v4, :cond_4

    iget-object v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPwdPolicy:Landroid/app/enterprise/PasswordPolicy;

    invoke-virtual {v4, v8}, Landroid/app/enterprise/PasswordPolicy;->getRequiredPwdPatternRestrictions(Z)Ljava/lang/String;

    move-result-object v4

    if-eqz v4, :cond_4

    iput-boolean v8, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->hasPwdPatternRestriction:Z
    ...
    :cond_5
    iget v4, p0, Lcom/android/settings/ChooseLockEnterpriseIdentity;->mPasswordMaxLength:I
    ...
    :cond_6
    new-instance v4, Lcom/android/settings/ChooseLockEnterpriseIdentity$PerformUserAuthTask;

    invoke-direct {v4, p0, v9}, Lcom/android/settings/ChooseLockEnterpriseIdentity$PerformUserAuthTask;-><init>(Lcom/android/settings/ChooseLockEnterpriseIdentity;Lcom/android/settings/ChooseLockEnterpriseIdentity$1;)V
    ...
    invoke-virtual {v4, v5}, Lcom/android/settings/ChooseLockEnterpriseIdentity$PerformUserAuthTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
