...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/android/settings/dashboard/DashboardTileView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/android/settings/dashboard/DashboardTileView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {p0, p1}, Lcom/android/settings/dashboard/DashboardTileView;->init(Landroid/content/Context;)V
...
.method private init(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/dashboard/DashboardTileView;->setFocusable(Z)V
...
.method public showOnlineHelpDialog()V
    ...
    iput-object v5, p0, Lcom/android/settings/dashboard/DashboardTileView;->mContext:Landroid/content/Context;

    iget-object v5, p0, Lcom/android/settings/dashboard/DashboardTileView;->mContext:Landroid/content/Context;
    ...
    iput-object v5, p0, Lcom/android/settings/dashboard/DashboardTileView;->sharedPreference:Landroid/content/SharedPreferences;

    iget-object v5, p0, Lcom/android/settings/dashboard/DashboardTileView;->sharedPreference:Landroid/content/SharedPreferences;
    ...
    new-instance v7, Lcom/android/settings/dashboard/DashboardTileView$3;

    invoke-direct {v7, p0, v0, v3}, Lcom/android/settings/dashboard/DashboardTileView$3;-><init>(Lcom/android/settings/dashboard/DashboardTileView;Landroid/widget/CheckBox;Landroid/content/SharedPreferences$Editor;)V
    ...
    new-instance v7, Lcom/android/settings/dashboard/DashboardTileView$2;

    invoke-direct {v7, p0}, Lcom/android/settings/dashboard/DashboardTileView$2;-><init>(Lcom/android/settings/dashboard/DashboardTileView;)V

    invoke-virtual {v5, v6, v7}, Landroid/app/AlertDialog$Builder;->setNegativeButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    move-result-object v5

    new-instance v6, Lcom/android/settings/dashboard/DashboardTileView$1;

    invoke-direct {v6, p0}, Lcom/android/settings/dashboard/DashboardTileView$1;-><init>(Lcom/android/settings/dashboard/DashboardTileView;)V
