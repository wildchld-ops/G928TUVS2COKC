...
.method public run()V
    ...
    # getter for: Lcom/android/settings/LockscreenNotificationApplist;->mLauncherApps:Landroid/content/pm/LauncherApps;
    invoke-static/range {v24 .. v24}, Lcom/android/settings/LockscreenNotificationApplist;->access$900(Lcom/android/settings/LockscreenNotificationApplist;)Landroid/content/pm/LauncherApps;
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/settings/LockscreenNotificationApplist;->access$1000(Lcom/android/settings/LockscreenNotificationApplist;)Landroid/content/pm/PackageManager;

    move-result-object v24

    invoke-static/range {v24 .. v24}, Lcom/android/settings/LockscreenNotificationApplist;->queryNotificationConfigActivities(Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    # getter for: Lcom/android/settings/LockscreenNotificationApplist;->excludeKnoxApp:[Ljava/lang/String;
    invoke-static/range {v24 .. v24}, Lcom/android/settings/LockscreenNotificationApplist;->access$1100(Lcom/android/settings/LockscreenNotificationApplist;)[Ljava/lang/String;
    ...
    # getter for: Lcom/android/settings/LockscreenNotificationApplist;->mHideApp:Z
    invoke-static/range {v24 .. v24}, Lcom/android/settings/LockscreenNotificationApplist;->access$1200(Lcom/android/settings/LockscreenNotificationApplist;)Z
    ...
    # getter for: Lcom/android/settings/LockscreenNotificationApplist;->hide_app_notification_list:[Ljava/lang/String;
    invoke-static/range {v24 .. v24}, Lcom/android/settings/LockscreenNotificationApplist;->access$1300(Lcom/android/settings/LockscreenNotificationApplist;)[Ljava/lang/String;
    ...
    invoke-static {v0, v1, v2}, Lcom/android/settings/LockscreenNotificationApplist;->applyConfigActivities(Landroid/content/pm/PackageManager;Landroid/util/ArrayMap;Ljava/util/List;)V
    ...
    # getter for: Lcom/android/settings/LockscreenNotificationApplist;->mRowComparator:Ljava/util/Comparator;
    invoke-static {}, Lcom/android/settings/LockscreenNotificationApplist;->access$1400()Ljava/util/Comparator;
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/settings/LockscreenNotificationApplist;->access$1500(Lcom/android/settings/LockscreenNotificationApplist;)Ljava/util/ArrayList;
    ...
    check-cast v17, Lcom/android/settings/LockscreenNotificationApplist$AppRow;
    ...
    invoke-static {v0, v1}, Lcom/android/settings/LockscreenNotificationApplist;->access$1600(Lcom/android/settings/LockscreenNotificationApplist;Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/settings/LockscreenNotificationApplist;->access$1800(Lcom/android/settings/LockscreenNotificationApplist;)Landroid/os/Handler;
    ...
    invoke-static/range {v26 .. v26}, Lcom/android/settings/LockscreenNotificationApplist;->access$1700(Lcom/android/settings/LockscreenNotificationApplist;)Ljava/lang/Runnable;
