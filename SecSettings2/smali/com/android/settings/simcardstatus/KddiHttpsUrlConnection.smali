.class public Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection$RequestBodyPart;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;->TAG:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;->mIsSucceed:Z
...
.method static synthetic access$000()Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;->TAG:Ljava/lang/String;
...
.method private static processResponseBodyPart(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    sget-object v6, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;->TAG:Ljava/lang/String;

    const-string v7, "process return body part()"
    ...
    const-string v7, "no response body part available"
    ...
    invoke-static {p0}, Lcom/android/settings/simcardstatus/SimStatusUtils;->copyRemainingByteBuffer(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
...
.method private static readInputStream(Ljava/io/InputStream;)Ljava/nio/ByteBuffer;
    ...
    sget-object v5, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;->TAG:Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/android/settings/simcardstatus/SimStatusUtils;->closeSilently(Ljava/io/Closeable;)V
...
.method public isSucceed()Z
    ...
    iget-boolean v0, p0, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;->mIsSucceed:Z
...
.method public post(Landroid/content/Context;)Ljava/nio/ByteBuffer;
    ...
    sget-object v10, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;->TAG:Ljava/lang/String;
    ...
    invoke-static {}, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;->getAuthorizationValue()Ljava/lang/String;
    ...
    invoke-static {}, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;->getUserAgentValue()Ljava/lang/String;
    ...
    :try_start_1
    invoke-static {p1}, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection$RequestBodyPart;->build(Landroid/content/Context;)[B
    ...
    invoke-static {v10}, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;->readInputStream(Ljava/io/InputStream;)Ljava/nio/ByteBuffer;

    move-result-object v4

    invoke-static {v4}, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;->processResponseBodyPart(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    iput-boolean v10, p0, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;->mIsSucceed:Z
    ...
    iget-boolean v12, p0, Lcom/android/settings/simcardstatus/KddiHttpsUrlConnection;->mIsSucceed:Z
