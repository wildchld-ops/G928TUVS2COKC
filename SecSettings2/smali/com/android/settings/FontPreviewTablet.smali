...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/android/settings/FontPreviewTablet;->mSelectedFontStyleItemIndex:I

    iput v0, p0, Lcom/android/settings/FontPreviewTablet;->mPreviousFont:I
...
.method static synthetic access$500(Lcom/android/settings/FontPreviewTablet;)V
    .locals 0
...
.method static synthetic access$600(Lcom/android/settings/FontPreviewTablet;)Landroid/content/Context;
    .locals 1
...
.method private changeFontSizeFromSeekBar(I)V
    ...
    iput p1, p0, Lcom/android/settings/FontPreviewTablet;->mSelectedFontSizeSeekBarProgress:I
...
.method private doneFontPreview()V
    ...
    :cond_1
    iget v0, p0, Lcom/android/settings/FontPreviewTablet;->mSelectedFontSizeSeekBarProgress:I
...
.method private doneFontSize()V
    ...
    const-string v3, "FontNewStyleDialog"
...
.method private setAccessiblityFontSizeView(Z)V
    ...
    :goto_1
    invoke-direct {p0, v3}, Lcom/android/settings/FontPreviewTablet;->setDim(Z)V
...
.method private setDim(Z)V
    ...
    iget-object v1, p0, Lcom/android/settings/FontPreviewTablet;->mMaxTextView:Landroid/widget/TextView;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/settings/FontPreviewTablet;->mMinTextView:Landroid/widget/TextView;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/settings/FontPreviewTablet;->mFontSizeTextView:Lcom/android/settings/widget/CategoryTextView;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/settings/FontPreviewTablet;->mShowForHugeFontTextView:Landroid/widget/TextView;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/settings/FontPreviewTablet;->mFontSizeSeekBar:Lcom/android/settings/IntervalSeekBar;
    ...
    iget-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mMaxTextView:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mExtraHugeString:Ljava/lang/String;

    invoke-virtual {v1, v2}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Lcom/android/settings/FontPreviewTablet;->mMinTextView:Landroid/widget/TextView;

    iget-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mMinTextView:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mFontSizeTextView:Lcom/android/settings/widget/CategoryTextView;
    ...
    sget v2, Lcom/android/settings/FontPreviewTablet;->DUAL_COLOR_FOR_ELEVENLEVEL_FONT_VALUE:I
    ...
    iget-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mHugeString:Ljava/lang/String;
...
.method private setFontsizeLayoutSevenOrEleven(Z)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/settings/FontPreviewTablet;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v3}, Lcom/android/settings/FontPreviewTablet;->findViewById(I)Landroid/view/View;

    move-result-object v2

    check-cast v2, Landroid/widget/TextView;

    iput-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mShowForHugeFontTextView:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mMinTextView:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mMaxTextView:Landroid/widget/TextView;
    ...
    iput-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mHugeString:Ljava/lang/String;
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/settings/FontPreviewTablet;->getString(I[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mExtraHugeString:Ljava/lang/String;
    ...
    check-cast v2, Lcom/android/settings/widget/CategoryTextView;

    iput-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mFontSizeTextView:Lcom/android/settings/widget/CategoryTextView;
    ...
    iput-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mFontSizeSeekBar:Lcom/android/settings/IntervalSeekBar;
    ...
    invoke-virtual {v2, v3}, Lcom/android/settings/IntervalSeekBar;->setProgressDrawable(Landroid/graphics/drawable/Drawable;)V

    iget-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mFontSizeSeekBar:Lcom/android/settings/IntervalSeekBar;

    sget v3, Lcom/android/settings/FontPreviewTablet;->DUAL_COLOR_FOR_ELEVENLEVEL_FONT_VALUE:I

    invoke-virtual {v2, v3}, Lcom/android/settings/IntervalSeekBar;->setOverlapPointForDualColor(I)V
    ...
    iget-object v3, p0, Lcom/android/settings/FontPreviewTablet;->mShowForHugeFontTextView:Landroid/widget/TextView;
    ...
    invoke-virtual {v2, v3}, Lcom/android/settings/IntervalSeekBar;->setMax(I)V
    ...
    iput-object v2, p0, Lcom/android/settings/FontPreviewTablet;->mChangingSizeText:Landroid/widget/TextView;
    ...
    iget-object v3, p0, Lcom/android/settings/FontPreviewTablet;->mExtraHugeString:Ljava/lang/String;
    ...
    invoke-direct {p0, v6}, Lcom/android/settings/FontPreviewTablet;->setDim(Z)V
...
.method private setReHeightFontStyleListview()V
    ...
    invoke-direct {v6, p0, v4}, Lcom/android/settings/FontPreviewTablet$2;-><init>(Lcom/android/settings/FontPreviewTablet;Landroid/widget/ScrollView;)V
...
.method private setSelectedFontStyle()V
    ...
    :goto_2
    const-string v2, "FontNewStyleDialog"
    ...
    iget v3, p0, Lcom/android/settings/FontPreviewTablet;->mSavedClickedItem:I
    ...
    const-string v4, "onPrepareDialogBuilder : MultiUser mPreviousFont / mSavedClickedItem : "
    ...
    iget v2, p0, Lcom/android/settings/FontPreviewTablet;->mSavedClickedItem:I
...
.method protected badFontDialog(Ljava/lang/String;)V
    ...
    new-instance v4, Lcom/android/settings/FontPreviewTablet$6;

    invoke-direct {v4, p0, v2}, Lcom/android/settings/FontPreviewTablet$6;-><init>(Lcom/android/settings/FontPreviewTablet;Ljava/lang/String;)V
...
.method protected checkFont(Ljava/lang/String;)Z
    ...
    sget-boolean v11, Lcom/android/settings/FontPreviewTablet;->DEBUG:Z
    ...
    :goto_1
    sget-object v11, Lcom/android/settings/FontPreviewTablet;->apkNameList:[Ljava/lang/String;
    ...
    :try_start_0
    iget-object v11, p0, Lcom/android/settings/FontPreviewTablet;->mFontListAdapter:Lcom/android/settings/flipfont/FontListAdapter;
...
.method public loadPreferences()V
    ...
    const-string v4, "FontNewStyleDialog"
...
.method public onCheckedChanged(Landroid/widget/CompoundButton;Z)V
    ...
    invoke-direct {p0, p2}, Lcom/android/settings/FontPreviewTablet;->setDim(Z)V
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lcom/android/settings/FontPreviewTablet;->mFontSwitch:Landroid/widget/Switch;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v5}, Lcom/android/settings/Utils;->getFontSize(Landroid/content/Context;)F
    ...
    :goto_0
    iput-boolean v5, p0, Lcom/android/settings/FontPreviewTablet;->mIsFont11Level:Z

    iget-boolean v5, p0, Lcom/android/settings/FontPreviewTablet;->mIsFont11Level:Z

    if-eqz v5, :cond_0

    iput v10, p0, Lcom/android/settings/FontPreviewTablet;->mExtraLargeFontIndex:I
    ...
    iput v5, p0, Lcom/android/settings/FontPreviewTablet;->mAccessFontOnOff:I

    iget v5, p0, Lcom/android/settings/FontPreviewTablet;->mAccessFontOnOff:I

    if-ne v5, v6, :cond_5

    iput-boolean v6, p0, Lcom/android/settings/FontPreviewTablet;->mIsFontLargerOn:Z
    ...
    iput-boolean v5, p0, Lcom/android/settings/FontPreviewTablet;->mIsAccessibilitySettingsVision:Z
    ...
    invoke-virtual {p0, v5}, Lcom/android/settings/FontPreviewTablet;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, v5}, Lcom/android/settings/FontPreviewTablet;->setFontsizeLayoutSevenOrEleven(Z)V
    ...
    invoke-direct {p0, v5}, Lcom/android/settings/FontPreviewTablet;->setAccessiblityFontSizeView(Z)V
    ...
    iput v5, p0, Lcom/android/settings/FontPreviewTablet;->mSelectedFontSize:I

    iget v5, p0, Lcom/android/settings/FontPreviewTablet;->mSelectedFontSize:I

    invoke-direct {p0, v5}, Lcom/android/settings/FontPreviewTablet;->changeFontSizeFromSeekBar(I)V

    iget-object v5, p0, Lcom/android/settings/FontPreviewTablet;->mFontSizeSeekBar:Lcom/android/settings/IntervalSeekBar;

    iget v8, p0, Lcom/android/settings/FontPreviewTablet;->mSelectedFontSize:I

    invoke-virtual {v5, v8}, Lcom/android/settings/IntervalSeekBar;->setProgress(I)V

    iget v5, p0, Lcom/android/settings/FontPreviewTablet;->mSelectedFontSize:I

    iget v8, p0, Lcom/android/settings/FontPreviewTablet;->mExtraLargeFontIndex:I
    ...
    iput-object v5, p0, Lcom/android/settings/FontPreviewTablet;->mSharedPreferences:Landroid/content/SharedPreferences;

    iget-object v5, p0, Lcom/android/settings/FontPreviewTablet;->mFontSizeSeekBar:Lcom/android/settings/IntervalSeekBar;

    new-instance v8, Lcom/android/settings/FontPreviewTablet$1;

    invoke-direct {v8, p0}, Lcom/android/settings/FontPreviewTablet$1;-><init>(Lcom/android/settings/FontPreviewTablet;)V

    invoke-virtual {v5, v8}, Lcom/android/settings/IntervalSeekBar;->setOnSeekBarChangeListener(Landroid/widget/SeekBar$OnSeekBarChangeListener;)V
    ...
    :cond_5
    iput-boolean v7, p0, Lcom/android/settings/FontPreviewTablet;->mIsFontLargerOn:Z

    const/4 v5, 0x5

    iput v5, p0, Lcom/android/settings/FontPreviewTablet;->mExtraLargeFontIndex:I
    ...
    iput-object v5, p0, Lcom/android/settings/FontPreviewTablet;->mFontStyleListView:Landroid/widget/ListView;

    iget-object v5, p0, Lcom/android/settings/FontPreviewTablet;->mFontStyleListView:Landroid/widget/ListView;
    ...
    iput-object v11, p0, Lcom/android/settings/FontPreviewTablet;->mFontListAdapter:Lcom/android/settings/flipfont/FontListAdapter;

    new-instance v5, Lcom/android/settings/FontPreviewTablet$LoadListTask;

    invoke-direct {v5, p0, v11}, Lcom/android/settings/FontPreviewTablet$LoadListTask;-><init>(Lcom/android/settings/FontPreviewTablet;Lcom/android/settings/FontPreviewTablet$1;)V

    iput-object v5, p0, Lcom/android/settings/FontPreviewTablet;->mLoadListTask:Lcom/android/settings/FontPreviewTablet$LoadListTask;

    iget-object v5, p0, Lcom/android/settings/FontPreviewTablet;->mLoadListTask:Lcom/android/settings/FontPreviewTablet$LoadListTask;

    new-array v6, v7, [Ljava/lang/Void;

    invoke-virtual {v5, v6}, Lcom/android/settings/FontPreviewTablet$LoadListTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    new-instance v2, Lcom/android/settings/FontPreviewTablet$3;

    invoke-direct {v2, p0}, Lcom/android/settings/FontPreviewTablet$3;-><init>(Lcom/android/settings/FontPreviewTablet;)V
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object v0, v0, Lcom/android/settings/FontPreviewTablet;->mContext:Landroid/content/Context;
    ...
    iget-object v0, v0, Lcom/android/settings/FontPreviewTablet;->themeFontTypeface:Landroid/graphics/Typeface;
    ...
    iget-object v0, v0, Lcom/android/settings/FontPreviewTablet;->mChangingSizeText:Landroid/widget/TextView;
    ...
    iput-boolean v0, v1, Lcom/android/settings/FontPreviewTablet;->mIsSelectedCurrentThemeFont:Z
    ...
    iput-object v0, v1, Lcom/android/settings/FontPreviewTablet;->mPackageName:Ljava/lang/String;
    ...
    invoke-virtual {v0, v4}, Lcom/android/settings/FontPreviewTablet;->checkFont(Ljava/lang/String;)Z

    move-result v16

    if-eqz v16, :cond_0

    sget-boolean v16, Lcom/android/settings/FontPreviewTablet;->DEBUG:Z
    ...
    invoke-virtual {v0, v4}, Lcom/android/settings/FontPreviewTablet;->badFontDialog(Ljava/lang/String;)V
    ...
    iput-object v0, v1, Lcom/android/settings/FontPreviewTablet;->mFontListAdapter:Lcom/android/settings/flipfont/FontListAdapter;
...
.method public readFontSizePreference()V
    ...
    const-string v1, "FontNewStyleDialog"
