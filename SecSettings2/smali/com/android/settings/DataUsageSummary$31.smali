...
.method public onCreateLoader(ILandroid/os/Bundle;)Landroid/content/Loader;
    ...
    iget-object v2, p0, Lcom/android/settings/DataUsageSummary$31;->this$0:Lcom/android/settings/DataUsageSummary;

    # getter for: Lcom/android/settings/DataUsageSummary;->mStatsSession:Landroid/net/INetworkStatsSession;
    invoke-static {v2}, Lcom/android/settings/DataUsageSummary;->access$5000(Lcom/android/settings/DataUsageSummary;)Landroid/net/INetworkStatsSession;
...
.method public onLoadFinished(Landroid/content/Loader;Lcom/android/settings/net/ChartData;)V
    ...
    invoke-static {v0, p2}, Lcom/android/settings/DataUsageSummary;->access$5102(Lcom/android/settings/DataUsageSummary;Lcom/android/settings/net/ChartData;)Lcom/android/settings/net/ChartData;

    iget-object v0, p0, Lcom/android/settings/DataUsageSummary$31;->this$0:Lcom/android/settings/DataUsageSummary;

    # getter for: Lcom/android/settings/DataUsageSummary;->mChart:Lcom/android/settings/widget/ChartDataUsageView;
    invoke-static {v0}, Lcom/android/settings/DataUsageSummary;->access$4800(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/widget/ChartDataUsageView;
    ...
    invoke-static {v1}, Lcom/android/settings/DataUsageSummary;->access$5100(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/net/ChartData;
    ...
    # getter for: Lcom/android/settings/DataUsageSummary;->mChartData:Lcom/android/settings/net/ChartData;
    invoke-static {v0}, Lcom/android/settings/DataUsageSummary;->access$5100(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/net/ChartData;
    ...
    invoke-static {v0}, Lcom/android/settings/DataUsageSummary;->access$5300(Lcom/android/settings/DataUsageSummary;)Landroid/widget/ListView;
...
.method public bridge synthetic onLoadFinished(Landroid/content/Loader;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/settings/DataUsageSummary$31;->onLoadFinished(Landroid/content/Loader;Lcom/android/settings/net/ChartData;)V
...
.method public onLoaderReset(Landroid/content/Loader;)V
    ...
    # setter for: Lcom/android/settings/DataUsageSummary;->mChartData:Lcom/android/settings/net/ChartData;
    invoke-static {v0, v1}, Lcom/android/settings/DataUsageSummary;->access$5102(Lcom/android/settings/DataUsageSummary;Lcom/android/settings/net/ChartData;)Lcom/android/settings/net/ChartData;
