...
.method private fetchIsSLDDevice()V
    ...
    iput-boolean v0, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mIsSLDDevice:Z
...
.method private fillData()V
    ...
    invoke-direct {p0}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->fetchIsSLDDevice()V
...
.method public clearProfileConnectionState()V
    ...
    sget-boolean v2, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->DEBUG:Z
...
.method public compareTo(Lcom/android/settings/bluetooth/CachedBluetoothDevice;)I
    ...
    :goto_3
    iget-boolean v4, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mGearIsConnected:Z
...
.method getDiscRawData()[B
    .locals 1

    iget-object v0, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mDiscRawData:[B
...
.method isSLDDevice()Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mIsSLDDevice:Z
...
.method processActionFoundEvent(SLandroid/bluetooth/BluetoothClass;SLjava/lang/String;Z[B[B)V
    .locals 11

    sget-boolean v7, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->DEBUG:Z
    ...
    const-string v9, "processActionFoundEvent :: rssi : "
    ...
    const-string v9, ", GearManagerName : "
    ...
    const-string v9, "processActionFoundEvent :: Length = "
    ...
    iget-short v7, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mRssi:S
    ...
    iget-object v7, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mBtClass:Landroid/bluetooth/BluetoothClass;
    ...
    :cond_6
    iget-short v7, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mAppearance:S
    ...
    :cond_7
    iget-object v7, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mName:Ljava/lang/String;
    ...
    iput-object v7, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mName:Ljava/lang/String;

    :goto_2
    const/4 v5, 0x1

    :cond_8
    iget-boolean v7, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mVisible:Z
    ...
    :cond_9
    iget-object v7, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mGearManagerName:[B
    ...
    :cond_a
    iget-object v7, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mDiscRawData:[B
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->mDiscRawData:[B
    ...
    const-string v8, "calling dispatchAttributesChanged"
    ...
    invoke-virtual {v7, p4}, Landroid/bluetooth/BluetoothDevice;->setAlias(Ljava/lang/String;)Z
...
.method public updateProfiles()Z
    ...
    invoke-virtual {v3}, Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;->getBleAudioProfile()Lcom/android/settings/bluetooth/BleAudioProfile;
