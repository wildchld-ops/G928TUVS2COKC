...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/settings/bluetooth/BluetoothEventManager$DeviceShutDownHandler;,
        ...
        Lcom/android/settings/bluetooth/BluetoothEventManager$BluetoothItPolicyHandler;,
        Lcom/android/settings/bluetooth/BluetoothEventManager$SettingsSoftResetHandler;,
        Lcom/android/settings/bluetooth/BluetoothEventManager$BluetoothScanDialogHandler;,
        Lcom/android/settings/bluetooth/BluetoothEventManager$RemoteNameChangedHandler;,
        Lcom/android/settings/bluetooth/BluetoothEventManager$DeviceNameChangedHandler;,
...
.method constructor <init>(Lcom/android/settings/bluetooth/LocalBluetoothAdapter;Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;Landroid/content/Context;)V
    ...
    new-instance v1, Lcom/android/settings/bluetooth/BluetoothEventManager$DeviceNameChangedHandler;

    invoke-direct {v1, v3}, Lcom/android/settings/bluetooth/BluetoothEventManager$DeviceNameChangedHandler;-><init>(Lcom/android/settings/bluetooth/BluetoothEventManager$1;)V

    invoke-virtual {p0, v0, v1}, Lcom/android/settings/bluetooth/BluetoothEventManager;->addHandler(Ljava/lang/String;Lcom/android/settings/bluetooth/BluetoothEventManager$Handler;)V

    const-string v0, "android.bluetooth.device.action.ALIAS_CHANGED"

    new-instance v1, Lcom/android/settings/bluetooth/BluetoothEventManager$RemoteNameChangedHandler;

    invoke-direct {v1, p0, v3}, Lcom/android/settings/bluetooth/BluetoothEventManager$RemoteNameChangedHandler;-><init>(Lcom/android/settings/bluetooth/BluetoothEventManager;Lcom/android/settings/bluetooth/BluetoothEventManager$1;)V

    invoke-virtual {p0, v0, v1}, Lcom/android/settings/bluetooth/BluetoothEventManager;->addHandler(Ljava/lang/String;Lcom/android/settings/bluetooth/BluetoothEventManager$Handler;)V

    const-string v0, "android.intent.action.BLUETOOTH_SCAN_DIALOG"

    new-instance v1, Lcom/android/settings/bluetooth/BluetoothEventManager$BluetoothScanDialogHandler;

    invoke-direct {v1, p0, v3}, Lcom/android/settings/bluetooth/BluetoothEventManager$BluetoothScanDialogHandler;-><init>(Lcom/android/settings/bluetooth/BluetoothEventManager;Lcom/android/settings/bluetooth/BluetoothEventManager$1;)V

    invoke-virtual {p0, v0, v1}, Lcom/android/settings/bluetooth/BluetoothEventManager;->addHandler(Ljava/lang/String;Lcom/android/settings/bluetooth/BluetoothEventManager$Handler;)V

    const-string v0, "com.samsung.intent.action.SETTINGS_SOFT_RESET"

    new-instance v1, Lcom/android/settings/bluetooth/BluetoothEventManager$SettingsSoftResetHandler;

    invoke-direct {v1, v3}, Lcom/android/settings/bluetooth/BluetoothEventManager$SettingsSoftResetHandler;-><init>(Lcom/android/settings/bluetooth/BluetoothEventManager$1;)V

    invoke-virtual {p0, v0, v1}, Lcom/android/settings/bluetooth/BluetoothEventManager;->addHandler(Ljava/lang/String;Lcom/android/settings/bluetooth/BluetoothEventManager$Handler;)V

    const-string v0, "com.samsung.server.BT_IT_POLICY"

    new-instance v1, Lcom/android/settings/bluetooth/BluetoothEventManager$BluetoothItPolicyHandler;

    invoke-direct {v1, v3}, Lcom/android/settings/bluetooth/BluetoothEventManager$BluetoothItPolicyHandler;-><init>(Lcom/android/settings/bluetooth/BluetoothEventManager$1;)V
    ...
    new-instance v1, Lcom/android/settings/bluetooth/BluetoothEventManager$DeviceShutDownHandler;

    invoke-direct {v1, p0, v3}, Lcom/android/settings/bluetooth/BluetoothEventManager$DeviceShutDownHandler;-><init>(Lcom/android/settings/bluetooth/BluetoothEventManager;Lcom/android/settings/bluetooth/BluetoothEventManager$1;)V
...
.method static synthetic access$1700(Lcom/android/settings/bluetooth/BluetoothEventManager;)Lcom/android/settings/bluetooth/LocalBluetoothAdapter;
    .locals 1
...
.method static synthetic access$1800(Lcom/android/settings/bluetooth/BluetoothEventManager;)Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;
    .locals 1
...
.method static synthetic access$1900(Lcom/android/settings/bluetooth/BluetoothEventManager;)Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;
    .locals 1
...
.method static synthetic access$2000(Lcom/android/settings/bluetooth/BluetoothEventManager;)Ljava/util/Map;
    .locals 1
...
.method static synthetic access$2100(Lcom/android/settings/bluetooth/BluetoothEventManager;)Ljava/util/Collection;
    .locals 1
...
.method static synthetic access$2200(Lcom/android/settings/bluetooth/BluetoothEventManager;Lcom/android/settings/bluetooth/CachedBluetoothDevice;)V
    .locals 0
...
.method static synthetic access$2400(Landroid/content/Context;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$2500(Lcom/android/settings/bluetooth/BluetoothEventManager;)Landroid/content/Context;
    .locals 1
