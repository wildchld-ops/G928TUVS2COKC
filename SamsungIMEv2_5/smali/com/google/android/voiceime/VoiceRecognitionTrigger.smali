...
# instance fields
.field private mDragonTrigger:Lcom/dragon/android/voiceime/DragonTrigger;
...
.method private getDragonTrigger()Lcom/google/android/voiceime/Trigger;
    .locals 2

    iget-object v0, p0, Lcom/google/android/voiceime/VoiceRecognitionTrigger;->mDragonTrigger:Lcom/dragon/android/voiceime/DragonTrigger;

    if-nez v0, :cond_0

    new-instance v0, Lcom/dragon/android/voiceime/DragonTrigger;
    ...
    invoke-direct {v0, v1}, Lcom/dragon/android/voiceime/DragonTrigger;-><init>(Landroid/inputmethodservice/InputMethodService;)V

    iput-object v0, p0, Lcom/google/android/voiceime/VoiceRecognitionTrigger;->mDragonTrigger:Lcom/dragon/android/voiceime/DragonTrigger;
...
.method private getTrigger()Lcom/google/android/voiceime/Trigger;
    ...
    invoke-static {v0}, Lcom/dragon/android/voiceime/DragonTrigger;->isInstalled(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, Lcom/google/android/voiceime/VoiceRecognitionTrigger;->getDragonTrigger()Lcom/google/android/voiceime/Trigger;
...
.method public static isInstalled(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/dragon/android/voiceime/DragonTrigger;->isInstalled(Landroid/content/Context;)Z
    ...
    :cond_1
    invoke-static {p0}, Lcom/google/android/voiceime/ImeTrigger;->isInstalled(Landroid/content/Context;)Z
...
.method public onConfigurationChanged()V
    ...
    invoke-interface {v0}, Lcom/google/android/voiceime/Trigger;->onConfigurationChanged()V
...
.method public onStartInputView()V
    ...
    instance-of v0, v0, Lcom/dragon/android/voiceime/DragonTrigger;
...
.method public updateLanguage(I)V
    ...
    invoke-interface {v0, p1}, Lcom/google/android/voiceime/Trigger;->updateLanguage(I)V
