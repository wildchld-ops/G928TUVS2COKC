.class public Lcom/ime/framework/sidesync/SideSyncManager;
...
.field private static sInstance:Lcom/ime/framework/sidesync/SideSyncManager;
...
.field private mSideSyncBroadcast:Lcom/ime/framework/sidesync/SideSyncBroadcast;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputManager:Lcom/ime/framework/common/InputManager;

    iget-object v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputManager:Lcom/ime/framework/common/InputManager;

    if-nez v0, :cond_0

    sget-object v0, Lcom/ime/framework/sidesync/SideSyncManager;->mContext:Landroid/content/Context;
    ...
    :cond_0
    iput-object v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mSideSyncBinder:Landroid/os/IBinder;

    iput-object v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mISideSyncSinkSIP:Lcom/sec/android/sidesync/sink/model/ISideSyncSinkSIP;

    iput-object v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mISideSyncSourceSIP:Lcom/sec/android/sidesync/source/model/ISideSyncSourceSIP;

    const/4 v0, -0x1

    iput v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mHostInputMode:I

    const/16 v0, 0x8

    iput v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mGuestInputMode:I

    iput-object v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputEditorInfo:Landroid/view/inputmethod/EditorInfo;

    new-instance v0, Lcom/ime/framework/sidesync/SideSyncBroadcast;

    sget-object v1, Lcom/ime/framework/sidesync/SideSyncManager;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1, p0}, Lcom/ime/framework/sidesync/SideSyncBroadcast;-><init>(Landroid/content/Context;Lcom/ime/framework/sidesync/SideSyncManager;)V

    iput-object v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mSideSyncBroadcast:Lcom/ime/framework/sidesync/SideSyncBroadcast;

    return-void
.end method

.method public static getInstance()Lcom/ime/framework/sidesync/SideSyncManager;
    .locals 1

    sget-object v0, Lcom/ime/framework/sidesync/SideSyncManager;->sInstance:Lcom/ime/framework/sidesync/SideSyncManager;

    if-nez v0, :cond_0

    sget-object v0, Lcom/ime/framework/sidesync/SideSyncManager;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lcom/ime/framework/sidesync/SideSyncManager;->newInstance(Landroid/content/Context;)Lcom/ime/framework/sidesync/SideSyncManager;
...
.method private getKeyFromKeycode(I)Lcom/ime/framework/view/Keyboard$Key;
    ...
    iget-object v7, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputManager:Lcom/ime/framework/common/InputManager;
    ...
    invoke-interface {v7, v9}, Lcom/ime/framework/common/InputManager;->getKeyboardKeyList(Z)Ljava/util/List;
    ...
    iget-object v7, v0, Lcom/ime/framework/view/Keyboard$Key;->codes:[I
...
.method public static isSideSyncSinkConnect()Z
    ...
    sget-object v2, Lcom/ime/framework/sidesync/SideSyncManager;->mContext:Landroid/content/Context;
...
.method public static newInstance(Landroid/content/Context;)Lcom/ime/framework/sidesync/SideSyncManager;
    .locals 1
    ...
    :cond_0
    sput-object p0, Lcom/ime/framework/sidesync/SideSyncManager;->mContext:Landroid/content/Context;

    sget-object v0, Lcom/ime/framework/sidesync/SideSyncManager;->sInstance:Lcom/ime/framework/sidesync/SideSyncManager;

    if-nez v0, :cond_1

    new-instance v0, Lcom/ime/framework/sidesync/SideSyncManager;

    invoke-direct {v0}, Lcom/ime/framework/sidesync/SideSyncManager;-><init>()V

    sput-object v0, Lcom/ime/framework/sidesync/SideSyncManager;->sInstance:Lcom/ime/framework/sidesync/SideSyncManager;
...
.method private sendExistTextBeforeCursor(Z)V
    ...
    :cond_0
    iget-object v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mISideSyncSourceSIP:Lcom/sec/android/sidesync/source/model/ISideSyncSourceSIP;
...
.method private sendIntentToSource(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mISideSyncSinkSIP:Lcom/sec/android/sidesync/sink/model/ISideSyncSinkSIP;
...
# virtual methods
.method public changeKoreanKeyCodeFromV9toGlobal(I)I
    .locals 1
...
.method public getGuestInputMode()I
    ...
    iget v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mGuestInputMode:I
...
.method public getHostInputMode()I
    ...
    iget v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mHostInputMode:I

    return v0
.end method

.method public getSideSyncBroadcast()Lcom/ime/framework/sidesync/SideSyncBroadcast;
    .locals 1

    iget-object v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mSideSyncBroadcast:Lcom/ime/framework/sidesync/SideSyncBroadcast;
...
.method public getSideSyncEditorInfo()Landroid/view/inputmethod/EditorInfo;
    ...
    iget-object v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputEditorInfo:Landroid/view/inputmethod/EditorInfo;
...
.method public getSideSyncExistTextBeforeCursor()Z
    ...
    iget-boolean v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mExistTextBeforeCursor:Z
...
.method public getSideSyncPreShiftPressed()Z
    ...
    iget-boolean v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mPreShiftPressed:Z
...
.method public getSideSyncShiftState()Z
    ...
    iget-boolean v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mShiftState:Z
...
.method public isSideSyncKeyboardConnected()Z
    ...
    sget-object v4, Lcom/ime/framework/sidesync/SideSyncManager;->mContext:Landroid/content/Context;
...
.method public isSideSyncWorkingOnSink()Z
    ...
    iget-object v2, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mISideSyncSinkSIP:Lcom/sec/android/sidesync/sink/model/ISideSyncSinkSIP;
...
.method public isSideSyncWorkingOnSource()Z
    ...
    iget-object v2, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mISideSyncSourceSIP:Lcom/sec/android/sidesync/source/model/ISideSyncSourceSIP;
...
.method public movePopupKeyboard(II)V
    ...
    iget-object v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputManager:Lcom/ime/framework/common/InputManager;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/ime/framework/view/PopupKeyboardView;->updateKeyboardSideSync(II)V
...
.method public sendFloatingKeyboardSize()V
    ...
    :try_start_0
    iget-object v5, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputManager:Lcom/ime/framework/common/InputManager;
    ...
    :goto_2
    iget-object v5, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mISideSyncSinkSIP:Lcom/sec/android/sidesync/sink/model/ISideSyncSinkSIP;
    ...
    invoke-interface {v5, v4, v6}, Lcom/sec/android/sidesync/sink/model/ISideSyncSinkSIP;->returnKeyboardSize(II)V
    :try_end_3
    ...
    const-string v6, "[SSM] sendFloatingKeyboardSize"
    ...
    const-string v6, "[SSB] sendFloatingKeyboardSize : RemoteException"
...
.method public sendSideSyncCtrlPressedState(Z)V
    ...
    invoke-virtual {p0}, Lcom/ime/framework/sidesync/SideSyncManager;->isSideSyncWorkingOnSink()Z
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/ime/framework/sidesync/SideSyncManager;->sendIntentToSource(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public sendSideSyncEdiorInfo(Landroid/view/inputmethod/EditorInfo;)V
    ...
    invoke-virtual {p0}, Lcom/ime/framework/sidesync/SideSyncManager;->isSideSyncWorkingOnSource()Z
...
.method public sendSideSyncExistTextBeforeCursor(Z)V
    ...
    invoke-direct {p0, p1}, Lcom/ime/framework/sidesync/SideSyncManager;->sendExistTextBeforeCursor(Z)V
...
.method public sendSideSyncKeyCode(I)V
    ...
    invoke-static {p1}, Lcom/ime/framework/sidesync/SideSyncUtils;->isThisKeyEnable(I)Z
    ...
    iget-object v12, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputManager:Lcom/ime/framework/common/InputManager;
    ...
    invoke-interface {v12}, Lcom/ime/framework/common/InputManager;->getRepository()Lcom/ime/framework/repository/Repository;

    move-result-object v9

    iget-object v12, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputManager:Lcom/ime/framework/common/InputManager;

    invoke-interface {v12}, Lcom/ime/framework/common/InputManager;->getShiftStateController()Lcom/ime/framework/common/ShiftStateController;
    ...
    invoke-interface {v12}, Lcom/ime/framework/common/InputManager;->getCurrentInputLanguageCode()Ljava/lang/String;
    ...
    :goto_1
    invoke-direct {p0, v7}, Lcom/ime/framework/sidesync/SideSyncManager;->sendKeyCode(I)V
    ...
    invoke-interface {v9, v12, v13}, Lcom/ime/framework/repository/Repository;->getData(Ljava/lang/String;I)I
    ...
    invoke-interface {v10}, Lcom/ime/framework/common/ShiftStateController;->getCapsLockState()Z
    ...
    :cond_6
    invoke-static {v5}, Lcom/ime/framework/util/Utils;->isArabicLanguage(I)Z
    ...
    :cond_c
    invoke-static {v6}, Lcom/ime/framework/util/Utils;->isArabicLanguage(I)Z
    ...
    invoke-direct {p0, p1}, Lcom/ime/framework/sidesync/SideSyncManager;->getKeyFromKeycode(I)Lcom/ime/framework/view/Keyboard$Key;

    move-result-object v0

    if-eqz v0, :cond_12

    iget-object v12, v0, Lcom/ime/framework/view/Keyboard$Key;->label:Ljava/lang/CharSequence;
...
.method public sendSideSyncKeyCodes(I[I)V
    .locals 3
    ...
    const-string v2, "[SSM] sendSideSyncKeyCodes"
    ...
    invoke-interface {v1, p1, p2}, Lcom/sec/android/sidesync/sink/model/ISideSyncSinkSIP;->sendKeyCodes(I[I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v2, "[SSB] sendSideSyncKeyCodes : RemoteException"
...
.method public sendSideSyncKeyLanguage(I)V
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/ime/framework/sidesync/SideSyncManager;->sendLangID(I)V
...
.method public sendSideSyncPredictiveText(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/ime/framework/sidesync/SideSyncManager;->sendIntentToSource(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public sendSideSyncShiftState(Z)V
    ...
    invoke-direct {p0, p1}, Lcom/ime/framework/sidesync/SideSyncManager;->sendShiftState(Z)V
...
.method public sendSideSyncSinkFloatingKeyboardSize(Landroid/os/Bundle;)V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/ime/framework/sidesync/SideSyncManager;->sendFloatingKeyboardSize()V
...
.method public setGuestInputMode(I)V
    ...
    iput p1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mGuestInputMode:I
...
.method public setHostInputMode(I)V
    ...
    iput p1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mHostInputMode:I
...
.method public setSideSyncCtrlPressedState(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Lcom/ime/framework/common/InputManager;->setCtrlPressedState(Z)V
...
.method public setSideSyncEdiorInfo(Landroid/view/inputmethod/EditorInfo;)V
    ...
    iput-object p1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputEditorInfo:Landroid/view/inputmethod/EditorInfo;
...
.method public setSideSyncExistTextBeforeCursorState(Ljava/lang/String;)V
    ...
    iget-boolean v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mExistTextBeforeCursor:Z
    ...
    iput-boolean v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mExistTextBeforeCursor:Z

    iget-object v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputManager:Lcom/ime/framework/common/InputManager;

    invoke-interface {v1}, Lcom/ime/framework/common/InputManager;->invalidateKeyboardView()V
...
.method public setSideSyncInputText(Ljava/lang/String;)V
    ...
    const-string v7, "[SSM] setSideSyncInputText"

    invoke-static {v6, v7}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    :cond_0
    iget-object v6, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputManager:Lcom/ime/framework/common/InputManager;
    ...
    invoke-interface {v6, v7, v8}, Lcom/ime/framework/common/InputManager;->onKey(I[I)V
    ...
    invoke-interface {v6, p1}, Lcom/ime/framework/common/InputManager;->onText(Ljava/lang/CharSequence;)V
...
.method public setSideSyncKeyCode(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/ime/framework/sidesync/SideSyncManager;->changeKoreanKeyCodeFromV9toGlobal(I)I
    ...
    invoke-interface {v0, p1, v1}, Lcom/ime/framework/common/InputManager;->onKey(I[I)V
    ...
    invoke-interface {v0, v2}, Lcom/ime/framework/common/InputManager;->requestHideSelf(I)V
...
.method public setSideSyncKeyCodes(I[I)V
    .locals 2
    ...
    const-string v1, "[SSM] setSideSyncKeyCodes"
...
.method public setSideSyncLanguage(I)V
    ...
    invoke-interface {v0, p1}, Lcom/ime/framework/common/InputManager;->setSideSyncKeyLanguage(I)V
...
.method public setSideSyncPreShiftPressed(Z)V
    ...
    iput-boolean p1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mPreShiftPressed:Z
...
.method public setSideSyncPredictiveText(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Lcom/ime/framework/common/InputManager;->setSideSyncPredictiveText(Ljava/lang/String;)V
...
.method public setSideSyncShiftPressedState(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Lcom/ime/framework/common/InputManager;->setSideSyncShiftPressedState(Z)V
...
.method public setSideSyncShiftState(Z)V
    ...
    invoke-interface {v0, p1}, Lcom/ime/framework/common/InputManager;->setSideSynShiftState(Z)V
...
.method public setSideSyncSinkBinder(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mSideSyncBinder:Landroid/os/IBinder;
...
.method public setSideSyncSinkEditorInfo(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v1}, Lcom/ime/framework/sidesync/SideSyncManager;->setSideSyncEdiorInfo(Landroid/view/inputmethod/EditorInfo;)V
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setSideSyncSinkFloatingKeyboardPostion(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v1, v2}, Lcom/ime/framework/sidesync/SideSyncManager;->movePopupKeyboard(II)V
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setSideSyncSinkShiftState(Landroid/os/Bundle;)V
    ...
    iput-boolean v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mShiftState:Z

    iget-object v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputManager:Lcom/ime/framework/common/InputManager;

    invoke-interface {v1}, Lcom/ime/framework/common/InputManager;->getShiftState()Z

    move-result v1

    iget-boolean v2, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mShiftState:Z

    if-eq v1, v2, :cond_1

    iget-object v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mInputManager:Lcom/ime/framework/common/InputManager;

    invoke-interface {v1}, Lcom/ime/framework/common/InputManager;->getCurrentInputLanguageCode()Ljava/lang/String;
    ...
    iget-boolean v1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mShiftState:Z
    ...
    invoke-virtual {p0, v1}, Lcom/ime/framework/sidesync/SideSyncManager;->setSideSyncShiftState(Z)V
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setSideSyncSourceBinder(Landroid/os/IBinder;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mSideSyncBinder:Landroid/os/IBinder;

    iget-object v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mSideSyncBinder:Landroid/os/IBinder;
    ...
    iput-object v0, p0, Lcom/ime/framework/sidesync/SideSyncManager;->mISideSyncSourceSIP:Lcom/sec/android/sidesync/source/model/ISideSyncSourceSIP;
