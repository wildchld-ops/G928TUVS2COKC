.class Lcom/ime/framework/common/InputManagerImpl$21;
...
.method constructor <init>(Lcom/ime/framework/common/InputManagerImpl;)V
    ...
    iput-object p1, p0, Lcom/ime/framework/common/InputManagerImpl$21;->this$0:Lcom/ime/framework/common/InputManagerImpl;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :cond_1
    iget-object v1, p0, Lcom/ime/framework/common/InputManagerImpl$21;->this$0:Lcom/ime/framework/common/InputManagerImpl;

    # getter for: Lcom/ime/framework/common/InputManagerImpl;->mCurrentInputLanguage:Lcom/ime/framework/common/Language;
    invoke-static {v1}, Lcom/ime/framework/common/InputManagerImpl;->access$6400(Lcom/ime/framework/common/InputManagerImpl;)Lcom/ime/framework/common/Language;
    ...
    invoke-interface {v1}, Lcom/ime/framework/common/ShiftStateController;->isForcedCapsLockForGreek()Z
    ...
    invoke-interface {v1}, Lcom/ime/framework/common/ShiftStateController;->backupCapsLock()V
    ...
    invoke-interface {v1, v0}, Lcom/ime/framework/common/ShiftStateController;->setCapsLockState(Z)V
    ...
    invoke-interface {v1}, Lcom/ime/framework/input/InputController;->updateShiftState()V

    iget-object v1, p0, Lcom/ime/framework/common/InputManagerImpl$21;->this$0:Lcom/ime/framework/common/InputManagerImpl;

    # getter for: Lcom/ime/framework/common/InputManagerImpl;->mViewController:Lcom/ime/framework/view/ViewController;
    invoke-static {v1}, Lcom/ime/framework/common/InputManagerImpl;->access$300(Lcom/ime/framework/common/InputManagerImpl;)Lcom/ime/framework/view/ViewController;

    move-result-object v1

    invoke-interface {v1}, Lcom/ime/framework/view/ViewController;->update()V
    ...
    invoke-interface {v1, v0}, Lcom/ime/framework/common/ShiftStateController;->setForcedCapslock(Z)V
