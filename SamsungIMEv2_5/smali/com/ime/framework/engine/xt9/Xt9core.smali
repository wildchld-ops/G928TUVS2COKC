.class public Lcom/ime/framework/engine/xt9/Xt9core;
...
.method public static native ET9AWHwr_HandlePenUp(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9WordSymbInfo;B[S)S
.end method

.method public static native ET9AWHwr_Init(S[B[BS)S
.end method

.method public static native ET9AWHwr_ProcessStrokes(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9WordSymbInfo;IB[S)S
.end method
...
.method public static native ET9AWLdbSetLanguage(SSZ)S
.end method
...
.method public static native ET9AWSelLstGetWord(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9AWWordInfo;B)S
.end method
...
.method public static native ET9CPEnableCategoryDB(Landroid/content/res/AssetManager;IILjava/lang/String;Ljava/lang/String;Z)S
.end method

.method public static native ET9CPGetActivatedCatID()I
.end method

.method public static native ET9CPGetCharSpell(SBBLcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPSpell;)S
.end method

.method public static native ET9CPGetChineseLdbNum()S
.end method

.method public static native ET9CPGetPhrase(SLcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPPhrase;Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPSpell;[B)S
.end method

.method public static native ET9CPGetPrefix(SLcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPSpell;)S
.end method

.method public static native ET9CPGetPrefixCount()B
.end method

.method public static native ET9CPGetSelection(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPPhrase;Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPSpell;[B)S
.end method

.method public static native ET9CPGetSpecialPhrase(BSLcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPPhrase;)S
.end method

.method public static native ET9CPGetSpell(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPSpell;)S
.end method

.method public static native ET9CPHasBilingualPrefix()Z
.end method

.method public static native ET9CPHotwordAddMdbPhrase(Ljava/lang/String;Ljava/lang/String;)I
.end method

.method public static native ET9CPHotwordDeletePhrase(Ljava/lang/String;)I
.end method

.method public static native ET9CPHotwordExit()V
.end method

.method public static native ET9CPHotwordExport(Ljava/lang/String;)I
.end method

.method public static native ET9CPHotwordImport(Ljava/lang/String;)I
.end method

.method public static native ET9CPHotwordInit(Landroid/content/res/AssetManager;)I
.end method

.method public static native ET9CPHotwordReset()I
.end method

.method public static native ET9CPHotwordSetLDBFileName(ILjava/lang/String;)I
.end method

.method public static native ET9CPHotwordSetLanguage(Ljava/lang/String;)I
.end method
...
.method public static native ET9CPSelectPhrase(SLcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPSpell;)S
.end method
...
.method public static native ET9CPUdbAddPhrase(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPPhrase;[S)S
.end method

.method public static native ET9CPUdbAddPhrase(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPPhrase;[SB)S
.end method

.method public static native ET9CPUdbDeletePhrase(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPPhrase;)S
.end method

.method public static native ET9CPUdbGetPhrase(SSLcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPPhrase;Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9CPSpell;)S
.end method
...
.method public static native ET9GetExactWord(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9SimpleWord;)S
.end method

.method public static native ET9GetStateBits()I
.end method

.method public static native ET9InitCallback(Lcom/ime/framework/engine/xt9/Xt9Datatype$BaseCallback;)S
.end method
...
.method public static native ET9JBuildSelectionList([B[S)S
.end method

.method public static native ET9JDLMInit([BI)S
.end method

.method public static native ET9JGetCandidate(B[B[S)S
.end method

.method public static native ET9JLdbInit()S
.end method

.method public static native ET9JNoteWordDone([CS[BI)S
.end method

.method public static native ET9JSysInit(ZB)S
.end method

.method public static native ET9KBuildHangul(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9KHangulWord;)S
.end method

.method public static native ET9KBuildHangul(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9KHangulWord;[SS)S
.end method
...
.method public static native ET9KClearAllSymbs()S
.end method

.method public static native ET9KClearOneSymb()S
.end method
...
.method public static native ET9KDB_GetKeyPositions([Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9Region;I)S
.end method
...
.method public static native ET9KDB_GetTapKeyRegion(SSLcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9Region;)S
.end method
...
.method public static native ET9KDB_Init(SSSSLcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9KDB_IMEInfo;)S
.end method

.method public static native ET9KDB_Init(SSSSLcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9KDB_IMEInfo;Lcom/ime/framework/common/InputManager;)S
.end method

.method public static native ET9KDB_InvalidateLoadedKdbInfo()S
.end method

.method public static native ET9KDB_IsAutoAcceptBeforeTrace([Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9TracePoint;I[Z)Z
.end method
...
.method public static native ET9KDB_ProcessTrace([Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9TracePoint;IB)S
.end method

.method public static native ET9KDB_ProcessTrace([Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9TracePoint;I[JB)S
.end method
...
.method public static native ET9KDB_ShouldAutoAcceptBeforeTrace([Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9TracePoint;I[Z)Z
.end method
...
.method public static native ET9KDecodeHangul(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9KHangulWord;Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9SimpleWord;)S
.end method

.method public static native ET9KDecodeHangul(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9KHangulWord;Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9SimpleWord;Z)S
.end method

.method public static native ET9KDeleteSymbs(BB)S
.end method
...
.method public static native ET9KSetInputMode(SZS)S
.end method
...
.method public static native ET9KUTIL_BuildHangulSingleConsonants(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9KHangulWord;[SS)S
.end method

.method public static native ET9KUTIL_GetHangulSingleConsonants(B[SS[S)S
.end method

.method public static native ET9KanaToRomaji([BS[B[I)S
.end method

.method public static native ET9LockWord(Lcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9SimpleWord;)S
.end method

.method public static native ET9MakeLdbList()S
.end method

.method public static native ET9RomajiToKana([CS[B[I)S
.end method
...
.method public static native ET9SetKeyboardDatabase(Lcom/ime/framework/engine/xt9/XT9KeyboardDatabase;)S
.end method
...
.method public static native ET9_K_Hangul2Jamo([CSLcom/ime/framework/engine/xt9/Xt9Datatype$S_ET9SimpleWord;Z)S
.end method

.method public static native ET9confirmRangeConvWord(I)I
.end method

.method public static native ET9getRangeConvCandidateWord(I[C[I)I
.end method

.method public static native ET9getRangeConvCandidateWordCount()I
.end method

.method public static native ET9getRangeConvertedPhrase(I[I[C[I)I
.end method

.method public static native ET9startRangeConversion(I[CI)I
.end method

.method public static native FreeAllXCatDBs()S
.end method

.method public static native GetCurrentTimeMillis()J
.end method

.method public static native InitAllXCatDBs()S
.end method

.method public static native exportAlphaDLMEvent(Ljava/lang/String;)S
.end method

.method public static native exportChnUDB(Ljava/lang/String;)S
.end method

.method public static native exportKorDLMEvent(Ljava/lang/String;)S
.end method

.method public static native getEngAddedWordList([S[SS)S
.end method

.method public static native getKorAddedWordList([S[SS)S
.end method

.method public static native importAlphaDLMEvent(Ljava/lang/String;)S
.end method

.method public static native importChnUDB(Ljava/lang/String;)S
.end method

.method public static native importKorDLMEvent(Ljava/lang/String;)S
.end method
