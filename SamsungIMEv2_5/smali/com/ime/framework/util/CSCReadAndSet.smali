.class public Lcom/ime/framework/util/CSCReadAndSet;
...
.field private static sInstance:Lcom/ime/framework/util/CSCReadAndSet;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/ime/framework/util/CSCReadAndSet;->sInstance:Lcom/ime/framework/util/CSCReadAndSet;

    const-string v0, ""

    sput-object v0, Lcom/ime/framework/util/CSCReadAndSet;->DEFAULT_ENABLE_LANGUAGE_LIST:Ljava/lang/String;
...
.method public static declared-synchronized getInstance(Ljava/lang/String;)Lcom/ime/framework/util/CSCReadAndSet;
    .locals 2

    const-class v1, Lcom/ime/framework/util/CSCReadAndSet;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/ime/framework/util/CSCReadAndSet;->sInstance:Lcom/ime/framework/util/CSCReadAndSet;

    if-nez v0, :cond_0

    new-instance v0, Lcom/ime/framework/util/CSCReadAndSet;

    invoke-direct {v0}, Lcom/ime/framework/util/CSCReadAndSet;-><init>()V
...
.method private getTagValue(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v3, Lcom/ime/framework/util/CSCReadAndSet;->mNode:Lorg/w3c/dom/Node;
    ...
    invoke-direct {p0, v3, p1}, Lcom/ime/framework/util/CSCReadAndSet;->getTagNode(Lorg/w3c/dom/Node;Ljava/lang/String;)Lorg/w3c/dom/Node;
...
.method private getTagValueReturnBoolean(Ljava/lang/String;Z)Z
    ...
    :cond_2
    invoke-direct {p0, p1}, Lcom/ime/framework/util/CSCReadAndSet;->getTagValue(Ljava/lang/String;)Ljava/lang/String;
...
.method private loadXMLFile(Ljava/lang/String;)V
    ...
    sput-object v7, Lcom/ime/framework/util/CSCReadAndSet;->mDoc:Lorg/w3c/dom/Document;

    sget-object v7, Lcom/ime/framework/util/CSCReadAndSet;->mDoc:Lorg/w3c/dom/Document;
    ...
    sget-object v9, Lcom/ime/framework/util/CSCReadAndSet;->mDoc:Lorg/w3c/dom/Document;
    ...
    sput-object v7, Lcom/ime/framework/util/CSCReadAndSet;->mRoot:Lorg/w3c/dom/Node;

    sget-object v7, Lcom/ime/framework/util/CSCReadAndSet;->mRoot:Lorg/w3c/dom/Node;
    ...
    sget-object v9, Lcom/ime/framework/util/CSCReadAndSet;->mRoot:Lorg/w3c/dom/Node;
    ...
    sput-object v7, Lcom/ime/framework/util/CSCReadAndSet;->mNode:Lorg/w3c/dom/Node;
    ...
    sget-object v7, Lcom/ime/framework/util/CSCReadAndSet;->mNode:Lorg/w3c/dom/Node;

    aget-object v8, v6, v5

    invoke-direct {p0, v7, v8}, Lcom/ime/framework/util/CSCReadAndSet;->getTagNode(Lorg/w3c/dom/Node;Ljava/lang/String;)Lorg/w3c/dom/Node;
    ...
    sget-object v9, Lcom/ime/framework/util/CSCReadAndSet;->mNode:Lorg/w3c/dom/Node;
...
.method public setCustomerCSC(Landroid/content/Context;Z)V
    ...
    iput-object v0, v1, Lcom/ime/framework/util/CSCReadAndSet;->mContext:Landroid/content/Context;

    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/ime/framework/util/CSCReadAndSet;->mContext:Landroid/content/Context;
    ...
    sget-boolean v31, Lcom/ime/framework/util/Debug;->INFO:Z

    if-eqz v31, :cond_0

    const-string v31, "SamsungIME"

    const-string v32, "getSharedPreferences() error"
    ...
    const-string v32, "CscFeature_Sip_DisableMultiInputLanuage"
    ...
    const-string v31, "language.xml"

    move-object/from16 v0, p0

    move-object/from16 v1, v31

    invoke-direct {v0, v1}, Lcom/ime/framework/util/CSCReadAndSet;->loadXMLFile(Ljava/lang/String;)V

    const-string v31, "SupportList"
    ...
    invoke-direct {v0, v1, v2}, Lcom/ime/framework/util/CSCReadAndSet;->getTagValueReturnString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_DaLanguage:Ljava/lang/String;

    :cond_5
    :goto_1
    const-string v31, "EnableList"
    ...
    iput-object v0, v1, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_EnableLanguageListOnLanguageXml:Ljava/lang/String;

    :cond_8
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_SupportLanguageListOnLanguageXml:Ljava/lang/String;

    move-object/from16 v31, v0

    if-eqz v31, :cond_f

    const-string v31, "support_languages"
    ...
    invoke-static {v0, v1}, Lcom/ime/framework/common/LanguageID;->getId(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iput-object v0, v1, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_SupportLanguageListOnLanguageXml:Ljava/lang/String;
    ...
    invoke-static {}, Lcom/ime/framework/repository/PropertyItems;->getDefaultSupportLanguages()Ljava/lang/String;
    ...
    iput-object v5, v0, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_SupportLanguageListOnLanguageXml:Ljava/lang/String;
    ...
    invoke-static/range {v30 .. v31}, Lcom/ime/framework/common/LanguageID;->getId(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v0, v0, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_EnableLanguageListOnLanguageXml:Ljava/lang/String;
    ...
    invoke-static/range {v30 .. v30}, Lcom/ime/framework/common/LanguageID;->getCountryCodeOfLanguageCode(Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v31, Lcom/ime/framework/util/CSCReadAndSet;->DEFAULT_ENABLE_LANGUAGE_LIST:Ljava/lang/String;

    invoke-virtual/range {p1 .. p1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v31

    const-string v32, "handwriting_language_list"

    sget-object v33, Lcom/ime/framework/util/CSCReadAndSet;->DEFAULT_ENABLE_LANGUAGE_LIST:Ljava/lang/String;

    const/16 v34, -0x2

    invoke-static/range {v31 .. v34}, Landroid/provider/Settings$System;->putStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;I)Z

    :cond_16
    if-eqz v11, :cond_2a

    const-string v31, "SupportUmlautList"
    ...
    iput-object v0, v1, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_DaSupportUmlautLanguageList:Ljava/lang/String;

    :cond_19
    const-string v31, "EnableUmlautList"
    ...
    iput-object v0, v1, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_DaSelectUmlautLanguageList:Ljava/lang/String;

    :cond_1c
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_DaLanguage:Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_DaSupportUmlautLanguageList:Ljava/lang/String;
    ...
    const-string v33, "mCscVal_DaSupportUmlautLanguageList : "
    ...
    iget-object v0, v0, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_DaSelectUmlautLanguageList:Ljava/lang/String;
    ...
    const-string v33, "mCscVal_DaSelectUmlautLanguageList : "
    ...
    const-string v31, "KeypadType"

    const-string v32, "3X4"
    ...
    iput-object v0, v1, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_KeypadType:Ljava/lang/String;

    :cond_2d
    const-string v31, "WORD_COMPLETION_POINT"
    ...
    iput-object v0, v1, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_WordCompletionPoint:Ljava/lang/String;

    :cond_30
    const-string v31, "HWR_RECOGNITION_TIME"

    const-string v32, "500ms"
    ...
    iput-object v0, v1, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_RecognitionTime:Ljava/lang/String;

    :cond_33
    const-string v31, "HWR_RECOGNITION_TYPE"

    const-string v32, "COMPLETE"
    ...
    iput-object v0, v1, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_RecognitionType:Ljava/lang/String;

    :cond_36
    const-string v31, "T9Enabling"
    ...
    invoke-direct {v0, v1, v2}, Lcom/ime/framework/util/CSCReadAndSet;->getTagValueReturnBoolean(Ljava/lang/String;Z)Z
    ...
    const-string v31, "SETTINGS_DEFAULT_FOREIGN_PREDICTION_ON"
    ...
    :cond_38
    const-string v31, "KEYPAD_SWEEPING"
    ...
    :cond_39
    const-string v31, "KEYPAD_POINTING"
    ...
    :cond_3b
    const-string v31, "AUTO_CAPITALIZATION"
    ...
    const-string v31, "SETTINGS_DEFAULT_AUTO_CAPS"
    ...
    const-string v31, "SETTINGS_DEFAULT_AUTO_SPACING"
    ...
    const-string v31, "SETTINGS_DEFAULT_VOICE_INPUT"
    ...
    const-string v31, "SETTINGS_DEFAULT_AUTO_PERIOD"
    ...
    :cond_3f
    const-string v31, "CHARACTER_PREVIEW"
    ...
    const-string v31, "SETTINGS_DEFAULT_SUPPORT_KEY_VIBRATE"
    ...
    const-string v31, "SETTINGS_DEFAULT_SUPPORT_KEY_SOUND"
    ...
    const-string v32, "sip_key_feedback_sound"
    ...
    :cond_43
    :goto_8
    const-string v31, "WORD_COMPLETION"
    ...
    const-string v31, "SETTINGS_DEFAULT_WORDCOMPLETION"
    ...
    const-string v32, "sip_key_feedback_vibration"
    ...
    :cond_44
    :goto_9
    const-string v31, "ContinuousInput"
    ...
    :cond_45
    const-string v31, "SPELL_CORRECTION"
    ...
    const-string v31, "SETTINGS_DEFAULT_SPELLCORRECTION"
    ...
    :cond_46
    const-string v31, "NEXT_WORD_PREDICTION"
    ...
    const-string v31, "SETTINGS_DEFAULT_NEXTWORDPREDICTION"
    ...
    const-string v31, "SETTINGS_DEFAULT_AUTOAPPEND"
    ...
    :cond_48
    const-string v31, "AUTO_SUBTITUTION"
    ...
    const-string v31, "SETTINGS_DEFAULT_AUTOSUBSTITUTION"
    ...
    :cond_49
    const-string v31, "REGIONAL_CORRECTION"
    ...
    const-string v31, "SETTINGS_DEFAULT_REGIONALCORRECTION"
    ...
    const-string v31, "SETTINGS_DEFAULT_RECAPTURE"
    ...
    :cond_4d
    const-string v31, "AutoReplacement"
    ...
    iget-object v0, v0, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_KeypadType:Ljava/lang/String;
    ...
    :goto_a
    sget-boolean v31, Lcom/ime/framework/util/Debug;->USE_COMMIT_MANAGER:Z
    ...
    invoke-interface {v0, v1, v14}, Lcom/ime/framework/repository/SharedPreferencesCommitManager;->setData(Ljava/lang/String;Ljava/lang/String;)V

    :cond_4f
    :goto_b
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_WordCompletionPoint:Ljava/lang/String;

    move-object/from16 v31, v0

    if-eqz v31, :cond_50

    const-string v31, "SETTINGS_DEFAULT_WORDCOMPLETIONPOINT"
    ...
    iget-object v0, v0, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_RecognitionTime:Ljava/lang/String;
    ...
    :goto_c
    const-string v31, "SETTINGS_DEFAULT_HWR_RECOGNIZE_DELAY"
    ...
    iget-object v0, v0, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_RecognitionType:Ljava/lang/String;
    ...
    :goto_d
    const-string v31, "SETTINGS_DEFAULT_HWR_RECOGNITION_TYPE"
    ...
    const-string v32, "editor has nothing to commit."
    ...
    const-string v32, "commit() success"
...
.method public setSupportLanguageFromCustomerCSC(Landroid/content/Context;Z)V
    ...
    sget-boolean v21, Lcom/ime/framework/util/Debug;->INFO:Z
    ...
    iput-object v13, v0, Lcom/ime/framework/util/CSCReadAndSet;->mCscVal_SupportLanguageListOnLanguageXml:Ljava/lang/String;
    ...
    :cond_b
    invoke-static {v10, v12}, Lcom/ime/framework/common/LanguageID;->getId(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static/range {v20 .. v21}, Lcom/ime/framework/common/LanguageID;->getId(Ljava/lang/String;Ljava/lang/String;)I
