...
.method static synthetic access$100(Lcom/touchtype/personalizer/PersonalizerService;)Z
    .locals 1
...
.method static synthetic access$102(Lcom/touchtype/personalizer/PersonalizerService;Z)Z
    .locals 0
...
.method static synthetic access$1100(Lcom/touchtype/personalizer/PersonalizerService;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic access$300(Lcom/touchtype/personalizer/PersonalizerService;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic access$400(Lcom/touchtype/personalizer/PersonalizerService;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic access$500(Lcom/touchtype/personalizer/PersonalizerService;IIZ)V
    .locals 0
...
.method static synthetic access$600(Lcom/touchtype/personalizer/PersonalizerService;IJ)V
    .locals 0
...
.method static synthetic access$800(Lcom/touchtype/personalizer/PersonalizerService;)I
    .locals 1
...
.method static synthetic access$808(Lcom/touchtype/personalizer/PersonalizerService;)I
    .locals 2
...
.method static synthetic access$900(Lcom/touchtype/personalizer/PersonalizerService;)Z
    .locals 1
...
.method static synthetic access$902(Lcom/touchtype/personalizer/PersonalizerService;Z)Z
    .locals 0
...
.method private init(Landroid/content/Intent;)V
    ...
    const-string v9, "com.touchtype.personalizer.ACTION_ENABLE_PERSONALIZATION"
    ...
    sget-object v8, Lcom/touchtype/personalizer/PersonalizerService;->TAG:Ljava/lang/String;

    const-string v9, "Got intent with ACTION_ENABLE_PERSONALIZATION"

    invoke-static {v8, v9}, Lcom/touchtype_fluency/service/util/LogUtil;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v12, v11, v10}, Lcom/touchtype/personalizer/PersonalizerService;->setPersonalizerState(IIZ)V

    invoke-direct {p0}, Lcom/touchtype/personalizer/PersonalizerService;->writeStoredState()V

    new-instance v8, Lcom/touchtype/personalizer/PersonalizerService$RunSmsParser;

    invoke-direct {v8, p0, v1, v7, v6}, Lcom/touchtype/personalizer/PersonalizerService$RunSmsParser;-><init>(Lcom/touchtype/personalizer/PersonalizerService;ZLjava/lang/String;I)V

    iput-object v8, p0, Lcom/touchtype/personalizer/PersonalizerService;->mSmsTimedTask:Ljava/lang/Runnable;

    sget-object v8, Lcom/touchtype/personalizer/PersonalizerService;->TAG:Ljava/lang/String;

    const-string v9, "Adding SMS parse job to queue"

    invoke-static {v8, v9}, Lcom/touchtype_fluency/service/util/LogUtil;->d(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, p0, Lcom/touchtype/personalizer/PersonalizerService;->mPersonalizerHandler:Landroid/os/Handler;

    iget-object v9, p0, Lcom/touchtype/personalizer/PersonalizerService;->mSmsTimedTask:Ljava/lang/Runnable;
    ...
    invoke-direct {p0, v13, v11, v10}, Lcom/touchtype/personalizer/PersonalizerService;->setPersonalizerState(IIZ)V

    invoke-direct {p0}, Lcom/touchtype/personalizer/PersonalizerService;->writeStoredState()V

    new-instance v8, Lcom/touchtype/personalizer/PersonalizerService$RunContactsParser;

    invoke-direct {v8, p0, v1, v7, v6}, Lcom/touchtype/personalizer/PersonalizerService$RunContactsParser;-><init>(Lcom/touchtype/personalizer/PersonalizerService;ZLjava/lang/String;I)V

    iput-object v8, p0, Lcom/touchtype/personalizer/PersonalizerService;->mContactsTimedTask:Ljava/lang/Runnable;

    sget-object v8, Lcom/touchtype/personalizer/PersonalizerService;->TAG:Ljava/lang/String;

    const-string v9, "Adding Contacts parse job to queue"

    invoke-static {v8, v9}, Lcom/touchtype_fluency/service/util/LogUtil;->d(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, p0, Lcom/touchtype/personalizer/PersonalizerService;->mPersonalizerHandler:Landroid/os/Handler;

    iget-object v9, p0, Lcom/touchtype/personalizer/PersonalizerService;->mContactsTimedTask:Ljava/lang/Runnable;
...
.method private initStoredState()V
    ...
    invoke-direct {p0, v2, v3, v8}, Lcom/touchtype/personalizer/PersonalizerService;->setPersonalizerState(IIZ)V
    ...
    invoke-direct {p0, v2, v4, v5}, Lcom/touchtype/personalizer/PersonalizerService;->setPersonalizerLastRun(IJ)V
...
.method public clearLanguageData()Z
    ...
    :try_start_0
    invoke-virtual {v7, v6}, Lcom/touchtype_fluency/util/SwiftKeySession;->clearUserData(Lcom/touchtype_fluency/util/LanguagePackManager;)Z
    :try_end_0
    ...
    invoke-static {v10}, Lcom/ime/framework/engine/swiftkey/SwiftkeyAutoTextManager;->getInstance(Landroid/content/Context;)Lcom/ime/framework/engine/swiftkey/SwiftkeyAutoTextManager;

    move-result-object v10

    invoke-virtual {v10}, Lcom/ime/framework/engine/swiftkey/SwiftkeyAutoTextManager;->removeCachedAllUserWord()V
    ...
    iget-object v10, p0, Lcom/touchtype/personalizer/PersonalizerService;->mPersonalizerState:Ljava/util/HashMap;
    ...
    iget-object v10, p0, Lcom/touchtype/personalizer/PersonalizerService;->mPersonalizerPreviousState:Ljava/util/HashMap;
    ...
    :goto_3
    iget-object v10, p0, Lcom/touchtype/personalizer/PersonalizerService;->mPersonalizerLastRun:Ljava/util/HashMap;
