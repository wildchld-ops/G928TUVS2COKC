...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;Lcom/touchtype_fluency/util/LanguagePackManager;)V
    ...
    iget-object v0, p0, Lcom/touchtype/personalizer/PersonalizationRequest;->mInputManager:Lcom/ime/framework/common/InputManager;
    ...
    iput-object v0, p0, Lcom/touchtype/personalizer/PersonalizationRequest;->mInputManager:Lcom/ime/framework/common/InputManager;
...
.method static synthetic access$300(Lcom/touchtype/personalizer/PersonalizationRequest;)Lcom/ime/framework/common/InputManager;
    .locals 1
...
.method private makeInitialRequest()V
    ...
    iget-object v10, p0, Lcom/touchtype/personalizer/PersonalizationRequest;->mUrlManager:Lcom/touchtype_fluency/service/util/UrlManager;

    invoke-virtual {v10}, Lcom/touchtype_fluency/service/util/UrlManager;->getInitialUrl()Ljava/net/URL;
    ...
    invoke-virtual {v2, v10}, Ljavax/net/ssl/HttpsURLConnection;->setInstanceFollowRedirects(Z)V
    ...
    iget-object v10, p0, Lcom/touchtype/personalizer/PersonalizationRequest;->mParams:Ljava/lang/String;

    invoke-direct {p0, v10}, Lcom/touchtype/personalizer/PersonalizationRequest;->addTextRetentionToParams(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    iput-object v10, p0, Lcom/touchtype/personalizer/PersonalizationRequest;->mParams:Ljava/lang/String;

    iget-object v10, p0, Lcom/touchtype/personalizer/PersonalizationRequest;->mParams:Ljava/lang/String;

    invoke-direct {p0, v10}, Lcom/touchtype/personalizer/PersonalizationRequest;->addAuthToParams(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v10}, Lcom/touchtype/personalizer/PersonalizationRequest;->addLocaleLanguageInfo(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    iput-object v10, p0, Lcom/touchtype/personalizer/PersonalizationRequest;->mParams:Ljava/lang/String;

    sget-object v10, Lcom/touchtype/personalizer/PersonalizationRequest;->TAG:Ljava/lang/String;
    ...
    iget-object v12, p0, Lcom/touchtype/personalizer/PersonalizationRequest;->mUrlManager:Lcom/touchtype_fluency/service/util/UrlManager;

    invoke-virtual {v12}, Lcom/touchtype_fluency/service/util/UrlManager;->getInitialUrl()Ljava/net/URL;
    ...
    iget-object v12, p0, Lcom/touchtype/personalizer/PersonalizationRequest;->mParams:Ljava/lang/String;
    ...
    invoke-static {v10, v11}, Lcom/touchtype_fluency/service/util/LogUtil;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lorg/apache/commons/io/IOUtils;->closeQuietly(Ljava/io/Writer;)V
    ...
    const-string v12, "makeInitialRequest: got response "
    ...
    const-string v12, "Personalization servers returned invalid HTTP result "
    ...
    invoke-static {v10, v11}, Lcom/touchtype_fluency/service/util/LogUtil;->w(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v10, Lcom/touchtype_fluency/service/util/ServerApiException;

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "Initial request, expected 301 or 503, got "
    ...
    invoke-direct {v10, v11}, Lcom/touchtype_fluency/service/util/ServerApiException;-><init>(Ljava/lang/String;)V
    ...
    :goto_0
    invoke-static {v8}, Lorg/apache/commons/io/IOUtils;->closeQuietly(Ljava/io/Writer;)V
    ...
    invoke-virtual {v10, v5}, Lcom/touchtype_fluency/service/util/UrlManager;->setRequestId(Ljava/lang/String;)V
    ...
    const-string v11, "Personalization servers are returning busy"

    invoke-static {v10, v11}, Lcom/touchtype_fluency/service/util/LogUtil;->w(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v10, Lcom/touchtype_fluency/service/util/ServerBusyException;

    const-string v11, "Servers returned busy"

    invoke-direct {v10, v11}, Lcom/touchtype_fluency/service/util/ServerBusyException;-><init>(Ljava/lang/String;)V
...
.method public deleteRemoteData(Lcom/touchtype/personalizer/PersonalizationListener;)V
    ...
    new-instance v2, Lcom/touchtype/personalizer/PersonalizationRequest$1;

    invoke-direct {v2, p0, v0, p1}, Lcom/touchtype/personalizer/PersonalizationRequest$1;-><init>(Lcom/touchtype/personalizer/PersonalizationRequest;Ljava/lang/String;Lcom/touchtype/personalizer/PersonalizationListener;)V

    invoke-virtual {v2}, Lcom/touchtype/personalizer/PersonalizationRequest$1;->start()V
