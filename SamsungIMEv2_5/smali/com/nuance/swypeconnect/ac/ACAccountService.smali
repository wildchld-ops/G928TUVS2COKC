...
.method constructor <init>(Lcom/nuance/connect/api/AccountService;)V
    ...
    iput-object v0, p0, Lcom/nuance/swypeconnect/ac/ACAccountService;->callbacks:Ljava/util/ArrayList;
...
# virtual methods
.method public createAccount(ILjava/lang/String;Lcom/nuance/swypeconnect/ac/ACDevice$ACDeviceType;Ljava/lang/String;)V
    .locals 3
    ...
    const-string v1, "Account identifier: "
    ...
    const-string v1, "Trying to create an account when one already exists."
    ...
    const-string v2, "Account creation exception.  Account has already been created."
    ...
    const-string v1, "Must supply a valid Device Type"
    ...
    const-string v2, "Account creation exception.  Unspecified device type"
    ...
    const-string v1, "Must supply a valid Device Name"
    ...
    const-string v2, "Account creation exception.  Unspecified device name."
    ...
    const-string v1, "Account creation exception.  Invalid email format"
    ...
    const-string v2, "The email address supplied is invalid"
    ...
    const-string v1, "unsupported type exception"
    ...
    const-string v2, "Account creation exception.  Unsupported account type"
...
.method public deleteAccount(Z)V
    ...
    const-string v1, "Account Exception deleting account.  No account found."
...
.method public getAccount()Lcom/nuance/swypeconnect/ac/ACAccount;
    .locals 2
...
.method public registerCallback(Lcom/nuance/swypeconnect/ac/ACAccountService$ACAccountCallback;)V
    ...
    iget-object v1, p0, Lcom/nuance/swypeconnect/ac/ACAccountService;->callbacks:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcom/nuance/swypeconnect/ac/ACAccountService;->callbacks:Ljava/util/ArrayList;
    ...
    new-instance v0, Lcom/nuance/swypeconnect/ac/ACAccountService$CallbackWrapper;

    iget-object v2, p0, Lcom/nuance/swypeconnect/ac/ACAccountService;->callbacks:Ljava/util/ArrayList;

    const/4 v3, 0x0

    invoke-direct {v0, v2, v3}, Lcom/nuance/swypeconnect/ac/ACAccountService$CallbackWrapper;-><init>(Ljava/util/ArrayList;Lcom/nuance/swypeconnect/ac/ACAccountService$1;)V
    ...
    invoke-virtual {v0, v2}, Lcom/nuance/swypeconnect/ac/ACAccountService$CallbackWrapper;->updateCallbacks(Ljava/util/ArrayList;)V
...
.method public removeDeviceFromAccount(Lcom/nuance/swypeconnect/ac/ACDevice;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/nuance/swypeconnect/ac/ACAccountService$ACAccountException;
    ...
    const-string v1, "Removing device."
    ...
    const-string v1, "Account Exception removing device.  No account found."
    ...
    const-string v1, "Account Exception removing device.  No matching device found."
    ...
    const-string v2, "Device not found, perhaps it was already deleted."
...
.method public reverify()V
    ...
    const-string v1, "Account Exception reverifying.  No account found."
    ...
    const-string v1, "Account Exception reverifying.  Account is already linked."
    ...
    const-string v2, "Reverify is not allowed on an account that has been linked."
...
.method public verifyAccount(Ljava/lang/String;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/nuance/swypeconnect/ac/ACAccountService$ACAccountException;
    ...
    const-string v1, "No account found to verify."
    ...
    const-string v2, "Account verification exception.  Account not found."
    ...
    const-string v1, "Account verification exception.  Account is already linked."
    ...
    const-string v2, "The account is already verified and the device is linked."
    ...
    const-string v1, "The verification string is null"
    ...
    const-string v2, "The verification code supplied is not valid."
