...
.method public constructor <init>(Lcom/nuance/swypeconnect/ac/ACScannerService;)V
    ...
    const-string v0, "SCANNER_MEDIA_LAST_RUN_CALENDAR"
...
.method private processMediaStore(Landroid/content/Context;Lcom/nuance/swypeconnect/ac/ACScannerMediaStore$MediaStoreReader;Lcom/nuance/connect/api/DLMConnector$ScannerBucket;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;J)V
    ...
    const-string v3, "Media Scanner processed "
    ...
    const-string v4, "Media Scanner processed "
...
.method scan()V
    ...
    invoke-virtual {p0, v2, v3, v3}, Lcom/nuance/swypeconnect/ac/ACScannerMediaStore;->getBucket([IIZ)Lcom/nuance/connect/api/DLMConnector$ScannerBucket;
    ...
    const-string v6, "begin media store scanning"
    ...
    const-string v1, "end media store scanning"
...
.method public setScanType([Lcom/nuance/swypeconnect/ac/ACScannerMediaStore$ACScannerMediaStoreType;)V
    .locals 2
...
.method public start(Lcom/nuance/swypeconnect/ac/ACScannerService$ACScannerCallback;)V
    ...
    const-string v2, "Media Scanner requires permission to read external storage"
