...
.field private trace:Lcom/nuance/connect/util/Logger$Trace;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/nuance/swypeconnect/ac/ACChinesePredictionServiceBase;->listCallbacks:Ljava/util/Set;
    ...
    iput-object v0, p0, Lcom/nuance/swypeconnect/ac/ACChinesePredictionServiceBase;->trace:Lcom/nuance/connect/util/Logger$Trace;
...
.method static synthetic access$100(Lcom/nuance/swypeconnect/ac/ACChinesePredictionServiceBase;)Lcom/nuance/connect/util/Logger$Trace;
    .locals 1

    iget-object v0, p0, Lcom/nuance/swypeconnect/ac/ACChinesePredictionServiceBase;->trace:Lcom/nuance/connect/util/Logger$Trace;

    return-object v0
.end method

.method static synthetic access$200(Lcom/nuance/swypeconnect/ac/ACChinesePredictionServiceBase;)Ljava/util/Set;
    .locals 1

    iget-object v0, p0, Lcom/nuance/swypeconnect/ac/ACChinesePredictionServiceBase;->listCallbacks:Ljava/util/Set;
...
.method dependenciesMet()Z
    ...
    const-string v1, "Attempting to use Chinese Prediction Service without a Chinese core enabled."
...
.method getName()Ljava/lang/String;
    ...
    const-string v0, "CHINESE_CLOUD_PREDICTION"
...
.method public logResultSelection(Ljava/lang/String;)V
    ...
    const-string v2, "Prediction Request on invalid prediction service"
...
.method public registerCallback(Lcom/nuance/swypeconnect/ac/ACChinesePredictionService$ACChinesePredictionCallback;)V
    ...
    iget-object v1, p0, Lcom/nuance/swypeconnect/ac/ACChinesePredictionServiceBase;->listCallbacks:Ljava/util/Set;
...
.method public requestPrediction([B)Ljava/lang/String;
    ...
    invoke-interface {v0, p1}, Lcom/nuance/connect/api/ChinesePredictionService;->requestPrediction([B)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lcom/nuance/swypeconnect/ac/ACChinesePredictionServiceBase;->trace:Lcom/nuance/connect/util/Logger$Trace;

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "predictionRequest: "
    ...
    const-string v2, "Prediction Request when session is not started"
...
.method public setIdleTimeout(I)V
    ...
    const-string v2, "Idle Timeout cannot be less then zero or more then ACChinesePredictionService.MAX_IDLE_TIMEOUT"
...
.method public setPredictionResults(I)V
    ...
    const-string v2, "Prediction Results cannot be less then zero or more then ACChinesePredictionService.MAX_PREDICTION_RESULTS"
...
.method public startSession(II)V
    ...
    const-string v2, "Both languageId and charactersetId must be proper values"
