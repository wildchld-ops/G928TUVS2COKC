...
.method public syncNow()V
    ...
    new-array v0, v2, [Lcom/nuance/connect/api/SyncService$DLMSyncCallback;
    ...
    invoke-virtual {v1, v3}, Lcom/nuance/connect/internal/ConnectServiceManagerInternal;->getFeatureService(Lcom/nuance/connect/common/ConnectFeature;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/nuance/connect/internal/DLMConnectorInternal;
    ...
    invoke-interface {v2, v4, v5}, Lcom/nuance/connect/api/SyncService$DLMSyncCallback;->onError(ILjava/lang/String;)V
