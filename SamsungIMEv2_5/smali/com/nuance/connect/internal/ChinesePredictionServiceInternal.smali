...
.field private final predictionCallbacks:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set",
            "<",
...
.method constructor <init>(Lcom/nuance/connect/internal/ConnectServiceManagerInternal;)V
    ...
    iput-object v0, p0, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->predictionCallbacks:Ljava/util/Set;
    ...
    iput-boolean v4, p0, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->useable:Z
    ...
    iput-object v0, p0, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->msgHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v1, v4}, Lcom/nuance/connect/system/Connectivity;->setStableCellularTime(I)V

    iget-object v1, p0, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->connectivity:Lcom/nuance/connect/system/Connectivity;

    invoke-virtual {v1, v4}, Lcom/nuance/connect/system/Connectivity;->setStableWifiTime(I)V
    ...
    new-instance v0, Lcom/nuance/connect/comm/CommandQueue$CommandQueueErrorHandlerDefault;

    invoke-direct {v0}, Lcom/nuance/connect/comm/CommandQueue$CommandQueueErrorHandlerDefault;-><init>()V

    new-instance v1, Lcom/nuance/connect/comm/CommandQueue;

    iget-object v2, p0, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->messageBus:Lcom/nuance/connect/comm/MessageSendingBus;

    invoke-direct {v1, v2, v0}, Lcom/nuance/connect/comm/CommandQueue;-><init>(Lcom/nuance/connect/comm/MessageSendingBus;Lcom/nuance/connect/comm/CommandQueue$CommandQueueErrorHandler;)V

    iput-object v1, p0, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->queue:Lcom/nuance/connect/comm/CommandQueue;
...
.method static synthetic access$1300(Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;Lcom/nuance/connect/api/ChinesePredictionService$ChinesePredictionResult;JJ)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->sendPredictionResponse(Lcom/nuance/connect/api/ChinesePredictionService$ChinesePredictionResult;JJ)V

    return-void
.end method

.method static synthetic access$1400(Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic access$1500(Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$1600(Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
...
.method static synthetic access$1700(Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;)Lcom/nuance/connect/sqlite/ChinesePredictionDataSource;
    .locals 1
...
.method static synthetic access$1802(Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;I)I
    .locals 0
...
.method static synthetic access$2000(Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$500(Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;)Landroid/os/Handler;
    .locals 1

    iget-object v0, p0, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->msgHandler:Landroid/os/Handler;

    return-object v0
.end method

.method static synthetic access$700(Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;Ljava/lang/String;ILjava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->sendPredictionFailure(Ljava/lang/String;ILjava/lang/String;)V

    return-void
.end method

.method private destroyConnectionQueue()V
    .locals 2
...
.method private sendLoggingToServer()V
    ...
    const-string v1, "sendLoggingToServer"
...
.method private sendPredictionCancel(Ljava/lang/String;)V
    ...
    const-string v1, "sendPredictionCancel("
    ...
    iget-object v1, p0, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->predictionCallbacks:Ljava/util/Set;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->predictionCallbacks:Ljava/util/Set;
    ...
    invoke-interface {v0, p1}, Lcom/nuance/connect/api/ChinesePredictionService$ChinesePredictionCallback;->onPredictionCancel(Ljava/lang/String;)V
    ...
    invoke-virtual/range {v0 .. v7}, Lcom/nuance/connect/sqlite/ChinesePredictionDataSource;->insertPrediction(Ljava/lang/String;Ljava/lang/String;IJJ)Z
...
.method private sendPredictionFailure(Ljava/lang/String;ILjava/lang/String;)V
    .locals 9
    ...
    const-string v1, "sendPredictionFailure("
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/nuance/connect/api/ChinesePredictionService$ChinesePredictionCallback;->onPredictionFailure(Ljava/lang/String;ILjava/lang/String;)V
...
.method private sendPredictionResponse(Lcom/nuance/connect/api/ChinesePredictionService$ChinesePredictionResult;JJ)V
    .locals 8

    iget-object v0, p0, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->log:Lcom/nuance/connect/util/Logger$Log;

    const-string v1, "sendPredictionResponse("
    ...
    invoke-interface {v0, p1}, Lcom/nuance/connect/api/ChinesePredictionService$ChinesePredictionCallback;->onPredictionResult(Lcom/nuance/connect/api/ChinesePredictionService$ChinesePredictionResult;)V
    :try_end_1
    ...
    const-string v2, "The client has thrown an exception to us: "
...
.method private sendPredictionStatus(ILjava/lang/String;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/nuance/connect/api/ChinesePredictionService$ChinesePredictionCallback;->onPredictionStatus(ILjava/lang/String;)V
...
.method private shutdownHandler()V
    ...
    invoke-direct {p0}, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->destroyConnectionQueue()V
...
.method private transmitOrShutdown()V
    ...
    const-string v1, "transmitOrShutdown processing now size="
...
.method public cancelPrediction(Ljava/lang/String;)V
    ...
    const-string v1, "cancelPrediction() predictionId="
...
.method public logResultSelection(Ljava/lang/String;)V
    ...
    const-string v1, "logResultSelection() predictionId="
...
.method public registerCallback(Lcom/nuance/connect/api/ChinesePredictionService$ChinesePredictionCallback;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;->predictionCallbacks:Ljava/util/Set;
...
.method public requestPrediction([B)Ljava/lang/String;
    ...
    const-string v1, "requestPrediction() sessionActive="
    ...
    invoke-direct/range {v0 .. v8}, Lcom/nuance/connect/internal/ChinesePredictionServiceInternal$ChinesePredictionTransaction;-><init>(Lcom/nuance/connect/internal/ChinesePredictionServiceInternal;Ljava/lang/String;IILjava/lang/String;[BLcom/nuance/connect/comm/PersistantConnectionConfig;I)V
...
.method public setIdleTimeout(I)V
    ...
    const-string v1, "Idle timeout cannot be less then 0"
    ...
    const-string v1, "Idle timeout cannot be greater then 60"
...
.method public setPredictionResults(I)V
    ...
    const-string v1, "prediction results cannot be less then 1"
    ...
    const-string v1, "prediction results cannot be greater then 10"
...
.method public startSession(II)V
    ...
    const-string v3, "Session already started."
    ...
    const-string v2, "Device is not registered, unable to process prediction request"
    ...
    const-string v4, "Device must be registered before attempting to use "
    ...
    const-string v3, "Starting Session url="
