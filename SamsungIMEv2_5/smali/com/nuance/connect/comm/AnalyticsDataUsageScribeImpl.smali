...
.method constructor <init>(Lcom/nuance/connect/comm/MessageSendingBus;)V
    ...
    invoke-interface {p1}, Lcom/nuance/connect/comm/MessageSendingBus;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/nuance/connect/sqlite/ReportingDataSource;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->dataSource:Lcom/nuance/connect/sqlite/ReportingDataSource;

    invoke-virtual {p0}, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->start()V
...
.method public flush()V
    ...
    iget-object v1, p0, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->dataSource:Lcom/nuance/connect/sqlite/ReportingDataSource;

    const-string v2, "C001"

    const-string v3, "CELLULAR_RX"

    iget-wide v4, p0, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->lastRxBytes:J
    ...
    iput-wide v12, p0, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->lastRxBytes:J
    ...
    iget-wide v4, p0, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->lastTxBytes:J
    ...
    iput-wide v12, p0, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->lastTxBytes:J
...
.method public mark()V
    ...
    iget v0, p0, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->trackNetworkUsageLength:I

    const/4 v1, -0x1

    if-eq v0, v1, :cond_1

    iget-wide v0, p0, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->trackNetworkUsageStart:J
    ...
    iget-wide v2, p0, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->trackNetworkUsageStart:J
    ...
    invoke-virtual {p0}, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->flush()V
...
.method public setTrackingInterval(I)V
    ...
    iput p1, p0, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->trackNetworkUsageLength:I
...
.method public start()V
    ...
    iput-wide v2, p0, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->lastRxBytes:J

    invoke-static {v0}, Lcom/nuance/connect/compat/TrafficStatsCompat;->getUidTxBytes(I)J

    move-result-wide v0

    iput-wide v0, p0, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->lastTxBytes:J
...
.method public writeRequest(Lcom/nuance/connect/comm/Command;J)V
    ...
    invoke-direct {p0, p1}, Lcom/nuance/connect/comm/AnalyticsDataUsageScribeImpl;->commandToURL(Lcom/nuance/connect/comm/Command;)Ljava/lang/String;
