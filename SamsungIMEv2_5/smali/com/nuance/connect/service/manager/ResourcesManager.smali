...
.method private getImageResource(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/nuance/connect/service/manager/ResourcesManager;->createCommand(Ljava/lang/String;Lcom/nuance/connect/comm/Command$REQUEST_TYPE;)Lcom/nuance/connect/comm/Command;

    move-result-object v0

    iput-object p1, v0, Lcom/nuance/connect/comm/Command;->thirdPartyURL:Ljava/lang/String;

    const-string v1, "GET"

    iput-object v1, v0, Lcom/nuance/connect/comm/Command;->method:Ljava/lang/String;

    iput-boolean v2, v0, Lcom/nuance/connect/comm/Command;->hasBody:Z

    iput-boolean v2, v0, Lcom/nuance/connect/comm/Command;->handleIOException:Z

    iput-boolean v2, v0, Lcom/nuance/connect/comm/Command;->notifyDownloadStatus:Z

    const/4 v1, 0x1

    iput-boolean v1, v0, Lcom/nuance/connect/comm/Command;->allowDuplicateOfCommand:Z

    invoke-virtual {p0, v0}, Lcom/nuance/connect/service/manager/ResourcesManager;->sendCommand(Lcom/nuance/connect/comm/Command;)V
...
.method public onFileResponse(Lcom/nuance/connect/comm/Response;)V
    ...
    iget-object v2, v2, Lcom/nuance/connect/comm/Command;->thirdPartyURL:Ljava/lang/String;
    ...
    invoke-virtual {v2, v3, p1}, Lcom/nuance/connect/service/manager/AbstractCommandManager$ValidCommands;->isResponseFor(Ljava/lang/String;Lcom/nuance/connect/comm/Response;)Z
    ...
    invoke-virtual {v2, v0, v1}, Lcom/nuance/connect/service/ConnectClient;->sendMessageToHost(Lcom/nuance/connect/internal/common/InternalMessages;Landroid/os/Bundle;)V
    ...
    iget-object v3, p1, Lcom/nuance/connect/comm/Response;->fileLocation:Ljava/lang/String;
