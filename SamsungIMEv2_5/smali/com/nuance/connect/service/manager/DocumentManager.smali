...
.method private getDocument(Ljava/lang/String;)V
    ...
    const-string v1, "Document URL does not exist.  Ignoring: "
    ...
    iput-boolean v3, v0, Lcom/nuance/connect/comm/Command;->handleIOException:Z
...
.method private processListResponse(Lcom/nuance/connect/comm/Response;)V
    ...
    invoke-direct {p0, v5, v6, v2}, Lcom/nuance/connect/service/manager/DocumentManager;->buildDocId(III)Ljava/lang/String;

    move-result-object v8

    invoke-interface {v4, v8}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    sget-object v9, Lcom/nuance/connect/internal/common/Document$DocumentType;->TERMS_OF_SERVICE:Lcom/nuance/connect/internal/common/Document$DocumentType;

    invoke-virtual {v9}, Lcom/nuance/connect/internal/common/Document$DocumentType;->getDocTypeId()I

    move-result v9

    if-eq v5, v9, :cond_0

    sget-object v9, Lcom/nuance/connect/internal/common/Document$DocumentType;->DATA_OPT_IN:Lcom/nuance/connect/internal/common/Document$DocumentType;
    ...
    :cond_0
    iget-object v9, p0, Lcom/nuance/connect/service/manager/DocumentManager;->docMetadata:Lcom/nuance/connect/util/InstallMetadata;

    invoke-virtual {v9, v8}, Lcom/nuance/connect/util/InstallMetadata;->hasPackage(Ljava/lang/String;)Z

    move-result v9

    if-nez v9, :cond_2

    iget-object v9, p0, Lcom/nuance/connect/service/manager/DocumentManager;->log:Lcom/nuance/connect/util/Logger$Log;

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "Server provided new document revision type["
    ...
    invoke-virtual {v9, v8}, Lcom/nuance/connect/util/InstallMetadata;->addPackage(Ljava/lang/String;)Z

    iget-object v9, p0, Lcom/nuance/connect/service/manager/DocumentManager;->docMetadata:Lcom/nuance/connect/util/InstallMetadata;

    const-string v10, "25"

    invoke-virtual {v9, v8, v10, v5}, Lcom/nuance/connect/util/InstallMetadata;->setProp(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {v5, v8, v9, v6}, Lcom/nuance/connect/util/InstallMetadata;->setProp(Ljava/lang/String;Ljava/lang/String;I)V

    iget-object v5, p0, Lcom/nuance/connect/service/manager/DocumentManager;->docMetadata:Lcom/nuance/connect/util/InstallMetadata;

    const-string v6, "108"

    invoke-virtual {v5, v8, v6, v2}, Lcom/nuance/connect/util/InstallMetadata;->setProp(Ljava/lang/String;Ljava/lang/String;I)V

    iget-object v2, p0, Lcom/nuance/connect/service/manager/DocumentManager;->docMetadata:Lcom/nuance/connect/util/InstallMetadata;

    const-string v5, "51"

    invoke-virtual {v2, v8, v5, v7}, Lcom/nuance/connect/util/InstallMetadata;->setProp(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v8, v5, v6}, Lcom/nuance/connect/util/InstallMetadata;->setProp(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, p0, Lcom/nuance/connect/service/manager/DocumentManager;->docMetadata:Lcom/nuance/connect/util/InstallMetadata;

    const-string v5, "TIME_ACCEPTED"

    const-wide/high16 v6, -0x8000000000000000L

    invoke-virtual {v2, v8, v5, v6, v7}, Lcom/nuance/connect/util/InstallMetadata;->setProp(Ljava/lang/String;Ljava/lang/String;J)V

    iget-object v2, p0, Lcom/nuance/connect/service/manager/DocumentManager;->docMetadata:Lcom/nuance/connect/util/InstallMetadata;

    const/4 v5, 0x1

    invoke-virtual {v2, v8, v5}, Lcom/nuance/connect/util/InstallMetadata;->setStep(Ljava/lang/String;I)V

    iget-object v2, p0, Lcom/nuance/connect/service/manager/DocumentManager;->docMetadata:Lcom/nuance/connect/util/InstallMetadata;

    const-string v5, "11"

    invoke-virtual {v2, v8, v5, v1}, Lcom/nuance/connect/util/InstallMetadata;->setProp(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0, v8}, Lcom/nuance/connect/service/manager/DocumentManager;->getDocument(Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v8, v10}, Lcom/nuance/connect/util/InstallMetadata;->getProp(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v11, "Updating for current language; document revision type["
    ...
    invoke-interface {v9, v2}, Lcom/nuance/connect/util/Logger$Log;->d(Ljava/lang/Object;)V
    ...
    :try_start_2
    iget-object v5, p0, Lcom/nuance/connect/service/manager/DocumentManager;->log:Lcom/nuance/connect/util/Logger$Log;

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "Error processing json object "
    ...
    invoke-interface {v5, v2}, Lcom/nuance/connect/util/Logger$Log;->d(Ljava/lang/Object;)V
    :try_end_2
    ...
    invoke-virtual {v2, v8}, Lcom/nuance/connect/util/InstallMetadata;->isInstalling(Ljava/lang/String;)Z
    ...
    const-string v2, "   Document is accepted.  Keeping the document"
...
.method private reprocessList()V
    ...
    const-string v5, "document found that is installing, getting document"
