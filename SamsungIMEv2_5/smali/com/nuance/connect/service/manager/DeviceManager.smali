...
.method private deviceRegistrationComplete(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "Device registration complete! DeviceId["

    const-string v3, "] swyperId["
    ...
    const-string v2, "processRegisterDeviceAckResponse() sessionId:"
...
.method private processDeviceValidateRequest(Lcom/nuance/connect/comm/Response;)V
    .locals 2
...
.method private processRequestConfigurationResponse(Lcom/nuance/connect/comm/Response;)V
    ...
    iget-object v4, p1, Lcom/nuance/connect/comm/Response;->parameters:Ljava/util/HashMap;
...
.method private processValidateDeviceRegistrationResponse(Lcom/nuance/connect/comm/Response;)V
    ...
    const-string v1, "Device validation is currently unsupported."
...
.method public onHandleMessage(Landroid/os/Message;)Z
    ...
    const-class v2, Lcom/nuance/connect/comm/Response;
    ...
    invoke-direct {p0, v0}, Lcom/nuance/connect/service/manager/DeviceManager;->processDeviceValidateRequest(Lcom/nuance/connect/comm/Response;)V
...
.method public registerDevice()V
    ...
    const-string v1, "Attempting to register device before DeviceManager has started"
    ...
    const-string v1, "Attempting to register device when it is already registered.  If this is intentional, please de-register before registering."
    ...
    const-string v1, "Attempting to register device when command is already being processed"
    ...
    new-instance v0, Lcom/nuance/connect/service/manager/DeviceManager$DeviceRegistrationTransaction;

    iget-object v1, p0, Lcom/nuance/connect/service/manager/DeviceManager;->deviceProperties:Ljava/util/HashMap;

    invoke-direct {v0, p0, v1}, Lcom/nuance/connect/service/manager/DeviceManager$DeviceRegistrationTransaction;-><init>(Lcom/nuance/connect/service/manager/DeviceManager;Ljava/util/Map;)V

    invoke-virtual {p0, v0}, Lcom/nuance/connect/service/manager/DeviceManager;->startTransaction(Lcom/nuance/connect/comm/Transaction;)V
...
.method public declared-synchronized resetDevice()V
    .locals 3
...
.method public updateDeviceRegistration()Z
    ...
    invoke-direct {v1, p0, v0}, Lcom/nuance/connect/service/manager/DeviceManager$1;-><init>(Lcom/nuance/connect/service/manager/DeviceManager;Lcom/nuance/connect/comm/Command;)V
