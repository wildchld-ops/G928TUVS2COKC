...
.field public static final DLM_SYNC_USER_ENABLED:Ljava/lang/String; = "DLM_SYNC_USER_ENABLED"
...
.method static synthetic access$1000(Lcom/nuance/connect/service/manager/DlmSyncManager;)Lcom/nuance/connect/sqlite/DlmEventsDataSource;
    .locals 1
...
.method static synthetic access$1200(Lcom/nuance/connect/service/manager/DlmSyncManager;)Z
    .locals 1
...
.method static synthetic access$1600(Lcom/nuance/connect/service/manager/DlmSyncManager;ILjava/lang/String;)V
    .locals 0
...
.method static synthetic access$1700(Lcom/nuance/connect/service/manager/DlmSyncManager;ILjava/util/ArrayList;)V
    .locals 0
...
.method static synthetic access$2000(Lcom/nuance/connect/service/manager/DlmSyncManager;)V
    .locals 0
...
.method static synthetic access$300(Lcom/nuance/connect/service/manager/DlmSyncManager;)Ljava/util/HashMap;
    .locals 1
...
.method static synthetic access$400(Lcom/nuance/connect/service/manager/DlmSyncManager;)Ljava/lang/Boolean;
    .locals 1
...
.method static synthetic access$500(Lcom/nuance/connect/service/manager/DlmSyncManager;)V
    .locals 0
...
.method static synthetic access$600(Lcom/nuance/connect/service/manager/DlmSyncManager;)Ljava/util/Set;
    .locals 1
...
.method static synthetic access$800(Lcom/nuance/connect/service/manager/DlmSyncManager;)V
    .locals 0
...
.method static synthetic access$900(Lcom/nuance/connect/service/manager/DlmSyncManager;)Lcom/nuance/connect/util/Logger$Log;
    .locals 1
...
.method private backup(Ljava/lang/String;I)V
    ...
    const-string v2, "DLMManager.backup()  category="
    ...
    const-string v1, "    Backup already for unsupported category!  (Initialization failure?)"
    ...
    const-string v1, "    Backup already in progress. Ignoring request."
...
.method private checkBackupRequired()V
    ...
    const-string v1, "checkBackupRequired(): backup is required"
...
.method private checkDlmSync()V
    ...
    const-string v1, "checkDlmSync(): dlmEnabled not enabled"
    ...
    const-string v4, "DLMManager.checkDlmSync() currentCategory="
    ...
    const-string v3, "category not supported: "
...
.method private loadPreferences()V
    ...
    iput-object v1, p0, Lcom/nuance/connect/service/manager/DlmSyncManager;->categoryState:Ljava/util/HashMap;

    sget-object v3, Lcom/nuance/connect/service/manager/DlmSyncManager;->supportedCategories:[Ljava/lang/Integer;
    ...
    const-string v7, "CATEGORY_STATE"
    ...
    invoke-interface {v2, v6, v8}, Lcom/nuance/connect/store/PersistentDataStore;->readString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    new-instance v7, Lcom/nuance/connect/service/manager/DlmSyncManager$DlmState;

    invoke-direct {v7, v6}, Lcom/nuance/connect/service/manager/DlmSyncManager$DlmState;-><init>(Ljava/lang/String;)V

    iget-object v6, p0, Lcom/nuance/connect/service/manager/DlmSyncManager;->categoryState:Ljava/util/HashMap;
    ...
    invoke-virtual {v1}, Lcom/nuance/connect/service/ConnectClient;->isAccountLinked()Z

    move-result v1

    if-eqz v1, :cond_1

    const-string v0, "DLM_SYNC_ENABLED"

    invoke-interface {v2, v0, v1}, Lcom/nuance/connect/store/PersistentDataStore;->readBoolean(Ljava/lang/String;Z)Z
    ...
    const-string v0, "DLM_SYNC_USER_ENABLED"

    invoke-interface {v2, v0, v8}, Lcom/nuance/connect/store/PersistentDataStore;->readBoolean(Ljava/lang/String;Ljava/lang/Boolean;)Ljava/lang/Boolean;
...
.method private push()V
    ...
    const-string v1, "DLMManager.push()"
    ...
    const-string v1, "DLMManager.push() found no categories; exitting push"
    ...
    invoke-virtual {v1, v2, v6, v7}, Lcom/nuance/connect/sqlite/DlmEventsDataSource;->clearEvents(IJ)V
    ...
    const-string v11, "   DLMManager.push() category="
...
.method private sendReceivedEvents(ILjava/util/ArrayList;)V
    ...
    const-string v3, "Could not send the received events to the host: "
...
.method private sendTransaction(Lcom/nuance/connect/comm/Transaction;)V
    ...
    const-string v2, "sendTransaction(): dropping transaction: "
...
.method private setDlmEventsTimer()V
    ...
    const-string v1, "    DLM Sync Disabled. Ignoring request to set timer."
    ...
    const-string v4, "DLM_EVENTS_SEND"
    ...
    const-string v3, "setDlmEventsTimer() "
...
.method public onHandleMessage(Landroid/os/Message;)Z
    ...
    const-string v4, "MESSAGE_COMMAND_PULL_DLM_EVENTS category="
    ...
    const-string v4, "MESSAGE_COMMAND_DLM_BACKUP_REQUIRED category="
    ...
    const-string v4, "    backupRequired = "
    ...
    const-string v2, "MESSAGE_CLIENT_DLM_RESTORE"
    ...
    const-string v2, "MESSAGE_CLIENT_DLM_BACKUP_EVENTS"
    ...
    const-string v2, "MESSAGE_CLIENT_DLM_SYNC_NOW"
    ...
    const-string v4, "MESSAGE_CLIENT_SET_DLM_STATUS changed="
...
.method public onResponse(Lcom/nuance/connect/comm/Response;)V
    ...
    const-string v1, "Unexpected response.  Command="
