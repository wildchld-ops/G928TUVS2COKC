...
.method public onDriveModeChange(Z)V
    ...
    invoke-interface {v0, p1}, Lcom/ime/framework/common/InputManager;->setCarInDrivingMode(Z)V

    iget-object v0, p0, Lcom/sec/android/inputmethod/MirrorLinkBroadcastReceiver$4;->this$0:Lcom/sec/android/inputmethod/MirrorLinkBroadcastReceiver;

    iget-object v0, v0, Lcom/sec/android/inputmethod/MirrorLinkBroadcastReceiver;->mInputManager:Lcom/ime/framework/common/InputManager;

    invoke-interface {v0}, Lcom/ime/framework/common/InputManager;->closeKeyboard()V
