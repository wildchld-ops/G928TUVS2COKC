...
.method private static declared-synchronized downloadLiveLanguagePack(Landroid/content/Context;)V
    ...
    :cond_2
    :try_start_1
    invoke-static {p0}, Lcom/ime/framework/engine/swiftkey/SwiftkeyWrapper;->getLanguagePackManager(Landroid/content/Context;)Lcom/touchtype_fluency/util/LanguagePackManager;
    :try_end_1
...
.method public static onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const-string v1, "com.sec.android.inputmethod.ACTION_ALARM_LIVELANGUAGE"
    ...
    sput-boolean v1, Lcom/sec/android/inputmethod/SwiftkeyLiveLanguageManager;->mNeedToUpdateLanguageList:Z
...
.method private static declared-synchronized updateLanguagePackList(Landroid/content/Context;)Z
    ...
    invoke-virtual {v1, v3}, Lcom/myscript/atk/rmc/VOLanguagePackManager;->updateVOLanguagePackManager(Lcom/touchtype_fluency/util/RefreshListener;)V
