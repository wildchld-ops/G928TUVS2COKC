...
.method constructor <init>(Landroid/bluetooth/IBluetoothManager;)V
    ...
    iput-object v1, p0, Landroid/bluetooth/BluetoothAdapter;->mBluetoothStateChangeCallback:Landroid/bluetooth/IBluetoothStateChangeCallback;
    ...
    invoke-interface {p1, v1}, Landroid/bluetooth/IBluetoothManager;->customRegisterStateChangeCallback(Landroid/bluetooth/IBluetoothStateChangeCallback;)V
    :try_end_0
...
.method public BleAlwaysOn(Z)Z
    ...
    const-string/jumbo v3, "setBleAutoEnable, Adapter.BleAlwaysOn"
    ...
    invoke-interface {v1, p1}, Landroid/bluetooth/IBluetoothManager;->setBleAutoEnable(Z)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public enable()Z
    ...
    const-string v3, "BluetoothAdapter -- enable() called by PID : "
...
.method protected finalize()V
    ...
    invoke-interface {v1, v2}, Landroid/bluetooth/IBluetoothManager;->customUnregisterStateChangeCallback(Landroid/bluetooth/IBluetoothStateChangeCallback;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setStandAloneBleMode()V
    .locals 4
    ...
    const-string/jumbo v2, "setting StandAloneBleMode"

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    sput-boolean v3, Landroid/bluetooth/BluetoothAdapter;->sShouldAllowUseOfLeApi:Z
