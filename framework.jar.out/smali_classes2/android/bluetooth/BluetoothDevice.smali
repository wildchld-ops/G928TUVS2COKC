...
.field public static final ACTION_AUTHORIZE_REQUEST:Ljava/lang/String; = "com.samsung.bluetooth.device.action.ACTION_AUTHORIZE_REQUEST"
...
.field public static final EXTRA_DISC_RAW_DATA:Ljava/lang/String; = "android.bluetooth.device.extra.DISC_RAW_DATA"
...
.method public createBond()Z
    ...
    invoke-interface {v4, p0, v5}, Landroid/bluetooth/IBluetooth;->createBond(Landroid/bluetooth/BluetoothDevice;I)Z
...
.method public getDiscoveryRawData()[B
    .locals 4
    ...
    const-string v3, "BT not enabled. Cannot get Discovery Raw Data"
    ...
    const-string/jumbo v3, "sService.getDiscoveryRawData(this);"

    invoke-static {v2, v3}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    sget-object v2, Landroid/bluetooth/BluetoothDevice;->sService:Landroid/bluetooth/IBluetooth;

    invoke-interface {v2, p0}, Landroid/bluetooth/IBluetooth;->getDiscoveryRawData(Landroid/bluetooth/BluetoothDevice;)[B
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
