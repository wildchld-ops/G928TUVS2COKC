...
# instance fields
.field final PASTE_ID:I

.field am:Landroid/view/accessibility/AccessibilityManager;

.field private mActionModeMenu:Landroid/view/Menu;

.field mActionPopupMode:Z
...
.field private mDetachingFromWindow:Z
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Landroid/widget/Editor;->isUSA()Z
    ...
    sput v2, Landroid/widget/Editor;->TOP_LINE:I
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-boolean v4, p0, Landroid/widget/Editor;->mIsSuggestionsPopup:Z
    ...
    iput v4, p0, Landroid/widget/Editor;->mCursorShiftOffset:I

    iput-object v3, p0, Landroid/widget/Editor;->am:Landroid/view/accessibility/AccessibilityManager;
    ...
    iput v4, p0, Landroid/widget/Editor;->selection_start:I

    iput v4, p0, Landroid/widget/Editor;->selection_end:I

    iput-boolean v5, p0, Landroid/widget/Editor;->mCurrentTranslateEnable:Z

    iput-boolean v5, p0, Landroid/widget/Editor;->mTranslateEnable:Z
    ...
    iput-boolean v4, p0, Landroid/widget/Editor;->mActionPopupMode:Z

    iput-boolean v4, p0, Landroid/widget/Editor;->mNewSelectionActionMode:Z

    iput-boolean v5, p0, Landroid/widget/Editor;->mEnableActionPopupWindow:Z

    iput-boolean v4, p0, Landroid/widget/Editor;->mShareEnable:Z

    iput-boolean v4, p0, Landroid/widget/Editor;->mWebSearchEnable:Z

    iput-boolean v5, p0, Landroid/widget/Editor;->mClipboardEnable:Z

    iput-boolean v5, p0, Landroid/widget/Editor;->mDictionaryEnable:Z

    iput-boolean v5, p0, Landroid/widget/Editor;->mPasteEnable:Z

    const/16 v2, 0x3e7

    iput v2, p0, Landroid/widget/Editor;->PASTE_ID:I
    ...
    iput-object v2, p0, Landroid/widget/Editor;->am:Landroid/view/accessibility/AccessibilityManager;
...
.method static synthetic access$2402(Landroid/widget/Editor;Z)Z
    .locals 0
...
.method static synthetic access$2500(Landroid/widget/Editor;I)Z
    .locals 1
...
.method static synthetic access$3300(Landroid/widget/Editor;)Landroid/graphics/Rect;
    .locals 1
...
.method static synthetic access$3302(Landroid/widget/Editor;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    .locals 0
...
.method static synthetic access$3600(Landroid/widget/Editor;)Landroid/view/Menu;
    .locals 1
...
.method static synthetic access$3602(Landroid/widget/Editor;Landroid/view/Menu;)Landroid/view/Menu;
    .locals 0
...
.method static synthetic access$3800(Landroid/widget/Editor;)Z
    ...
    invoke-direct {p0}, Landroid/widget/Editor;->isTablet()Z
...
.method static synthetic access$3900(Landroid/widget/Editor;FF)Z
    .locals 1
...
.method static synthetic access$4100(Landroid/widget/Editor;)I
    ...
    iget v0, p0, Landroid/widget/Editor;->mCursorShiftOffset:I
...
.method static synthetic access$4700(Landroid/widget/Editor;FF)Z
    .locals 1
...
.method static synthetic access$4800(Landroid/widget/Editor;)I
    .locals 1
...
.method static synthetic access$5000(Landroid/widget/Editor;)Landroid/content/BroadcastReceiver;
    .locals 1
...
.method private isDictionaryEnabled()Z
    ...
    invoke-virtual {v3}, Landroid/widget/TextView;->isFinishSetupWizard()Z
...
.method finishBatchEdit(Landroid/widget/Editor$InputMethodState;)V
    ...
    iget-boolean v0, p0, Landroid/widget/Editor;->mDetachingFromWindow:Z
...
.method onAttachedToWindow()V
    ...
    iput-boolean v3, p0, Landroid/widget/Editor;->mDetachingFromWindow:Z
...
.method onTouchUpEvent(Landroid/view/MotionEvent;)V
    ...
    iput-boolean v3, p0, Landroid/widget/Editor;->mActionPopupMode:Z
...
.method public performLongClick(Z)Z
    ...
    iget-object v9, p0, Landroid/widget/Editor;->am:Landroid/view/accessibility/AccessibilityManager;

    invoke-virtual {v9}, Landroid/view/accessibility/AccessibilityManager;->isTwoFingerGestureRecognitionEnabled()Z
    ...
    invoke-virtual {v9}, Landroid/view/accessibility/AccessibilityManager;->isUniversalSwitchEnabled()Z

    move-result v9

    if-nez v9, :cond_7

    iget-boolean v9, p0, Landroid/widget/Editor;->mEnableActionPopupWindow:Z

    if-eqz v9, :cond_7

    const-string v9, "Editor"

    const-string v10, "Accessibility two finger gesture not enabled"
    ...
    const-string v10, "else Accessibility two finger gesture not enabled"
...
.method public relocateActionPopupWindow()V
    .locals 1

    iget-boolean v0, p0, Landroid/widget/Editor;->mActionPopupMode:Z
    ...
    invoke-virtual {v0}, Landroid/widget/Editor$InsertionPointCursorController;->relocateActionPopupWindow()V
...
.method public setNewActionPopupMenu(IZ)V
    ...
    :sswitch_0
    iput-boolean p2, p0, Landroid/widget/Editor;->mPasteEnable:Z
...
.method public translateRegister(Ljava/lang/String;II)V
    ...
    iget v3, p0, Landroid/widget/Editor;->mInputType:I
    ...
    iget-object v4, p0, Landroid/widget/Editor;->mReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v4, p0, Landroid/widget/Editor;->mCaller:Ljava/lang/CharSequence;
    ...
    const-string v4, "Fail to launch translate."
