...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v6}, Landroid/widget/Editor;->access$4800(Landroid/widget/Editor;)I
    ...
    invoke-static {v6, v4}, Landroid/widget/Editor;->access$4802(Landroid/widget/Editor;I)I

    :cond_0
    iget-object v6, p0, Landroid/widget/Editor$2;->this$0:Landroid/widget/Editor;

    # getter for: Landroid/widget/Editor;->selection_end:I
    invoke-static {v6}, Landroid/widget/Editor;->access$4900(Landroid/widget/Editor;)I
    ...
    invoke-static {v6, v3}, Landroid/widget/Editor;->access$4902(Landroid/widget/Editor;I)I
    ...
    # getter for: Landroid/widget/Editor;->selection_start:I
    invoke-static {v7}, Landroid/widget/Editor;->access$4800(Landroid/widget/Editor;)I
    ...
    # getter for: Landroid/widget/Editor;->selection_end:I
    invoke-static {v8}, Landroid/widget/Editor;->access$4900(Landroid/widget/Editor;)I
    ...
    invoke-static {v7}, Landroid/widget/Editor;->access$5000(Landroid/widget/Editor;)Landroid/content/BroadcastReceiver;
