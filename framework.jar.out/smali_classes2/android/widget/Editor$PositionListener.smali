...
.method static synthetic access$1700(Landroid/widget/Editor$PositionListener;)I
    .locals 1
...
.method static synthetic access$1800(Landroid/widget/Editor$PositionListener;)I
    .locals 1
...
.method static synthetic access$1900(Landroid/widget/Editor$PositionListener;)Z
    .locals 1
...
.method static synthetic access$2000(Landroid/widget/Editor$PositionListener;)Z
    .locals 1
...
.method static synthetic access$2100(Landroid/widget/Editor$PositionListener;Landroid/widget/Editor$TextViewPositionListener;IIZZ)V
    .locals 0
...
.method public onPreDraw()Z
    ...
    invoke-virtual {v5}, Landroid/widget/Editor;->removeMessage()V
    ...
    iget-object v5, p0, Landroid/widget/Editor$PositionListener;->mCanMove:[Z
    ...
    :cond_0
    iget-object v5, p0, Landroid/widget/Editor$PositionListener;->mPositionListeners:[Landroid/widget/Editor$TextViewPositionListener;
    ...
    instance-of v5, v4, Landroid/widget/Editor$HandleView;
    ...
    iget-boolean v5, v5, Landroid/widget/Editor;->mActionPopupMode:Z
    ...
    iget v5, v0, Landroid/widget/Editor$HandleView;->mHandleType:I

    iput v5, v3, Landroid/os/Message;->what:I

    :cond_3
    iget-object v5, p0, Landroid/widget/Editor$PositionListener;->mDelayHandler:Landroid/os/Handler;
    ...
    iget v6, p0, Landroid/widget/Editor$PositionListener;->mDelayTime:I
    ...
    :cond_6
    iget v5, p0, Landroid/widget/Editor$PositionListener;->mPositionX:I
    ...
    iget-boolean v8, p0, Landroid/widget/Editor$PositionListener;->mScrollHasChanged:Z

    invoke-interface {v4, v5, v6, v7, v8}, Landroid/widget/Editor$TextViewPositionListener;->updatePosition(IIZZ)V

    goto :goto_1

    :cond_7
    iput-boolean v9, p0, Landroid/widget/Editor$PositionListener;->mScrollHasChanged:Z
