...
.method public relocateActionPopupWindow()V
    ...
    invoke-virtual {v0, v1}, Landroid/widget/Editor$InsertionHandleView;->showActionPopupWindow(I)V
    ...
    iget-object v0, v0, Landroid/widget/Editor$InsertionHandleView;->mActionPopupWindow:Landroid/widget/Editor$ActionPopupWindow;
...
.method public show()V
    ...
    const-string v1, "isTwoFingerGestureRecognitionEnabled1"
    ...
    const-string v1, "isTwoFingerGestureRecognitionEnabled1else"
...
.method public showWithActionPopup()V
    ...
    iget-object v1, v1, Landroid/widget/Editor;->am:Landroid/view/accessibility/AccessibilityManager;

    invoke-virtual {v1}, Landroid/view/accessibility/AccessibilityManager;->isTwoFingerGestureRecognitionEnabled()Z
    ...
    invoke-virtual {v1}, Landroid/view/accessibility/AccessibilityManager;->isUniversalSwitchEnabled()Z
    ...
    iget-boolean v1, v1, Landroid/widget/Editor;->mEnableActionPopupWindow:Z

    if-eqz v1, :cond_0

    const-string v1, "Editor"

    const-string v2, "isTwoFingerGestureRecognitionEnabled2"
    ...
    invoke-virtual {v1}, Landroid/widget/Editor$InsertionHandleView;->showWithActionPopup()V

    iget-object v1, p0, Landroid/widget/Editor$InsertionPointCursorController;->this$0:Landroid/widget/Editor;

    iget-boolean v1, v1, Landroid/widget/Editor;->mShowSoftInputOnFocus:Z
    ...
    const-string v2, "isTwoFingerGestureRecognitionEnabled2else"
