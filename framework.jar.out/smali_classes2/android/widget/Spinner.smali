...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/widget/Spinner$SettingsObserver;,
...
.field private mShowingBgBtnObserver:Landroid/widget/Spinner$SettingsObserver;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/widget/Spinner;->SHOW_BTN_BG:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;III)V
    ...
    iput-boolean v8, p0, Landroid/widget/Spinner;->mIsShowButtonBackground:Z
    ...
    :cond_1
    iget-boolean v1, p0, Landroid/widget/Spinner;->mIsDeviceDefault:Z

    if-eqz v1, :cond_2

    sget-boolean v1, Landroid/widget/Spinner;->SHOW_BTN_BG:Z
    ...
    iput-boolean v3, p0, Landroid/widget/Spinner;->mIsShowButtonBackground:Z

    invoke-virtual {p0}, Landroid/widget/Spinner;->getBackground()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, p0, Landroid/widget/Spinner;->mDefaultBackground:Landroid/graphics/drawable/Drawable;

    new-instance v1, Landroid/widget/Spinner$SettingsObserver;

    invoke-direct {v1, p0, p1, p0}, Landroid/widget/Spinner$SettingsObserver;-><init>(Landroid/widget/Spinner;Landroid/content/Context;Landroid/view/View;)V

    iput-object v1, p0, Landroid/widget/Spinner;->mShowingBgBtnObserver:Landroid/widget/Spinner$SettingsObserver;

    invoke-direct {p0, v3}, Landroid/widget/Spinner;->setShowButtonBackgroundChange(Z)V
...
.method static synthetic access$800(Landroid/widget/Spinner;Z)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/widget/Spinner;->setShowButtonBackgroundChange(Z)V
...
.method private setShowButtonBackgroundChange(Z)V
    .locals 1
    ...
    :cond_0
    iget-object v0, p0, Landroid/widget/Spinner;->mDefaultBackground:Landroid/graphics/drawable/Drawable;
...
.method protected onDetachedFromWindow()V
    ...
    :cond_0
    iget-object v0, p0, Landroid/widget/Spinner;->mShowingBgBtnObserver:Landroid/widget/Spinner$SettingsObserver;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/widget/Spinner;->mShowingBgBtnObserver:Landroid/widget/Spinner$SettingsObserver;

    invoke-virtual {v0}, Landroid/widget/Spinner$SettingsObserver;->unregisterObserver()V

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/widget/Spinner;->mShowingBgBtnObserver:Landroid/widget/Spinner$SettingsObserver;
