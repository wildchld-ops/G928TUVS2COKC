...
.method private updatePendingConfigurations([Landroid/content/res/Configuration;)V
    .locals 4

    iget-object v1, p0, Landroid/app/ActivityThread$ApplicationThread;->this$0:Landroid/app/ActivityThread;

    # getter for: Landroid/app/ActivityThread;->mResourcesManager:Landroid/app/ResourcesManager;
    invoke-static {v1}, Landroid/app/ActivityThread;->access$200(Landroid/app/ActivityThread;)Landroid/app/ResourcesManager;
    ...
    iget-object v1, v1, Landroid/app/ActivityThread;->mPendingConfigurations:[Landroid/content/res/Configuration;
    ...
    invoke-virtual {v1, v3}, Landroid/content/res/Configuration;->isOtherSeqNewer(Landroid/content/res/Configuration;)Z
...
.method public final bindApplication(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;Ljava/util/List;Landroid/content/ComponentName;Landroid/app/ProfilerInfo;Landroid/os/Bundle;Landroid/app/IInstrumentationWatcher;Landroid/app/IUiAutomationConnection;IZZZ[Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;Ljava/util/Map;Landroid/os/Bundle;I)V
    ...
    iget-object v7, v1, Landroid/app/ActivityThread$AppBindData;->configs:[Landroid/content/res/Configuration;

    const/4 v8, 0x0

    const/4 v9, 0x0

    aget-object v9, p13, v9
...
.method public scheduleConfigurationsChanged([Landroid/content/res/Configuration;)V
    .locals 2

    invoke-direct {p0, p1}, Landroid/app/ActivityThread$ApplicationThread;->updatePendingConfigurations([Landroid/content/res/Configuration;)V
...
.method public scheduleMultiWindowFocusChanged(Landroid/os/IBinder;IZ)V
    .locals 3
    ...
    :goto_0
    # invokes: Landroid/app/ActivityThread;->sendMessage(ILjava/lang/Object;II)V
    invoke-static {v1, v2, p1, p2, v0}, Landroid/app/ActivityThread;->access$400(Landroid/app/ActivityThread;ILjava/lang/Object;II)V
...
.method public final scheduleRelaunchActivity(Landroid/os/IBinder;Ljava/util/List;Ljava/util/List;IZLandroid/content/res/Configuration;Lcom/samsung/android/multiwindow/MultiWindowStyle;I)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public scheduleSendShrinkRequest(Landroid/os/IBinder;II)V
    ...
    # invokes: Landroid/app/ActivityThread;->sendMessage(ILjava/lang/Object;I)V
    invoke-static {v1, v2, v3, p3}, Landroid/app/ActivityThread;->access$300(Landroid/app/ActivityThread;ILjava/lang/Object;I)V
...
.method public scheduleUpdateDisplayOfNonActivityContext(I)V
    .locals 3
