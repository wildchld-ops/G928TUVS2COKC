...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/app/Activity$OnShowButtonBackgroundChangeListener;,
        Landroid/app/Activity$ShowButtonBackgroundObserver;,
...
.field private mShowButtonBackgroundListenerList:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.field private mShowButtonBackgroundObserver:Landroid/app/Activity$ShowButtonBackgroundObserver;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/app/Activity;->SHOW_BUTTON_BACKGROUND:Z
...
.method static synthetic access$600(Landroid/app/Activity;)Ljava/util/ArrayList;
    .locals 1

    iget-object v0, p0, Landroid/app/Activity;->mShowButtonBackgroundListenerList:Ljava/util/ArrayList;
...
.method public addOnShowButtonBackgroundChangeListener(Landroid/app/Activity$OnShowButtonBackgroundChangeListener;)V
    .locals 1
...
.method final attach(Landroid/content/Context;Landroid/app/ActivityThread;Landroid/app/Instrumentation;Landroid/os/IBinder;ILandroid/app/Application;Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Ljava/lang/CharSequence;Landroid/app/Activity;Ljava/lang/String;Landroid/app/Activity$NonConfigurationInstances;Landroid/content/res/Configuration;Ljava/lang/String;Lcom/android/internal/app/IVoiceInteractor;)V
    ...
    invoke-static {p0}, Lcom/android/internal/policy/PolicyManager;->makeNewSubWindow(Landroid/content/Context;)Landroid/view/Window;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v3, p0, Landroid/app/Activity;->mAllLoaderManagers:Landroid/util/ArrayMap;
    ...
    iget-object v3, v3, Landroid/app/Activity$NonConfigurationInstances;->fragments:Ljava/util/ArrayList;

    :goto_2
    invoke-virtual {v6, v2, v3}, Landroid/app/FragmentManagerImpl;->restoreAllState(Landroid/os/Parcelable;Ljava/util/ArrayList;)V

    :cond_2
    iget-object v3, p0, Landroid/app/Activity;->mFragments:Landroid/app/FragmentManagerImpl;

    invoke-virtual {v3}, Landroid/app/FragmentManagerImpl;->dispatchCreate()V
    ...
    iput-object v3, p0, Landroid/app/Activity;->mPerfActivityList:[Ljava/lang/String;
    ...
    sput v3, Landroid/app/Activity;->mAsCpuBoost:I
    ...
    sput v3, Landroid/app/Activity;->mAsSchedBoost:I
    ...
    sput v3, Landroid/app/Activity;->mAsPcDisblBoost:I
    ...
    :goto_3
    iput-boolean v3, p0, Landroid/app/Activity;->mIsThemeDeviceDefaultFamily:Z

    sget-boolean v3, Landroid/app/Activity;->SHOW_BUTTON_BACKGROUND:Z

    if-eqz v3, :cond_4

    iget-boolean v3, p0, Landroid/app/Activity;->mIsThemeDeviceDefaultFamily:Z
    ...
    iput-object v3, p0, Landroid/app/Activity;->mShowButtonBackgroundListenerList:Ljava/util/ArrayList;

    new-instance v3, Landroid/app/Activity$ShowButtonBackgroundObserver;

    invoke-direct {v3, p0}, Landroid/app/Activity$ShowButtonBackgroundObserver;-><init>(Landroid/app/Activity;)V

    iput-object v3, p0, Landroid/app/Activity;->mShowButtonBackgroundObserver:Landroid/app/Activity$ShowButtonBackgroundObserver;
    ...
    iget-object v6, p0, Landroid/app/Activity;->mShowButtonBackgroundObserver:Landroid/app/Activity$ShowButtonBackgroundObserver;
    ...
    invoke-virtual {v3, v4}, Landroid/app/ActionBar;->setDefaultDisplayHomeAsUpEnabled(Z)V
...
.method protected onDestroy()V
    ...
    iget-object v5, p0, Landroid/app/Activity;->mShowButtonBackgroundObserver:Landroid/app/Activity$ShowButtonBackgroundObserver;
    ...
    iput-object v7, p0, Landroid/app/Activity;->mShowButtonBackgroundObserver:Landroid/app/Activity$ShowButtonBackgroundObserver;

    :cond_0
    iget-object v5, p0, Landroid/app/Activity;->mShowButtonBackgroundListenerList:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Landroid/app/Activity;->mShowButtonBackgroundListenerList:Ljava/util/ArrayList;
    ...
    iput-object v7, p0, Landroid/app/Activity;->mShowButtonBackgroundListenerList:Ljava/util/ArrayList;
...
.method public onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    const-string v3, "onContextItemSelected handled by feature app"
...
.method public onMultiWindowFocusChanged(IZ)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/view/Window;->onMultiWindowFocusChanged(IZ)V
...
.method final performCreate(Landroid/os/Bundle;)V
    ...
    const-string v1, "performCreate Call Injection manager"
...
.method final performStart()V
    ...
    :cond_0
    iget-object v4, p0, Landroid/app/Activity;->mInjectionManager:Landroid/app/im/InjectionManager;

    if-eqz v4, :cond_1

    iget-object v4, p0, Landroid/app/Activity;->mInjectionManager:Landroid/app/im/InjectionManager;

    sget-object v5, Landroid/app/im/InjectionConstants$DispatchParentCall;->ONSTART:Landroid/app/im/InjectionConstants$DispatchParentCall;

    iget-object v6, p0, Landroid/app/Activity;->myName:Ljava/lang/String;

    invoke-virtual {v4, v5, v6, p0}, Landroid/app/im/InjectionManager;->dispatchParentCallToFeature(Landroid/app/im/InjectionConstants$DispatchParentCall;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public removeOnShowButtonBackgroundChangeListener(Landroid/app/Activity$OnShowButtonBackgroundChangeListener;)V
    .locals 1
