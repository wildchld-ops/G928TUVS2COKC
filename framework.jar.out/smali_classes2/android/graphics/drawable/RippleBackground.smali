...
.field private static final EXIT_ANIMATION_TIMEOUT:J = 0x1f4L
...
.field private mExitAnimationRequestedTime:J
...
.method private createPendingHardwareExit(III)V
    ...
    iput-wide v0, p0, Landroid/graphics/drawable/RippleBackground;->mExitAnimationRequestedTime:J
...
.method private drawHardware(Landroid/view/HardwareCanvas;Landroid/graphics/Paint;)Z
    ...
    iget-wide v2, p0, Landroid/graphics/drawable/RippleBackground;->mExitAnimationRequestedTime:J
    ...
    iget-wide v4, p0, Landroid/graphics/drawable/RippleBackground;->mExitAnimationRequestedTime:J
    ...
    invoke-direct {p0, v1}, Landroid/graphics/drawable/RippleBackground;->cancelHardwareAnimations(Z)V
    ...
    iget-object v2, p0, Landroid/graphics/drawable/RippleBackground;->mPropOuterY:Landroid/graphics/CanvasProperty;

    iget-object v3, p0, Landroid/graphics/drawable/RippleBackground;->mPropOuterRadius:Landroid/graphics/CanvasProperty;

    iget-object v4, p0, Landroid/graphics/drawable/RippleBackground;->mPropOuterPaint:Landroid/graphics/CanvasProperty;

    invoke-virtual {p1, v0, v2, v3, v4}, Landroid/view/HardwareCanvas;->drawCircle(Landroid/graphics/CanvasProperty;Landroid/graphics/CanvasProperty;Landroid/graphics/CanvasProperty;Landroid/graphics/CanvasProperty;)V

    iput-wide v6, p0, Landroid/graphics/drawable/RippleBackground;->mExitAnimationRequestedTime:J
