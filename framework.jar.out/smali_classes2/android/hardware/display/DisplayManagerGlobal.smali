...
.method public getDisplayInfo(I)Landroid/view/DisplayInfo;
    ...
    invoke-virtual {p0, p1, v1, v2}, Landroid/hardware/display/DisplayManagerGlobal;->getDisplayInfo(ILandroid/os/IBinder;Z)Landroid/view/DisplayInfo;
...
.method public getDisplayInfo(ILandroid/os/IBinder;Z)Landroid/view/DisplayInfo;
    ...
    invoke-virtual {v2, p2}, Landroid/app/ActivityThread;->getActivity(Landroid/os/IBinder;)Landroid/app/Activity;
    ...
    const-string v10, "multiwindow_facade"
    ...
    invoke-virtual {v6, v7, v8}, Lcom/samsung/android/multiwindow/MultiWindowFacade;->shouldFakeOrientation(ILcom/samsung/android/multiwindow/MultiWindowStyle;)Z

    move-result v8

    if-eqz v8, :cond_1

    iget-object v8, p0, Landroid/hardware/display/DisplayManagerGlobal;->mDm:Landroid/hardware/display/IDisplayManager;

    invoke-interface {v8, p1, p2, v7}, Landroid/hardware/display/IDisplayManager;->getDisplayInfoEx(ILandroid/os/IBinder;I)Landroid/view/DisplayInfo;
    ...
    const-string v10, "Could not get display information from display manager."
    ...
    invoke-interface {v8, p1, p2, v11}, Landroid/hardware/display/IDisplayManager;->getDisplayInfoEx(ILandroid/os/IBinder;I)Landroid/view/DisplayInfo;
    ...
    invoke-interface {v8, p1}, Landroid/hardware/display/IDisplayManager;->getDisplayInfo(I)Landroid/view/DisplayInfo;
