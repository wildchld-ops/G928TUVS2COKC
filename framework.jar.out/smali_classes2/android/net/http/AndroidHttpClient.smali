...
.method private checkMmsOps()Z
    ...
    const-string v6, "[NALSECURITY] checkMmsOps() : callingPackage = "
    ...
    invoke-interface {v4, v2, v1}, Landroid/content/pm/IPackageManager;->isSendMMSManaged(ILjava/lang/String;)Z
    ...
    const-string v5, "[NALSECURITY] checkMmsOps() : SEND_MMS return true. Block MMS sending"
    ...
    const-string v5, "[NALSECURITY] checkMmsOps() : SEND_MMS return false. Allow to send MMS"
...
.method private checkMmsSendPermission(Ljava/lang/String;)Z
    ...
    const-string v3, "[NALSECURITY] checkMmsSendPermission() : isMmsRequest() = "
    ...
    const-string v3, "[NALSECURITY] checkMmsSendPermission() : checkMmsOps() = "
...
.method private isMmsRequest()Z
    ...
    const-string v2, "[NALSECURITY] isMmsRequest() : CoreProtocolPNames.USER_AGENT = "
