...
.method private runDhcp(Landroid/net/DhcpStateMachine$DhcpAction;)Z
    ...
    invoke-virtual {v4, v10, v6, v7, v5}, Landroid/app/AlarmManager;->setExact(IJLandroid/app/PendingIntent;)V
    ...
    invoke-virtual {v4, v11, v5, v6, v0}, Lcom/android/internal/util/StateMachine;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {p1}, Landroid/net/DhcpStateMachine$DhcpAction;->ordinal()I

    move-result v5

    invoke-virtual {v4, v11, v10, v5}, Lcom/android/internal/util/StateMachine;->obtainMessage(III)Landroid/os/Message;
