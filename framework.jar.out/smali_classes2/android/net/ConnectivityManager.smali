...
.method public startUsingNetworkFeature(ILjava/lang/String;)I
    ...
    const-string v16, "ConnectivityManager"

    new-instance v17, Ljava/lang/StringBuilder;

    invoke-direct/range {v17 .. v17}, Ljava/lang/StringBuilder;-><init>()V

    const-string v18, "CallingUid : "
    ...
    const-string v18, "Can\'t satisfy startUsingNetworkFeature for "
    ...
    invoke-virtual/range {v16 .. v17}, Landroid/app/Application;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    const-string/jumbo v17, "requested special network with data disabled - rejected"
    ...
    const-string/jumbo v17, "ril.ActivePDPRejectCause"
    ...
    const-string v17, "enableSUPL type  NOT available - rejectCause 8"
    ...
    invoke-interface/range {v16 .. v16}, Lcom/android/internal/telephony/ITelephony;->needsOtaServiceProvisioning()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v12, v0}, Landroid/net/NetworkCapabilities;->hasCapability(I)Z
    ...
    const-string v17, "Device is not activated yet"
    ...
    const-string v17, "needsOtaServiceProvisioning returned RemoteException"
    ...
    const-string v17, "needsOtaServiceProvisioning has NullPointerException"
    ...
    :cond_7
    invoke-virtual {v12}, Landroid/net/NetworkCapabilities;->firstNetCapToApnType()Ljava/lang/String;
    ...
    invoke-interface {v9, v2}, Lcom/android/internal/telephony/ITelephony;->isApnTypeAvailable(Ljava/lang/String;)Z
    ...
    const-string v18, ") NOT available"
    ...
    const-string v17, "RemoteException isApnTypeAvailable()"
    ...
    const-string v17, "CscFeature_RIL_SupportImsService"
    ...
    const-string v18, "VoLTE : feature: "
    ...
    const-string v17, "NullPointerException isApnTypeAvailable()"
    ...
    :try_start_3
    sget-object v16, Landroid/net/ConnectivityManager;->sLegacyRequests:Ljava/util/HashMap;
    ...
    check-cast v10, Landroid/net/ConnectivityManager$LegacyRequest;
    ...
    const-string/jumbo v19, "renewing startUsingNetworkFeature request "

    invoke-virtual/range {v18 .. v19}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v18

    iget-object v0, v10, Landroid/net/ConnectivityManager$LegacyRequest;->networkRequest:Landroid/net/NetworkRequest;
    ...
    invoke-direct {v0, v10}, Landroid/net/ConnectivityManager;->renewRequestLocked(Landroid/net/ConnectivityManager$LegacyRequest;)V

    iget-object v0, v10, Landroid/net/ConnectivityManager$LegacyRequest;->currentNetwork:Landroid/net/Network;
    ...
    invoke-direct {v0, v12}, Landroid/net/ConnectivityManager;->requestNetworkForFeatureLocked(Landroid/net/NetworkCapabilities;)Landroid/net/NetworkRequest;
    ...
    const-string/jumbo v18, "starting startUsingNetworkFeature for request "
    ...
    invoke-direct {v0, v12}, Landroid/net/ConnectivityManager;->legacyTypeForNetworkCapabilities(Landroid/net/NetworkCapabilities;)I

    move-result v17

    invoke-interface/range {v16 .. v17}, Landroid/net/IConnectivityManager;->getNetworkForType(I)Landroid/net/Network;
    ...
    const-string/jumbo v17, "return APN ALREADY ACTIVE"
    ...
    const-string v18, "getNetworkForType "
