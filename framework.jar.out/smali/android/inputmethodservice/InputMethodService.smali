...
# static fields
.field private static final ACTION_INPUT_METHOD_SHOWN:Ljava/lang/String; = "android.inputmethodservice.SHOWN"
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/inputmethodservice/InputMethodService;->mIsTabletDevice:Z

    sput-boolean v0, Landroid/inputmethodservice/InputMethodService;->mIsJanpaneseModel:Z
...
.method private sendBroadcaseSIPShownByThread()V
    .locals 2

    new-instance v0, Ljava/lang/Thread;

    new-instance v1, Landroid/inputmethodservice/InputMethodService$4;

    invoke-direct {v1, p0}, Landroid/inputmethodservice/InputMethodService$4;-><init>(Landroid/inputmethodservice/InputMethodService;)V
...
.method private sendInputViewShownState()V
    ...
    invoke-direct {p0}, Landroid/inputmethodservice/InputMethodService;->sendBroadcaseSIPShownByThread()V
...
.method public onConfiguratinChangedForAllDisplays([Landroid/content/res/Configuration;)V
    ...
    const-string/jumbo v3, "onConfiguratinChangedForAllDisplays : "
    ...
    invoke-virtual {v1}, Landroid/view/inputmethod/InputMethodManager;->getCurrentFocusDisplayID()I
    ...
    invoke-virtual {v1, v2, v3, v4}, Landroid/app/ResourcesManager;->applyConfigurationToResourcesLocked(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;Z)Z
...
.method showWindowInner(Z)V
    ...
    iput-boolean v10, p0, Landroid/inputmethodservice/InputMethodService;->mWindowVisible:Z
    ...
    iput-boolean v10, p0, Landroid/inputmethodservice/InputMethodService;->mShowInputRequested:Z
    ...
    iget-boolean v6, p0, Landroid/inputmethodservice/InputMethodService;->mWindowAdded:Z

    if-eqz v6, :cond_1

    iget-boolean v6, p0, Landroid/inputmethodservice/InputMethodService;->mWindowCreated:Z

    if-nez v6, :cond_2

    :cond_1
    iput-boolean v10, p0, Landroid/inputmethodservice/InputMethodService;->mWindowAdded:Z

    iput-boolean v10, p0, Landroid/inputmethodservice/InputMethodService;->mWindowCreated:Z
    ...
    :cond_2
    iget-boolean v6, p0, Landroid/inputmethodservice/InputMethodService;->mSideSyncShowInputRequested:Z
    ...
    invoke-virtual {p0, v6}, Landroid/inputmethodservice/InputMethodService;->isEmailInputType(Landroid/view/inputmethod/EditorInfo;)Z
    ...
    const-string v7, "SideSyncShowInputRequested true. CALL: onStartInput"

    invoke-static {v6, v7}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v6, p0, Landroid/inputmethodservice/InputMethodService;->mInputEditorInfo:Landroid/view/inputmethod/EditorInfo;

    invoke-virtual {p0, v6, v9}, Landroid/inputmethodservice/InputMethodService;->onStartInput(Landroid/view/inputmethod/EditorInfo;Z)V
    ...
    const-string v7, "SideSyncShowInputRequested true. WILLCALL: onStartInputView"

    invoke-static {v6, v7}, Landroid/util/Log;->v(Ljava/lang/String;Ljava/lang/String;)I

    :cond_6
    iput-boolean v10, p0, Landroid/inputmethodservice/InputMethodService;->mInputViewStarted:Z

    iget-object v6, p0, Landroid/inputmethodservice/InputMethodService;->mInputEditorInfo:Landroid/view/inputmethod/EditorInfo;

    invoke-virtual {p0, v6, v9}, Landroid/inputmethodservice/InputMethodService;->onStartInputView(Landroid/view/inputmethod/EditorInfo;Z)V
    ...
    const-string/jumbo v7, "sidesync_tablet_connect"
    ...
    const-string/jumbo v7, "showWindow: sidesync_tablet_connect is connected!"
    ...
    const-string/jumbo v7, "showWindowInner: IllegalArgumentException occured."
    ...
    :cond_b
    iput-boolean v10, p0, Landroid/inputmethodservice/InputMethodService;->mCandidatesViewStarted:Z

    iget-object v6, p0, Landroid/inputmethodservice/InputMethodService;->mInputEditorInfo:Landroid/view/inputmethod/EditorInfo;

    invoke-virtual {p0, v6, v9}, Landroid/inputmethodservice/InputMethodService;->onStartCandidatesView(Landroid/view/inputmethod/EditorInfo;Z)V
    ...
    invoke-virtual {v6, v7, v10, v8}, Landroid/view/inputmethod/InputMethodManager;->setImeWindowStatus(Landroid/os/IBinder;II)V
    ...
    invoke-virtual {v6, v7}, Landroid/inputmethodservice/SoftInputWindow;->setToken(Landroid/os/IBinder;)V
    ...
    const-string/jumbo v7, "showWindow: NumberFormatException occured!"
    ...
    const-string/jumbo v7, "showWindow: IllegalArgumentException occured!"
    ...
    const-string/jumbo v7, "showWindow: BadTokenException occured!"
