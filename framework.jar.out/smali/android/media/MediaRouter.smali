...
.method private static updateWifiDisplayRoute(Landroid/media/MediaRouter$RouteInfo;Landroid/hardware/display/WifiDisplay;Landroid/hardware/display/WifiDisplayStatus;Z)V
    ...
    iget-boolean v3, v3, Landroid/media/MediaRouter$Static;->mDeviceNameChanged:Z
...
.method static updateWifiDisplayStatus(Landroid/hardware/display/WifiDisplayStatus;)V
    ...
    iput-boolean v11, v12, Landroid/media/MediaRouter$Static;->mDeviceNameChanged:Z
    ...
    invoke-virtual {v9}, Landroid/media/MediaRouter$RouteInfo;->getSupportedTypes()I

    move-result v12

    invoke-static {v12, v9, v11}, Landroid/media/MediaRouter;->selectRouteStatic(ILandroid/media/MediaRouter$RouteInfo;Z)V
    ...
    iget-boolean v12, v12, Landroid/media/MediaRouter$Static;->mCanConfigureWifiDisplays:Z
    ...
    iget-object v12, v12, Landroid/media/MediaRouter$Static;->mPreviousActiveWifiDisplayAddress:Ljava/lang/String;
    ...
    invoke-virtual {v9}, Landroid/media/MediaRouter$RouteInfo;->getName()Ljava/lang/CharSequence;
    ...
    iput-boolean v10, v12, Landroid/media/MediaRouter$Static;->mDeviceNameChanged:Z

    :cond_8
    invoke-static {v9, v3, p0, v4}, Landroid/media/MediaRouter;->updateWifiDisplayRoute(Landroid/media/MediaRouter$RouteInfo;Landroid/hardware/display/WifiDisplay;Landroid/hardware/display/WifiDisplayStatus;Z)V
    ...
    iget-object v10, v10, Landroid/media/MediaRouter$Static;->mRoutes:Ljava/util/ArrayList;
    ...
    iget-object v10, v9, Landroid/media/MediaRouter$RouteInfo;->mDeviceAddress:Ljava/lang/String;

    if-eqz v10, :cond_c

    iget-object v10, v9, Landroid/media/MediaRouter$RouteInfo;->mDeviceAddress:Ljava/lang/String;

    invoke-static {v5, v10}, Landroid/media/MediaRouter;->findWifiDisplay([Landroid/hardware/display/WifiDisplay;Ljava/lang/String;)Landroid/hardware/display/WifiDisplay;
    ...
    iput-object v1, v10, Landroid/media/MediaRouter$Static;->mPreviousActiveWifiDisplayAddress:Ljava/lang/String;
...
.method public selectRoute(ILandroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-boolean v0, v0, Landroid/media/MediaRouter$Static;->mDeviceNameChanged:Z
