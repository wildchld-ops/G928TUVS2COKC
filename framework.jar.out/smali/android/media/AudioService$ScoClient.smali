...
.method private requestScoState(II)V
    ...
    invoke-static {v1, v6}, Landroid/media/AudioService;->access$2900(Landroid/media/AudioService;I)V
    ...
    invoke-static {v1, v3}, Landroid/media/AudioService;->access$3102(Landroid/media/AudioService;I)I
    ...
    # invokes: Landroid/media/AudioService;->broadcastScoConnectionState(I)V
    invoke-static {v1, v3}, Landroid/media/AudioService;->access$2900(Landroid/media/AudioService;I)V
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$3500(Landroid/media/AudioService;)Ljava/util/ArrayList;
    ...
    # getter for: Landroid/media/AudioService;->mScoDevices:Ljava/util/ArrayList;
    invoke-static {v3}, Landroid/media/AudioService;->access$3500(Landroid/media/AudioService;)Ljava/util/ArrayList;
    ...
    # setter for: Landroid/media/AudioService;->mScoAudioState:I
    invoke-static {v1, v4}, Landroid/media/AudioService;->access$3002(Landroid/media/AudioService;I)I

    iget-object v1, p0, Landroid/media/AudioService$ScoClient;->this$0:Landroid/media/AudioService;

    # invokes: Landroid/media/AudioService;->broadcastScoConnectionState(I)V
    invoke-static {v1, v4}, Landroid/media/AudioService;->access$2900(Landroid/media/AudioService;I)V
    ...
    # getter for: Landroid/media/AudioService;->mBluetoothHeadsetDevice:Landroid/bluetooth/BluetoothDevice;
    invoke-static {v2}, Landroid/media/AudioService;->access$3300(Landroid/media/AudioService;)Landroid/bluetooth/BluetoothDevice;
    ...
    # setter for: Landroid/media/AudioService;->mScoAudioState:I
    invoke-static {v1, v7}, Landroid/media/AudioService;->access$3002(Landroid/media/AudioService;I)I
