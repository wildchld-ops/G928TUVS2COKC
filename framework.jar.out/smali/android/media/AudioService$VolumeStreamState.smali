...
.method static synthetic access$1000(Landroid/media/AudioService$VolumeStreamState;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$1200(Landroid/media/AudioService$VolumeStreamState;)I
    .locals 1
...
.method static synthetic access$2500(Landroid/media/AudioService$VolumeStreamState;)Ljava/util/ArrayList;
    .locals 1
...
.method private dump(Ljava/io/PrintWriter;)V
    ...
    invoke-static {v6}, Landroid/media/AudioService;->access$3500(Landroid/media/AudioService;)Ljava/util/ArrayList;
...
.method private getDeathHandler_syncVSS(Landroid/os/IBinder;Z)Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;
    ...
    invoke-static {v0}, Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;->access$6000(Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;)Landroid/os/IBinder;
...
.method private muteCount()I
    ...
    invoke-static {v5}, Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;->access$2600(Landroid/media/AudioService$VolumeStreamState$VolumeDeathHandler;)I
    :try_end_0
...
.method public applyAllVolumes()V
    ...
    invoke-static {v6}, Landroid/media/AudioService;->access$5100(Landroid/media/AudioService;)Ljava/lang/String;
    ...
    # getter for: Landroid/media/AudioService;->mPrevRingerMode:I
    invoke-static {v6}, Landroid/media/AudioService;->access$5200(Landroid/media/AudioService;)I
    ...
    invoke-static {v6}, Landroid/media/AudioService;->access$5300(Landroid/media/AudioService;)I
    ...
    invoke-static {v6, v8}, Landroid/media/AudioSystem;->isStreamActive(II)Z
    ...
    invoke-static {v6}, Landroid/media/AudioService;->access$5400(Landroid/media/AudioService;)I
    ...
    invoke-static {v6, v4, v8}, Landroid/media/AudioSystem;->setStreamVolumeIndex(III)I
    ...
    invoke-static {v6, v4, v0}, Landroid/media/AudioSystem;->setStreamVolumeIndex(III)I
...
.method public applyDeviceVolume_syncVSS(I)V
    ...
    invoke-static {v1, v3}, Landroid/media/AudioService;->access$4902(Landroid/media/AudioService;Z)Z

    iget-object v1, p0, Landroid/media/AudioService$VolumeStreamState;->this$0:Landroid/media/AudioService;

    # setter for: Landroid/media/AudioService;->mMediaLastAudibleIndex:I
    invoke-static {v1, v3}, Landroid/media/AudioService;->access$5002(Landroid/media/AudioService;I)I
...
.method public readSettings()V
    ...
    # getter for: Landroid/media/AudioService;->mUseFixedVolume:Z
    invoke-static {v8}, Landroid/media/AudioService;->access$4400(Landroid/media/AudioService;)Z
    ...
    # getter for: Landroid/media/AudioService;->mUseMasterVolume:Z
    invoke-static {v8}, Landroid/media/AudioService;->access$4500(Landroid/media/AudioService;)Z
    ...
    invoke-static {v8}, Landroid/media/AudioService;->access$4600(Landroid/media/AudioService;)Landroid/content/ContentResolver;
...
.method public setAllIndexes(Landroid/media/AudioService$VolumeStreamState;)V
    ...
    invoke-static {v6, v3, v5, v8}, Landroid/media/AudioService;->access$5800(Landroid/media/AudioService;III)I
...
.method public setIndex(II)Z
    ...
    invoke-static {v8}, Landroid/media/AudioService;->access$5500(Landroid/media/AudioService;)Ljava/lang/Boolean;
    ...
    # getter for: Landroid/media/AudioService;->mCameraSoundForced:Ljava/lang/Boolean;
    invoke-static {v9}, Landroid/media/AudioService;->access$5500(Landroid/media/AudioService;)Ljava/lang/Boolean;
    ...
    invoke-static {v8, v9}, Landroid/media/AudioService;->access$5600(Landroid/media/AudioService;I)I
    ...
    # getter for: Landroid/media/AudioService;->mStreamVolumeAlias:[I
    invoke-static {v6}, Landroid/media/AudioService;->access$5700(Landroid/media/AudioService;)[I
    ...
    # invokes: Landroid/media/AudioService;->rescaleIndex(III)I
    invoke-static {v6, p1, v8, v4}, Landroid/media/AudioService;->access$5800(Landroid/media/AudioService;III)I
    ...
    invoke-static {v6}, Landroid/media/AudioService;->access$5900(Landroid/media/AudioService;)[Landroid/media/AudioService$VolumeStreamState;
    ...
    # invokes: Landroid/media/AudioService;->getDeviceForStream(I)I
    invoke-static {v8, v4}, Landroid/media/AudioService;->access$5600(Landroid/media/AudioService;I)I
