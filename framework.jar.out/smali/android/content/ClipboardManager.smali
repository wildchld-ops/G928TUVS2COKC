...
.method public setPrimaryClip(Landroid/content/ClipData;)V
    ...
    invoke-virtual {v4}, Landroid/sec/clipboard/data/list/ClipboardDataText;->GetFomat()I
    ...
    new-instance v2, Landroid/sec/clipboard/data/list/ClipboardDataHTMLFragment;

    invoke-direct {v2}, Landroid/sec/clipboard/data/list/ClipboardDataHTMLFragment;-><init>()V
    ...
    invoke-virtual {v2, v7}, Landroid/sec/clipboard/data/list/ClipboardDataHTMLFragment;->SetHTMLFragment(Ljava/lang/CharSequence;)Z

    sget-object v7, Landroid/content/ClipboardManager;->sServiceEx:Landroid/sec/clipboard/IClipboardService;

    invoke-virtual {v2}, Landroid/sec/clipboard/data/list/ClipboardDataHTMLFragment;->GetFomat()I
    ...
    invoke-virtual {v6}, Landroid/sec/clipboard/data/list/ClipboardDataUri;->GetFomat()I
    ...
    invoke-virtual {v3}, Landroid/sec/clipboard/data/list/ClipboardDataIntent;->GetFomat()I
