...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/view/View$OnAttachedDisplayChangeListener;,
...
.field private static final DCS_LOG_TAG:Ljava/lang/String; = "SRIB_DCS"
...
.field private static final IS_DYNAMIC_COLOR_SCALING_ENABLED:Z = false
...
.field mGetBoundsOnScreenResult:Z
...
.field mLastAccessibilityFocusRect:Landroid/graphics/Rect;
...
.method static constructor <clinit>()V
    ...
    const-string v9, "americano"

    const-string/jumbo v10, "ro.build.scafe"
    ...
    sput-boolean v9, Landroid/view/View;->TW_SCAFE_AMERICANO:Z
    ...
    sput-boolean v9, Landroid/view/View;->TW_SCAFE_CAPUCCINO:Z

    const-string/jumbo v9, "mocha"
    ...
    sput-boolean v9, Landroid/view/View;->TW_SCAFE_MOCHA:Z

    const-string/jumbo v9, "latte"
    ...
    sput-boolean v9, Landroid/view/View;->TW_SCAFE_LATTE:Z
...
.method constructor <init>()V
    ...
    iput-boolean v4, p0, Landroid/view/View;->DEBUG_ELASTIC:Z

    iput-boolean v4, p0, Landroid/view/View;->isElasticEnabled:Z
    ...
    iput-object v1, p0, Landroid/view/View;->mLastAccessibilityFocusRect:Landroid/graphics/Rect;

    iput-boolean v2, p0, Landroid/view/View;->mGetBoundsOnScreenResult:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Landroid/view/View;->mLastAccessibilityFocusRect:Landroid/graphics/Rect;

    iput-boolean v5, p0, Landroid/view/View;->mGetBoundsOnScreenResult:Z
...
.method private drawBackground(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Landroid/view/View;->twUpdateBackgroundBounds()V
...
.method private isScreenReaderEnabled()Z
    ...
    const-string v2, "enabled_accessibility_samsung_screen_reader"
...
.method clearFocusInternal(Landroid/view/View;ZZ)V
    ...
    invoke-virtual {p0, v3, v3, v2}, Landroid/view/View;->onFocusChanged(ZILandroid/graphics/Rect;)V
...
.method public dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    invoke-virtual {p1, v5}, Landroid/view/MotionEvent;->setTargetAccessibilityFocus(Z)V
    ...
    invoke-interface {v7, p1}, Landroid/view/ViewParent;->requestOnStylusButtonEvent(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {v7, p1, v5}, Landroid/view/InputEventConsistencyVerifier;->onTouchEvent(Landroid/view/MotionEvent;I)V
    ...
    invoke-virtual {v7, p1, v5}, Landroid/view/InputEventConsistencyVerifier;->onUnhandledEvent(Landroid/view/InputEvent;I)V
...
.method public getLocationOnScreen([I)V
    ...
    iget-object v5, v4, Landroid/view/ViewRootImpl;->mWindowAttributes:Landroid/view/WindowManager$LayoutParams;

    iget v5, v5, Landroid/view/WindowManager$LayoutParams;->type:I

    if-ne v5, v8, :cond_1

    iget v5, v1, Landroid/view/View$AttachInfo;->mWindowLeft:I

    iput v5, v3, Landroid/graphics/Point;->x:I

    iget v5, v1, Landroid/view/View$AttachInfo;->mWindowTop:I
...
.method protected getMultiWindowStyle()Lcom/samsung/android/multiwindow/MultiWindowStyle;
    .locals 4
...
.method public isMultiWindow()Z
    ...
    invoke-virtual {p0}, Landroid/view/View;->getMultiWindowStyle()Lcom/samsung/android/multiwindow/MultiWindowStyle;
...
.method public final measure(II)V
    ...
    iget-boolean v14, v0, Landroid/view/View;->mSkipRtlCheck:Z
    ...
    const-string/jumbo v15, "sys.multiwindow.running"
...
.method public onAttachedDisplayIdChanged(I)V
    .locals 0
...
.method public requestAccessibilityFocus()Z
    ...
    invoke-direct {p0}, Landroid/view/View;->isScreenReaderEnabled()Z
    ...
    iget-object v5, p0, Landroid/view/View;->mLastAccessibilityFocusRect:Landroid/graphics/Rect;
    ...
    iput-object v5, p0, Landroid/view/View;->mLastAccessibilityFocusRect:Landroid/graphics/Rect;

    :cond_3
    iget-object v5, p0, Landroid/view/View;->mLastAccessibilityFocusRect:Landroid/graphics/Rect;

    invoke-virtual {p0, v5}, Landroid/view/View;->getBoundsOnScreen(Landroid/graphics/Rect;)V
...
.method public setOnAttachedDisplayChangeListener(Landroid/view/View$OnAttachedDisplayChangeListener;)V
    .locals 0
...
.method public setWritingBuddy(Lcom/samsung/android/writingbuddy/WritingBuddyImpl;)V
    ...
    iput-object v6, p0, Landroid/view/View;->mWritingBuddy:Lcom/samsung/android/writingbuddy/WritingBuddyImpl;
    ...
    :cond_2
    iget-object v2, p0, Landroid/view/View;->mWritingBuddy:Lcom/samsung/android/writingbuddy/WritingBuddyImpl;
    ...
    :cond_3
    iput-boolean v1, p0, Landroid/view/View;->mIsWritingBuddyEnabled:Z
...
.method public twSetDrawDuringWindowsAnimating(Z)V
    .locals 4
    ...
    iput-boolean p1, v0, Landroid/view/ViewRootImpl;->mTwDrawDuringWindowsAnimating:Z
    ...
    const-string/jumbo v3, "mTwDrawDuringWindowsAnimating="
    ...
    const-string v2, "There is no ViewRootImpl."
...
.method public twSetEnabledThreeFingerGesture(Z)V
    .locals 0
...
.method public usingInputMethodInCascade()Z
    .locals 3
