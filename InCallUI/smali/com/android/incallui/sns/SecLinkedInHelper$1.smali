...
.method public onImageGetResponse(IZLandroid/net/Uri;ILjava/lang/String;)V
    ...
    const-string v3, "failed to get image from Linkedin"
    ...
    :cond_1
    iget-object v3, p0, Lcom/android/incallui/sns/SecLinkedInHelper$1;->this$0:Lcom/android/incallui/sns/SecLinkedInHelper;

    # getter for: Lcom/android/incallui/sns/SecLinkedInHelper;->mContext:Landroid/content/Context;
    invoke-static {v3}, Lcom/android/incallui/sns/SecLinkedInHelper;->access$400(Lcom/android/incallui/sns/SecLinkedInHelper;)Landroid/content/Context;
    ...
    invoke-static {v3}, Lcom/android/incallui/sns/SecLinkedInHelper;->access$500(Lcom/android/incallui/sns/SecLinkedInHelper;)Lcom/android/incallui/sns/SecLinkedInHelper$LinkedinCookieWrapper;
    ...
    iget v3, v3, Lcom/android/incallui/sns/SecLinkedInHelper$LinkedinCookieWrapper;->reqId:I

    if-eq v3, p1, :cond_3

    :cond_2
    const-string v3, "reqId is not matched"
    ...
    iget-object v3, v3, Lcom/android/incallui/sns/SecLinkedInHelper$LinkedinCookieWrapper;->entry:Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;

    iput-object v2, v3, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->photo:Landroid/graphics/drawable/Drawable;
    ...
    iput-boolean v5, v3, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->isLinkedin:Z
    ...
    iput-boolean v5, v3, Lcom/android/incallui/ContactInfoCache$ContactCacheEntry;->isPersonalPhotoAvailable:Z

    const-string v3, "set Linkedin photo"
    ...
    invoke-virtual {v3, v4}, Lcom/android/incallui/CallCardPresenter;->updatePhotoForLinkedin(Lcom/android/incallui/sns/SecLinkedInHelper$LinkedinCookieWrapper;)V
    ...
    const-string v3, "failed to create drawable from URI"
