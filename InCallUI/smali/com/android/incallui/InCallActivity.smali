...
.method private internalResolveIntent(Landroid/content/Intent;)V
    ...
    const-string v10, "- internalResolveIntent: SHOW_DIALPAD_EXTRA: "
    ...
    :cond_0
    const-string v9, "InCallActivity.new_outgoing_call"
    ...
    invoke-virtual {v9}, Landroid/telecom/Call$Details;->getExtras()Landroid/os/Bundle;
    ...
    :cond_4
    :goto_0
    const-string v9, "InCallActivity.show_circular_reveal"

    invoke-virtual {p1, v9, v11}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v6

    iget-object v9, p0, Lcom/android/incallui/InCallActivity;->mCallCardFragment:Lcom/android/incallui/CallCardFragment;

    invoke-virtual {v9, v8, v6}, Lcom/android/incallui/CallCardFragment;->animateForNewOutgoingCall(Landroid/graphics/Point;Z)V
    ...
    invoke-virtual {v9, v11}, Lcom/android/incallui/CallCardFragment;->setVisible(Z)V
    ...
    invoke-static {v9, v10, v12, v5, v3}, Lcom/android/incallui/SelectPhoneAccountDialogFragment;->showAccountDialog(Landroid/app/FragmentManager;IZLjava/util/List;Lcom/android/incallui/SelectPhoneAccountDialogFragment$SelectPhoneAccountListener;)V
    ...
    invoke-virtual {v9, v12}, Lcom/android/incallui/CallCardFragment;->setVisible(Z)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    :cond_1
    const-string v3, "visual_call_center_callerid_info"
    ...
    invoke-static {p0}, Lcom/android/incallui/VisualCallCenter;->VCC_registerNetworkReceiver(Landroid/content/Context;)V
...
.method protected onDestroy()V
    ...
    invoke-static {p0}, Lcom/android/incallui/VisualCallCenter;->VCC_unregisterNetworkReceiver(Landroid/content/Context;)V
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    :cond_0
    invoke-super {p0, p1}, Lcom/android/incallui/BaseInCallActivity;->onSaveInstanceState(Landroid/os/Bundle;)V
...
.method public showConferenceCallManager(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/incallui/ConferenceManagerFragment;->setVisible(Z)V
