.class public Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;
...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->TAG:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->indialogbuilder:Landroid/app/AlertDialog$Builder;

    iput-object v0, p0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->mInComingInvitation:Landroid/app/AlertDialog;

    new-instance v0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity$3;

    invoke-direct {v0, p0}, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity$3;-><init>(Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;)V

    iput-object v0, p0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->mReceiver:Landroid/content/BroadcastReceiver;
...
.method public static acceptInvitation(Landroid/content/Context;Lcom/android/incallui/Call;)V
    ...
    invoke-static {v0, p0, p1}, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->startRcsActivity(Landroid/content/Intent;Landroid/content/Context;Lcom/android/incallui/Call;)V
...
.method static synthetic access$000()Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->TAG:Ljava/lang/String;

    return-object v0
.end method

.method static synthetic access$100(Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;)Landroid/app/AlertDialog;
    .locals 1

    iget-object v0, p0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->mInComingInvitation:Landroid/app/AlertDialog;

    return-object v0
.end method

.method static synthetic access$102(Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;
    .locals 0

    iput-object p1, p0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->mInComingInvitation:Landroid/app/AlertDialog;
...
.method private showRCSDialog(ILjava/lang/Long;)V
    ...
    sget-object v4, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->TAG:Ljava/lang/String;
    ...
    iput-object v4, p0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->indialogbuilder:Landroid/app/AlertDialog$Builder;
    ...
    :goto_0
    iget-object v4, p0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->indialogbuilder:Landroid/app/AlertDialog$Builder;
    ...
    new-instance v6, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity$1;

    invoke-direct {v6, p0, v0}, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity$1;-><init>(Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;Lcom/android/incallui/Call;)V
    ...
    new-instance v6, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity$2;

    invoke-direct {v6, p0, v3, v2}, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity$2;-><init>(Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;ILjava/lang/Long;)V

    invoke-virtual {v4, v5, v6}, Landroid/app/AlertDialog$Builder;->setNegativeButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    :cond_0
    iget-object v4, p0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->mInComingInvitation:Landroid/app/AlertDialog;
    ...
    iput-object v4, p0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->mInComingInvitation:Landroid/app/AlertDialog;
...
.method public static startRcsActivity(Landroid/content/Intent;Landroid/content/Context;Lcom/android/incallui/Call;)V
    ...
    invoke-static {p2, p0, p1}, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->addRcsExtras(Lcom/android/incallui/Call;Landroid/content/Intent;Landroid/content/Context;)V
    ...
    sget-object v1, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->TAG:Ljava/lang/String;
...
.method public finish()V
    ...
    iget-object v0, p0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->mReceiver:Landroid/content/BroadcastReceiver;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->mReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {p0, v0}, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->getIntent()Landroid/content/Intent;
    ...
    iget-object v3, p0, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->mReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {p0, v3, v0}, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    :cond_1
    sget-object v3, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->finish()V

    :goto_0
    return-void

    :cond_2
    invoke-direct {p0, v2, v1}, Lcom/android/incallui/rcs/SecRCSCallPopupDialogActivity;->showRCSDialog(ILjava/lang/Long;)V
