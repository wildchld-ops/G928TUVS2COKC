.class public Lcom/android/incallui/SecTabletVideoCallView;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;
    }
.end annotation
...
.field private static sDisplaySurface:Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;

.field private static sPreviewSurface:Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/incallui/SecTabletVideoCallView;->sVideoSurfacesInUse:Z

    sput-object v1, Lcom/android/incallui/SecTabletVideoCallView;->sPreviewSurface:Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;

    sput-object v1, Lcom/android/incallui/SecTabletVideoCallView;->sDisplaySurface:Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;

    sput-boolean v0, Lcom/android/incallui/SecTabletVideoCallView;->mIsShowingVideoUI:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mVideoViews:Landroid/view/View;

    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mFarEndCaptureAnimatinoView:Landroid/view/View;

    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mNearEndCaptureAnimatinoView:Landroid/view/View;

    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mNearEndSwitchAnimationView:Landroid/view/View;

    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mTouchBackground:Landroid/view/View;

    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mBigTouchArea:Landroid/view/View;

    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mSmallTouchArea:Landroid/view/View;

    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mRecInfoFarEnd:Landroid/view/ViewGroup;

    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mRecInfoTimeTextViewFarEnd:Landroid/widget/TextView;

    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mRecInfoNearEnd:Landroid/view/ViewGroup;

    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mRecInfoTimeTextViewNearEnd:Landroid/widget/TextView;

    iput-boolean v1, p0, Lcom/android/incallui/SecTabletVideoCallView;->mIsLayoutComplete:Z

    iput v2, p0, Lcom/android/incallui/SecTabletVideoCallView;->mWidth:I

    iput v2, p0, Lcom/android/incallui/SecTabletVideoCallView;->mHeight:I

    iput-boolean v1, p0, Lcom/android/incallui/SecTabletVideoCallView;->isShowingPreparingAnimation:Z

    sget v0, Lcom/android/incallui/secservice/SecVideoState;->VIDEO_NONE:I

    iput v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mVideoState:I

    sget v0, Lcom/android/incallui/secservice/SecVideoState;->VIDEO_NONE:I

    iput v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mOldVideoState:I

    sget v0, Lcom/android/incallui/secservice/SecVideoState;->VIDEO_NONE:I

    iput v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mDelayedVideoState:I

    iput-boolean v1, p0, Lcom/android/incallui/SecTabletVideoCallView;->mIsProgressingAnimation:Z

    iput-boolean v1, p0, Lcom/android/incallui/SecTabletVideoCallView;->mIsInitializedLayout:Z

    iput v3, p0, Lcom/android/incallui/SecTabletVideoCallView;->HIDE_INCALL_BANNER_DELAY:I

    iput v3, p0, Lcom/android/incallui/SecTabletVideoCallView;->HIDE_NOTIFY_BANNER_DELAY:I

    new-instance v0, Lcom/android/incallui/SecTabletVideoCallView$1;

    invoke-direct {v0, p0}, Lcom/android/incallui/SecTabletVideoCallView$1;-><init>(Lcom/android/incallui/SecTabletVideoCallView;)V

    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mVideoCallViewHandler:Landroid/os/Handler;

    return-void
.end method

.method static synthetic access$002(Lcom/android/incallui/SecTabletVideoCallView;I)I
    .locals 0

    iput p1, p0, Lcom/android/incallui/SecTabletVideoCallView;->mWidth:I

    return p1
.end method

.method static synthetic access$102(Lcom/android/incallui/SecTabletVideoCallView;I)I
    .locals 0

    iput p1, p0, Lcom/android/incallui/SecTabletVideoCallView;->mHeight:I
...
.method private updatePreparingAnimation(I)V
    .locals 1
    ...
    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->getVideoCallManager()Lcom/android/incallui/secservice/SecVideoCallManager;
    ...
    invoke-virtual {p0, v0}, Lcom/android/incallui/SecTabletVideoCallView;->showPreparingAnimation(Z)V
...
.method public captureSurfaceImage(Z)V
    ...
    invoke-direct {p0, v0}, Lcom/android/incallui/SecTabletVideoCallView;->checkStorageMemorySpace(Z)Z
    ...
    new-instance v1, Lcom/android/incallui/SecTabletVideoCallView$2;

    invoke-direct {v1, p0}, Lcom/android/incallui/SecTabletVideoCallView$2;-><init>(Lcom/android/incallui/SecTabletVideoCallView;)V
...
.method public changeOrientaiton(I)V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->getView()Landroid/view/View;
    ...
    invoke-virtual {v0}, Lcom/android/incallui/SecTabletInCallService;->getRequestedOrientation()I
    ...
    invoke-virtual {v0, p1}, Lcom/android/incallui/SecTabletInCallService;->setRequestedOrientation(I)V
...
.method public cleanupSurfaces()V
    ...
    sget-object v0, Lcom/android/incallui/SecTabletVideoCallView;->sDisplaySurface:Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;
    ...
    invoke-virtual {p0, v0}, Lcom/android/incallui/SecTabletVideoCallView;->surfaceTextureDestroyed(I)V

    :cond_0
    sget-object v0, Lcom/android/incallui/SecTabletVideoCallView;->sPreviewSurface:Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;
...
.method public bridge synthetic createPresenter()Lcom/android/incallui/Presenter;
    ...
    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->createPresenter()Lcom/android/incallui/VideoCallPresenter;
...
.method protected deInitView()V
    ...
    invoke-super {p0}, Lcom/android/incallui/SecTabletView;->deInitView()V
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->cleanupSurfaces()V

    iget-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mVideoCallViewHandler:Landroid/os/Handler;
...
.method public getDisplayVideoSurface()Landroid/view/Surface;
    ...
    invoke-virtual {v0}, Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;->getSurface()Landroid/view/Surface;
...
.method bridge synthetic getUi()Lcom/android/incallui/Ui;
    ...
    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->getUi()Lcom/android/incallui/SecVideoCallUi;
...
.method protected hideDialpadWithAniamation()V
    ...
    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->getSecUiAdapter()Lcom/android/incallui/secui/SecUiAdapter;
...
.method public inflateVideoCallViews()V
    ...
    iget-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mVideoViews:Landroid/view/View;

    if-eqz v0, :cond_0

    sget-boolean v0, Lcom/android/incallui/SecTabletVideoCallView;->sVideoSurfacesInUse:Z

    if-nez v0, :cond_1

    new-instance v0, Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;

    iget-object v1, p0, Lcom/android/incallui/SecTabletVideoCallView;->mIncomingVideo:Landroid/view/TextureView;

    invoke-direct {v0, p0, v3, v1}, Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;-><init>(Lcom/android/incallui/SecTabletVideoCallView;ILandroid/view/TextureView;)V

    sput-object v0, Lcom/android/incallui/SecTabletVideoCallView;->sDisplaySurface:Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;

    new-instance v0, Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;

    const/4 v1, 0x2

    iget-object v2, p0, Lcom/android/incallui/SecTabletVideoCallView;->mPreviewVideo:Landroid/view/TextureView;

    invoke-direct {v0, p0, v1, v2}, Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;-><init>(Lcom/android/incallui/SecTabletVideoCallView;ILandroid/view/TextureView;)V

    sput-object v0, Lcom/android/incallui/SecTabletVideoCallView;->sPreviewSurface:Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;

    sput-boolean v3, Lcom/android/incallui/SecTabletVideoCallView;->sVideoSurfacesInUse:Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;->recreateView(Landroid/view/TextureView;)V

    sget-object v0, Lcom/android/incallui/SecTabletVideoCallView;->sPreviewSurface:Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;

    iget-object v1, p0, Lcom/android/incallui/SecTabletVideoCallView;->mPreviewVideo:Landroid/view/TextureView;
...
.method protected initView()V
    ...
    iput-boolean v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mIsActivityRestart:Z
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->getPresenter()Lcom/android/incallui/Presenter;
    ...
    :cond_1
    iput-object p0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mVideoViews:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mIncomingVideo:Landroid/view/TextureView;

    iget-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mIncomingVideo:Landroid/view/TextureView;
    ...
    iput-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mPreviewVideo:Landroid/view/TextureView;

    iget-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mPreviewVideo:Landroid/view/TextureView;
    ...
    :cond_3
    sget-boolean v0, Lcom/android/incallui/SecTabletVideoCallView;->mIsShowingVideoUI:Z

    invoke-virtual {p0, v0}, Lcom/android/incallui/SecTabletVideoCallView;->showVideoUi(Z)V
...
.method public isActivityRestart()Z
    ...
    iget-boolean v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mIsActivityRestart:Z
...
.method protected isPossibleToHideBanner()Z
    ...
    iget-object v4, p0, Lcom/android/incallui/SecTabletVideoCallView;->mVideoCallViewHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v0}, Lcom/android/incallui/SecTabletInCallService;->getInCallMenu()Lcom/android/incallui/InCallMenu;
...
.method public notifyMediaEvent(Lcom/android/incallui/secservice/SecVideoCall;I)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/incallui/SecTabletVideoCallView;->showSwitchCameraAnimation(Z)V
    ...
    :sswitch_3
    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->hideDialpadWithAniamation()V
    ...
    :sswitch_4
    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->showNearEndCaptureAnimation()V

    goto :goto_0

    :sswitch_5
    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->showFarEndCaptureAnimation()V
...
.method public onEmergencyModeChange(I)V
    ...
    invoke-virtual {p0, v1, v1}, Lcom/android/incallui/SecTabletVideoCallView;->showRecordingInfo(ZZ)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/incallui/SecTabletVideoCallView;->showRecordingInfo(ZZ)V
...
.method public onSecVideoStateChanged(Lcom/android/incallui/secservice/SecVideoCall;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/incallui/SecTabletVideoCallView;->setCallState(Lcom/android/incallui/Call;)V
...
.method public setCallState(Lcom/android/incallui/Call;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/incallui/SecTabletVideoCallView;->updatePreparingAnimation(I)V
...
.method public setDisplayVideoSurface(Landroid/view/Surface;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/incallui/SecTabletVideoCallView$VideoCallSurface;->setSurface(Landroid/view/Surface;)V
...
.method public setPrimaryCallElapsedTime(ZLjava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/android/incallui/SecTabletVideoCallView;->mRecInfoTimeTextViewFarEnd:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Lcom/android/incallui/SecTabletVideoCallView;->mRecInfoTimeTextViewNearEnd:Landroid/widget/TextView;
...
.method public setVisibleCameraPreview(Z)V
    ...
    iget-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mPreviewContainer:Landroid/view/ViewGroup;
...
.method public showFarEndCaptureAnimation()V
    ...
    iget-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mFarEndCaptureAnimatinoView:Landroid/view/View;
...
.method public showNearEndCaptureAnimation()V
    ...
    iget-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mNearEndCaptureAnimatinoView:Landroid/view/View;
...
.method public showPreparingAnimation(Z)V
    ...
    iget-boolean v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->isShowingPreparingAnimation:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mPreparingAnimation:Landroid/view/View;

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->isShowingPreparingAnimation:Z
...
.method public showSwitchCameraAnimation(Z)V
    ...
    iget-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mNearEndSwitchAnimationView:Landroid/view/View;
...
.method public showVideoAsVideoState(Z)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/incallui/SecTabletVideoCallView;->showVideoAsVideoState(IZ)V
...
.method public showVideoIndicatorArea(Z)V
    ...
    iget-object v0, p0, Lcom/android/incallui/SecTabletVideoCallView;->mIndicatorArea:Landroid/view/ViewGroup;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lcom/android/incallui/SecTabletVideoCallView;->mIndicatorArea:Landroid/view/ViewGroup;
...
.method public showVideoUi(Z)V
    ...
    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->inflateVideoCallViews()V

    :goto_1
    iget-object v1, p0, Lcom/android/incallui/SecTabletVideoCallView;->mVideoViews:Landroid/view/View;
    ...
    :cond_0
    sput-boolean p1, Lcom/android/incallui/SecTabletVideoCallView;->mIsShowingVideoUI:Z
...
.method protected surfaceTextureCreated(ILandroid/graphics/SurfaceTexture;II)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/incallui/SecTabletVideoCallView;->setDisplayVideoSurface(Landroid/view/Surface;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/incallui/SecTabletVideoCallView;->setPreviewVideoSurface(Landroid/view/Surface;)V
...
.method protected togglePrimaryCallBanner()V
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/incallui/SecTabletVideoCallView;->mVideoCallViewHandler:Landroid/os/Handler;
    ...
    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->isPrimaryVisible()Z

    move-result v2

    if-eqz v2, :cond_4

    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->isPossibleToHideBanner()Z
    ...
    :goto_1
    iget-object v2, p0, Lcom/android/incallui/SecTabletVideoCallView;->mTouchBackground:Landroid/view/View;
    ...
    invoke-virtual {p0}, Lcom/android/incallui/SecTabletVideoCallView;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {p0, v1}, Lcom/android/incallui/SecTabletVideoCallView;->showPrimaryCallBanner(Z)V
...
.method public updateVideoIndicatorArea()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/incallui/SecTabletVideoCallView;->showVideoIndicatorArea(Z)V
