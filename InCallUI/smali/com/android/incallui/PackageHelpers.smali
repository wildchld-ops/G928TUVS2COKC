.class public Lcom/android/incallui/PackageHelpers;
...
.method public static isTopActivityRunning(Ljava/lang/String;)Z
    ...
    invoke-static {v0, p0}, Lcom/android/incallui/PackageHelpers;->isTopActivityRunning(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static launchContacts()V
    ...
    const-string v6, "launchContacts"
...
.method private static launchDuringCallMemo()V
    ...
    :cond_2
    invoke-static {}, Lcom/android/incallui/InCallUtils;->getPrimaryOriginalPhoneNumber()Ljava/lang/String;
    ...
    :try_start_0
    invoke-interface {v0, v3}, Lcom/android/incallui/BaseInCallComponent;->startActivity(Landroid/content/Intent;)V
    :try_end_0
    .catch Landroid/content/ActivityNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static launchDuringCallSnote()V
    ...
    invoke-virtual {v7}, Lcom/android/incallui/InCallPresenter;->getActivity()Lcom/android/incallui/BaseInCallComponent;
...
.method public static launchMemo()V
    ...
    invoke-static {}, Lcom/android/incallui/PackageHelpers;->launchDuringCallMemo()V
    ...
    invoke-static {}, Lcom/android/incallui/PackageHelpers;->launchDuringCallSnote()V

    goto :goto_0

    :cond_2
    invoke-static {}, Lcom/android/incallui/PackageHelpers;->isSamsungAppsPackageInstalled()Z

    move-result v1

    if-eqz v1, :cond_3

    invoke-interface {v0}, Lcom/android/incallui/BaseInCallComponent;->getContext()Landroid/content/Context;
    ...
    invoke-static {v1, v2}, Lcom/android/incallui/PackageHelpers;->showDownloadAppDialog(Landroid/content/Context;Ljava/lang/String;)V
...
.method public static launchMessage()V
    ...
    invoke-static {}, Lcom/android/incallui/InCallUtils;->getAliveParticipantNumber()Ljava/lang/String;
    ...
    const-string v6, "com.verizon.messaging.vzmsgs"
    ...
    const-string v7, "com.verizon.messaging.vzmsgs"

    const-string v8, "com.verizon.mms.ui.ComposeMessageActivity"
    ...
    :try_start_0
    invoke-interface {v0, v4}, Lcom/android/incallui/BaseInCallComponent;->startActivity(Landroid/content/Intent;)V
    :try_end_0
    .catch Landroid/content/ActivityNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static showDownloadAppDialog(Landroid/content/Context;Ljava/lang/String;)V
    ...
    new-instance v3, Lcom/android/incallui/PackageHelpers$1;

    invoke-direct {v3}, Lcom/android/incallui/PackageHelpers$1;-><init>()V

    invoke-virtual {v0, v2, v3}, Landroid/app/AlertDialog$Builder;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    const v2, 0x7f0d01fb

    new-instance v3, Lcom/android/incallui/PackageHelpers$2;

    invoke-direct {v3}, Lcom/android/incallui/PackageHelpers$2;-><init>()V
