.class Lcom/android/server/telecom/ConnectionServiceWrapper$4;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/server/telecom/ConnectionServiceWrapper;->queryRemoteConnectionServices(Lcom/android/internal/telecom/RemoteServiceCallback;)V
.end annotation
...
.field final synthetic val$callback:Lcom/android/internal/telecom/RemoteServiceCallback;

.field final synthetic val$currentSimService:Lcom/android/server/telecom/ConnectionServiceWrapper;

.field final synthetic val$simServiceBinders:Ljava/util/List;

.field final synthetic val$simServiceComponentNames:Ljava/util/List;

.field final synthetic val$simServices:Ljava/util/Set;
...
.method private maybeComplete()V
    .locals 4
    ...
    # invokes: Lcom/android/server/telecom/ConnectionServiceWrapper;->setRemoteServices(Lcom/android/internal/telecom/RemoteServiceCallback;Ljava/util/List;Ljava/util/List;)V
    invoke-static {v0, v1, v2, v3}, Lcom/android/server/telecom/ConnectionServiceWrapper;->access$1100(Lcom/android/server/telecom/ConnectionServiceWrapper;Lcom/android/internal/telecom/RemoteServiceCallback;Ljava/util/List;Ljava/util/List;)V
...
.method public onFailure()V
    ...
    invoke-static {v0, v1}, Lcom/android/server/telecom/ConnectionServiceWrapper;->access$1000(Lcom/android/server/telecom/ConnectionServiceWrapper;Lcom/android/internal/telecom/RemoteServiceCallback;)V
...
.method public onSuccess()V
    ...
    invoke-static {v1}, Lcom/android/server/telecom/ConnectionServiceWrapper;->access$900(Lcom/android/server/telecom/ConnectionServiceWrapper;)Lcom/android/internal/telecom/IConnectionService;
    ...
    invoke-direct {p0}, Lcom/android/server/telecom/ConnectionServiceWrapper$4;->maybeComplete()V
