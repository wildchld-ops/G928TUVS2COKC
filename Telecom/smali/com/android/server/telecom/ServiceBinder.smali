...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/telecom/ServiceBinder$1;,
...
# direct methods
.method protected constructor <init>(Ljava/lang/String;Landroid/content/ComponentName;Landroid/content/Context;Landroid/os/UserHandle;)V
    .locals 5
    ...
    iput-object p4, p0, Lcom/android/server/telecom/ServiceBinder;->mUserHandle:Landroid/os/UserHandle;
...
.method static synthetic access$000(Lcom/android/server/telecom/ServiceBinder;)V
    ...
    invoke-direct {p0}, Lcom/android/server/telecom/ServiceBinder;->clearAbort()V
...
.method static synthetic access$1000(Lcom/android/server/telecom/ServiceBinder;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/telecom/ServiceBinder;->handleSuccessfulConnection()V

    return-void
.end method

.method static synthetic access$1100(Lcom/android/server/telecom/ServiceBinder;)Z
    .locals 1
...
.method static synthetic access$1200(Lcom/android/server/telecom/ServiceBinder;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic access$1300(Lcom/android/server/telecom/ServiceBinder;Landroid/os/IBinder;)V
    .locals 0
...
.method static synthetic access$1400(Lcom/android/server/telecom/ServiceBinder;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/telecom/ServiceBinder;->handleServiceDisconnected()V
...
.method static synthetic access$600(Lcom/android/server/telecom/ServiceBinder;)Landroid/os/UserHandle;
    .locals 1

    iget-object v0, p0, Lcom/android/server/telecom/ServiceBinder;->mUserHandle:Landroid/os/UserHandle;

    return-object v0
.end method

.method static synthetic access$700(Lcom/android/server/telecom/ServiceBinder;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$800(Lcom/android/server/telecom/ServiceBinder;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/server/telecom/ServiceBinder;->handleFailedConnection()V

    return-void
.end method

.method static synthetic access$900(Lcom/android/server/telecom/ServiceBinder;)Landroid/os/IBinder;
    .locals 1
...
.method private handleSuccessfulConnection()V
    .locals 2
...
.method private setBinder(Landroid/os/IBinder;)V
    ...
    invoke-interface {v0, p0}, Lcom/android/server/telecom/ServiceBinder$Listener;->onUnbind(Lcom/android/server/telecom/ServiceBinder;)V
