...
# instance fields
.field final synthetic this$0:Lcom/android/server/telecom/ServiceBinder;
...
# virtual methods
.method bind(Lcom/android/server/telecom/ServiceBinder$BindCallback;)V
    .locals 7
    ...
    # invokes: Lcom/android/server/telecom/ServiceBinder;->clearAbort()V
    ...
    invoke-direct {v1, v2, v3}, Lcom/android/server/telecom/ServiceBinder$ServiceBinderConnection;-><init>(Lcom/android/server/telecom/ServiceBinder;Lcom/android/server/telecom/ServiceBinder$1;)V
    ...
    # getter for: Lcom/android/server/telecom/ServiceBinder;->mUserHandle:Landroid/os/UserHandle;
    invoke-static {v2}, Lcom/android/server/telecom/ServiceBinder;->access$600(Lcom/android/server/telecom/ServiceBinder;)Landroid/os/UserHandle;
    ...
    invoke-static {v2}, Lcom/android/server/telecom/ServiceBinder;->access$700(Lcom/android/server/telecom/ServiceBinder;)Landroid/content/Context;

    move-result-object v2

    iget-object v3, p0, Lcom/android/server/telecom/ServiceBinder$Binder;->this$0:Lcom/android/server/telecom/ServiceBinder;

    # getter for: Lcom/android/server/telecom/ServiceBinder;->mUserHandle:Landroid/os/UserHandle;
    invoke-static {v3}, Lcom/android/server/telecom/ServiceBinder;->access$600(Lcom/android/server/telecom/ServiceBinder;)Landroid/os/UserHandle;

    move-result-object v3

    invoke-virtual {v2, v0, v1, v6, v3}, Landroid/content/Context;->bindServiceAsUser(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
    ...
    # invokes: Lcom/android/server/telecom/ServiceBinder;->handleFailedConnection()V
    invoke-static {v0}, Lcom/android/server/telecom/ServiceBinder;->access$800(Lcom/android/server/telecom/ServiceBinder;)V
    ...
    invoke-static {v0}, Lcom/android/server/telecom/ServiceBinder;->access$900(Lcom/android/server/telecom/ServiceBinder;)Landroid/os/IBinder;
    ...
    # invokes: Lcom/android/server/telecom/ServiceBinder;->handleSuccessfulConnection()V
    invoke-static {v0}, Lcom/android/server/telecom/ServiceBinder;->access$1000(Lcom/android/server/telecom/ServiceBinder;)V
