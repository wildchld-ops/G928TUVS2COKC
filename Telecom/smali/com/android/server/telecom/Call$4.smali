.class Lcom/android/server/telecom/Call$4;
...
.method public bridge synthetic onError(Ljava/lang/Object;ILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/android/server/telecom/Call$4;->onError(Ljava/lang/Void;ILjava/lang/String;)V

    return-void
.end method

.method public onError(Ljava/lang/Void;ILjava/lang/String;)V
    .locals 5
...
.method public bridge synthetic onResult(Ljava/lang/Object;[Ljava/lang/Object;)V
    .locals 0
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/server/telecom/Call$4;->onResult(Ljava/lang/Void;[Ljava/util/List;)V

    return-void
.end method

.method public varargs onResult(Ljava/lang/Void;[Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, v1}, Lcom/android/server/telecom/Call;->access$402(Lcom/android/server/telecom/Call;Ljava/util/List;)Ljava/util/List;

    iget-object v0, p0, Lcom/android/server/telecom/Call$4;->this$0:Lcom/android/server/telecom/Call;

    # getter for: Lcom/android/server/telecom/Call;->mListeners:Ljava/util/Set;
    invoke-static {v0}, Lcom/android/server/telecom/Call;->access$500(Lcom/android/server/telecom/Call;)Ljava/util/Set;
    ...
    invoke-interface {v0, v2}, Lcom/android/server/telecom/Call$Listener;->onCannedSmsResponsesLoaded(Lcom/android/server/telecom/Call;)V
