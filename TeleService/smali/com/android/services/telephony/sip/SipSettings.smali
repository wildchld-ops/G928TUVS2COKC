...
.method private handleProfileClick(Landroid/net/sip/SipProfile;)V
    ...
    new-instance v3, Lcom/android/services/telephony/sip/SipSettings$6;

    invoke-direct {v3, p0, p1}, Lcom/android/services/telephony/sip/SipSettings$6;-><init>(Lcom/android/services/telephony/sip/SipSettings;Landroid/net/sip/SipProfile;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lcom/android/services/telephony/sip/SipSettings;->getWindow()Landroid/view/Window;
    ...
    iput-object v3, p0, Lcom/android/services/telephony/sip/SipSettings;->mSipManager:Landroid/net/sip/SipManager;

    new-instance v3, Lcom/android/services/telephony/sip/SipSharedPreferences;

    invoke-direct {v3, p0}, Lcom/android/services/telephony/sip/SipSharedPreferences;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/android/services/telephony/sip/SipSettings;->mSipSharedPreferences:Lcom/android/services/telephony/sip/SipSharedPreferences;
    ...
    iput-object v3, p0, Lcom/android/services/telephony/sip/SipSettings;->mProfileDb:Lcom/android/services/telephony/sip/SipProfileDb;

    invoke-virtual {p0}, Lcom/android/services/telephony/sip/SipSettings;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v3

    iput-object v3, p0, Lcom/android/services/telephony/sip/SipSettings;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    invoke-virtual {p0, v3}, Lcom/android/services/telephony/sip/SipSettings;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v2}, Lcom/android/services/telephony/sip/SipSettings;->setContentView(Landroid/view/View;)V

    :goto_0
    const v3, 0x7f07003d

    invoke-virtual {p0, v3}, Lcom/android/services/telephony/sip/SipSettings;->addPreferencesFromResource(I)V

    const-string v3, "sip_account_list"

    invoke-virtual {p0, v3}, Lcom/android/services/telephony/sip/SipSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v3

    check-cast v3, Landroid/preference/PreferenceCategory;

    iput-object v3, p0, Lcom/android/services/telephony/sip/SipSettings;->mSipListContainer:Landroid/preference/PreferenceCategory;

    invoke-static {}, Lcom/android/internal/telephony/CallManager;->getInstance()Lcom/android/internal/telephony/CallManager;

    move-result-object v3

    iput-object v3, p0, Lcom/android/services/telephony/sip/SipSettings;->mCallManager:Lcom/android/internal/telephony/CallManager;
    ...
    invoke-virtual {p0, v3}, Lcom/android/services/telephony/sip/SipSettings;->setContentView(I)V
