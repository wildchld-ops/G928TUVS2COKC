.class public Lcom/android/phone/operator/usa/ResetSettingListener;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/phone/operator/usa/ResetSettingListener;->REF_COUNTRY_SHARED_PREF:Landroid/net/Uri;
    ...
    sput-object v0, Lcom/android/phone/operator/usa/ResetSettingListener;->RESET_COUNTRY_DETAILS:Landroid/net/Uri;

    const-string v0, "default_message"

    sput-object v0, Lcom/android/phone/operator/usa/ResetSettingListener;->DefaultMessage:Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/phone/operator/usa/ResetSettingListener;->defaultRejectMsgList:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->rejectmsg_db:Landroid/database/sqlite/SQLiteDatabase;

    iput-object v0, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->autoreject_db:Landroid/database/sqlite/SQLiteDatabase;

    iput-object v0, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->autorejectoutgoingcall_db:Landroid/database/sqlite/SQLiteDatabase;
...
.method private resetAssistedDialingSetting()V
    ...
    iget-object v1, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->mContext:Landroid/content/Context;
    ...
    sget-object v1, Lcom/android/phone/operator/usa/ResetSettingListener;->REF_COUNTRY_SHARED_PREF:Landroid/net/Uri;

    invoke-virtual {v0, v1}, Landroid/content/ContentResolver;->acquireContentProviderClient(Landroid/net/Uri;)Landroid/content/ContentProviderClient;

    sget-object v1, Lcom/android/phone/operator/usa/ResetSettingListener;->RESET_COUNTRY_DETAILS:Landroid/net/Uri;
...
.method private resetAutoRejectCallSetting()V
    ...
    iget-object v2, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->mContext:Landroid/content/Context;

    invoke-direct {v1, v2}, Lcom/android/phone/callsettings/AutoRejectDB;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->autoreject:Lcom/android/phone/callsettings/AutoRejectDB;
    ...
    iput-object v1, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->autorejectoutgoingcall:Lcom/android/phone/callsettings/AutoRejectOutgoingCallDB;

    :try_start_0
    iget-object v1, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->autoreject:Lcom/android/phone/callsettings/AutoRejectDB;
    ...
    iput-object v1, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->autoreject_db:Landroid/database/sqlite/SQLiteDatabase;

    iget-object v1, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->autorejectoutgoingcall:Lcom/android/phone/callsettings/AutoRejectOutgoingCallDB;
    ...
    iput-object v1, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->autorejectoutgoingcall_db:Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0

    :goto_0
    iget-object v1, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->autoreject_db:Landroid/database/sqlite/SQLiteDatabase;

    const-string v2, "DROP TABLE IF EXISTS reject_num"

    invoke-virtual {v1, v2}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    iget-object v1, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->autorejectoutgoingcall_db:Landroid/database/sqlite/SQLiteDatabase;
...
.method private resetRejectWithMsgSetting()V
    ...
    iget-object v4, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->mContext:Landroid/content/Context;

    invoke-direct {v3, v4}, Lcom/android/phone/callsettings/RejectCallWithMsgDB;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->rejectmsg:Lcom/android/phone/callsettings/RejectCallWithMsgDB;

    :try_start_0
    iget-object v3, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->rejectmsg:Lcom/android/phone/callsettings/RejectCallWithMsgDB;
    ...
    iput-object v3, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->rejectmsg_db:Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0

    :goto_0
    iget-object v3, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->rejectmsg_db:Landroid/database/sqlite/SQLiteDatabase;
    ...
    :goto_1
    sget-object v3, Lcom/android/phone/operator/usa/ResetSettingListener;->defaultRejectMsgList:[Ljava/lang/String;
    ...
    sget-object v5, Lcom/android/phone/operator/usa/ResetSettingListener;->DefaultMessage:Ljava/lang/String;
...
.method private resetSettingProvideCallSetting()V
    ...
    iget-object v0, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->mContext:Landroid/content/Context;
...
.method private resetSharedprefCallSetting()V
    ...
    const-string v2, "button_meterial_voicemail_notification_vibrate_key"
...
.method private resetTempCallSetting()V
    ...
    :goto_0
    invoke-static {v0}, Lcom/android/services/telephony/common/SystemDBInterface;->setCallerInfoCardMode(I)V
    ...
    :goto_1
    invoke-static {v0}, Lcom/android/services/telephony/common/SystemDBInterface;->setTPhoneEnabled(I)V
    ...
    const-string v3, "intcall_voice_noti"
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iput-object p1, p0, Lcom/android/phone/operator/usa/ResetSettingListener;->mContext:Landroid/content/Context;

    invoke-direct {p0}, Lcom/android/phone/operator/usa/ResetSettingListener;->resetSettingProvideCallSetting()V

    invoke-direct {p0}, Lcom/android/phone/operator/usa/ResetSettingListener;->resetSharedprefCallSetting()V

    invoke-direct {p0}, Lcom/android/phone/operator/usa/ResetSettingListener;->resetRejectWithMsgSetting()V

    invoke-direct {p0}, Lcom/android/phone/operator/usa/ResetSettingListener;->resetAutoRejectCallSetting()V
    ...
    invoke-direct {p0}, Lcom/android/phone/operator/usa/ResetSettingListener;->resetAssistedDialingSetting()V

    invoke-direct {p0}, Lcom/android/phone/operator/usa/ResetSettingListener;->vzwCscResetSettingCallSetting()V

    :goto_0
    return-void

    :cond_0
    invoke-direct {p0}, Lcom/android/phone/operator/usa/ResetSettingListener;->resetTempCallSetting()V
