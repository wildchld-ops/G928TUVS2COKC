...
.field public mPhoneNumberLocatorDownloader:Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;
...
.method private getLastUpdateTime()[Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->mPhoneNumberLocatorDownloader:Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;

    const-string v5, "/data/data/com.android.phone/HomeLocationVersion.bin"

    invoke-virtual {v4, v5}, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;->getVersionInfo(Ljava/lang/String;)Lcom/android/phone/operator/chn/phonenumberlocator/VersionInfo;
    :try_end_0
    ...
    :cond_3
    iget-object v1, v0, Lcom/android/phone/operator/chn/phonenumberlocator/VersionInfo;->lastUpdate:Ljava/lang/String;
...
.method private isNetConnected()Z
    ...
    iget-boolean v1, p0, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->mWLANOnly:Z
    ...
    sget-boolean v2, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->isWifiNetConnected:Z
    ...
    invoke-direct {p0, v1}, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->log(Ljava/lang/String;)V
    ...
    sget-boolean v2, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->isSIMNetConnected:Z
...
.method private isVersionAndDBFileValid()Z
    ...
    iget-object v5, p0, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->mPhoneNumberLocatorDownloader:Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;

    if-eqz v5, :cond_4

    iget-object v5, p0, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->mPhoneNumberLocatorDownloader:Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;

    iget-object v6, p0, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->mPhoneNumberLocatorDownloader:Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;

    const-string v6, "/data/data/com.android.phone/HomeLocationVersion.bin"

    invoke-virtual {v5, v6}, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;->getVersionInfo(Ljava/lang/String;)Lcom/android/phone/operator/chn/phonenumberlocator/VersionInfo;

    move-result-object v2

    if-eqz v2, :cond_4

    iget-object v5, v2, Lcom/android/phone/operator/chn/phonenumberlocator/VersionInfo;->lastUpdate:Ljava/lang/String;
    ...
    invoke-direct {p0, v5, v4}, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->log(Ljava/lang/String;Z)V
    ...
    iget-wide v6, v2, Lcom/android/phone/operator/chn/phonenumberlocator/VersionInfo;->dbSize:J
    ...
    iput-object v5, v1, Lcom/android/phone/operator/chn/phonenumberlocator/DownloadFileInfo;->fileName:Ljava/lang/String;

    iget-wide v6, v2, Lcom/android/phone/operator/chn/phonenumberlocator/VersionInfo;->dbSize:J

    iput-wide v6, v1, Lcom/android/phone/operator/chn/phonenumberlocator/DownloadFileInfo;->fileSize:J

    iget-object v5, p0, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->mPhoneNumberLocatorDownloader:Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;

    invoke-virtual {v5, v1}, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;->readDownloadFileInfo(Lcom/android/phone/operator/chn/phonenumberlocator/DownloadFileInfo;)V
...
.method private needUpdateDB()Z
    ...
    invoke-direct {p0, v3, v2}, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->log(Ljava/lang/String;Z)V
...
.method public checkNetWork(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, v9, v8}, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->log(Ljava/lang/String;Z)V
    ...
    :cond_2
    sput-boolean v7, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->isWifiNetConnected:Z
    ...
    :cond_5
    sput-boolean v8, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->isSIMNetConnected:Z
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iget-object v0, p0, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->mPhoneNumberLocatorDownloader:Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;
    ...
    iput-object v0, p0, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->mPhoneNumberLocatorDownloader:Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;

    iget-object v0, p0, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->mPhoneNumberLocatorDownloader:Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;

    invoke-virtual {v0, v2}, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;->setTypeAuto(Z)V

    :cond_2
    iget-object v0, p0, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorBootCompletedReceiver;->mPhoneNumberLocatorDownloader:Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;

    invoke-virtual {v0, p1}, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;->setContext(Landroid/content/Context;)V
    ...
    invoke-virtual {v0}, Lcom/android/phone/operator/chn/phonenumberlocator/PhoneNumberLocatorDownloader;->startDownloadThread()V
