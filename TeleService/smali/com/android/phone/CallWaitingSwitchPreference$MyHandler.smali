...
.method private checkDSAforCW()V
    ...
    # getter for: Lcom/android/phone/CallWaitingSwitchPreference;->mContext:Landroid/content/Context;
    invoke-static {v2}, Lcom/android/phone/CallWaitingSwitchPreference;->access$200(Lcom/android/phone/CallWaitingSwitchPreference;)Landroid/content/Context;
    ...
    # getter for: Lcom/android/phone/CallWaitingSwitchPreference;->mSimId:I
    invoke-static {v2}, Lcom/android/phone/CallWaitingSwitchPreference;->access$400(Lcom/android/phone/CallWaitingSwitchPreference;)I
    ...
    :cond_2
    const-string v2, "CallWaitingSwitchPreference"
...
.method private handleGetCallWaitingResponse(Landroid/os/Message;)V
    ...
    # getter for: Lcom/android/phone/CallWaitingSwitchPreference;->mTcpListener:Lcom/android/phone/TimeConsumingPreferenceListener;
    invoke-static {v4}, Lcom/android/phone/CallWaitingSwitchPreference;->access$100(Lcom/android/phone/CallWaitingSwitchPreference;)Lcom/android/phone/TimeConsumingPreferenceListener;
    ...
    const-string v7, "Do not show IMS_404_NOT_FOUND message"
    ...
    # getter for: Lcom/android/phone/CallWaitingSwitchPreference;->mContext:Landroid/content/Context;
    invoke-static {v4}, Lcom/android/phone/CallWaitingSwitchPreference;->access$200(Lcom/android/phone/CallWaitingSwitchPreference;)Landroid/content/Context;
...
.method private handleSetCallWaitingResponse(Landroid/os/Message;)V
    ...
    const-string v1, "CallWaitingSwitchPreference"
    ...
    # getter for: Lcom/android/phone/CallWaitingSwitchPreference;->mPhone:Lcom/android/internal/telephony/Phone;
    invoke-static {v1}, Lcom/android/phone/CallWaitingSwitchPreference;->access$300(Lcom/android/phone/CallWaitingSwitchPreference;)Lcom/android/internal/telephony/Phone;
    ...
    invoke-virtual {p0, v2, v4, v4, v3}, Lcom/android/phone/CallWaitingSwitchPreference$MyHandler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
