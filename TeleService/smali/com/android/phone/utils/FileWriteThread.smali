.class public Lcom/android/phone/utils/FileWriteThread;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/phone/utils/FileWriteThread;->sDataConnectState:I

    const/4 v0, 0x0

    sput-boolean v0, Lcom/android/phone/utils/FileWriteThread;->mIsSetWakeKey:Z
...
.method public constructor <init>(I)V
    ...
    iput p1, p0, Lcom/android/phone/utils/FileWriteThread;->mThreadType:I
...
.method private chargingCutOff()V
    ...
    :cond_1
    const-string v6, "FileWriteThread_Telephony"
    ...
    const-string v7, "FileWriteThread_Telephony"
...
.method private dataChargingCutOff(Z)V
    ...
    sget v8, Lcom/android/phone/utils/FileWriteThread;->sDataConnectState:I
    ...
    const-string v5, "FileWriteThread_Telephony"
    ...
    :goto_2
    sput v5, Lcom/android/phone/utils/FileWriteThread;->sDataConnectState:I
...
.method private writeHardKeyResetFile()V
    ...
    invoke-direct {p0, v9}, Lcom/android/phone/utils/FileWriteThread;->log(Ljava/lang/String;)V
    :try_end_0
    ...
    const-string v9, "FileWriteThread_Telephony"
    ...
    invoke-direct {p0, v9, v10}, Lcom/android/phone/utils/FileWriteThread;->log(Ljava/lang/String;Z)V
    ...
    const-string v10, "FileWriteThread_Telephony"
...
.method private writeUartEnFile(Z)V
    ...
    :cond_1
    const-string v3, "/sys/class/sec/switch/uart_en"
    ...
    const-string v7, "writeUartEnFile : not exist file"

    invoke-direct {p0, v7}, Lcom/android/phone/utils/FileWriteThread;->log(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_2
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v9, "writeUartEnFile exception - "
    ...
    const-string v8, "writeUartEnFile : uartEnState = "
    ...
    invoke-direct {p0, v7, v8}, Lcom/android/phone/utils/FileWriteThread;->log(Ljava/lang/String;Z)V
    ...
    const-string v8, "1st close fail!!!"
    ...
    const-string v8, "FileWriteThread_Telephony"

    const-string v9, "2nd close fail!!!"
...
.method public run()V
    ...
    iget v0, p0, Lcom/android/phone/utils/FileWriteThread;->mThreadType:I
    ...
    :pswitch_0
    invoke-virtual {p0}, Lcom/android/phone/utils/FileWriteThread;->writeSleepCheckingFile()V

    goto :goto_0

    :pswitch_1
    invoke-direct {p0}, Lcom/android/phone/utils/FileWriteThread;->chargingCutOff()V

    goto :goto_0

    :pswitch_2
    invoke-direct {p0, v2}, Lcom/android/phone/utils/FileWriteThread;->dataChargingCutOff(Z)V

    goto :goto_0

    :pswitch_3
    invoke-direct {p0, v1}, Lcom/android/phone/utils/FileWriteThread;->dataChargingCutOff(Z)V

    goto :goto_0

    :pswitch_4
    invoke-direct {p0}, Lcom/android/phone/utils/FileWriteThread;->writeHardKeyResetFile()V

    goto :goto_0

    :pswitch_5
    invoke-direct {p0, v2}, Lcom/android/phone/utils/FileWriteThread;->writeUartEnFile(Z)V

    goto :goto_0

    :pswitch_6
    invoke-direct {p0, v1}, Lcom/android/phone/utils/FileWriteThread;->writeUartEnFile(Z)V
...
.method writeSleepCheckingFile()V
    ...
    :cond_0
    sget-boolean v4, Lcom/android/phone/utils/FileWriteThread;->mIsSetWakeKey:Z
    ...
    sput-boolean v1, Lcom/android/phone/utils/FileWriteThread;->mIsSetWakeKey:Z
    ...
    invoke-direct {p0, v4}, Lcom/android/phone/utils/FileWriteThread;->log(Ljava/lang/String;)V
