...
.method public afterTextChanged(Landroid/text/Editable;)V
    ...
    iget-boolean v5, p0, Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen;->istoastshowing:Z

    if-eqz v5, :cond_0

    iput-boolean v8, p0, Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen;->istoastshowing:Z
    ...
    new-instance v5, Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen$9;

    invoke-direct {v5, p0}, Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen$9;-><init>(Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen;)V
    ...
    invoke-virtual {p0, v5, v6}, Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen;->setHasOptionsMenu(Z)V
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    invoke-interface {p1, v4, v5, v0, v8}, Landroid/view/Menu;->add(IIII)Landroid/view/MenuItem;
    ...
    invoke-interface {v5, v3}, Landroid/view/MenuItem;->setShowAsActionFlags(I)Landroid/view/MenuItem;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    const-string v6, "disableEmoticonInput=true"
...
.method public onResume()V
    ...
    iget-object v2, p0, Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen;->actionBar:Landroid/app/ActionBar;
    ...
    iget v2, p0, Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen;->mEdittextBlockStart:I

    iget v3, p0, Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen;->mEdittextBlockEnd:I
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen;->handler:Landroid/os/Handler;

    new-instance v3, Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen$5;

    invoke-direct {v3, p0}, Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen$5;-><init>(Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen;)V

    const-wide/16 v4, 0xc8

    invoke-virtual {v2, v3, v4, v5}, Landroid/os/Handler;->postDelayed(Ljava/lang/Runnable;J)Z

    const-string v2, "display_reject_message_limit_for_kor"
    ...
    iget-object v3, p0, Lcom/android/phone/callsettings/EditRejectCallWithMsgScreen;->titleString:Ljava/lang/CharSequence;
