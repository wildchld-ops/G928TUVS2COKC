...
.method private static actuallyImportOneSimContact(Landroid/database/Cursor;Landroid/content/ContentResolver;Landroid/accounts/Account;)V
    ...
    invoke-direct {v10, v14}, Lcom/android/phone/SimContacts$NamePhoneTypePair;-><init>(Ljava/lang/String;)V

    iget-object v9, v10, Lcom/android/phone/SimContacts$NamePhoneTypePair;->name:Ljava/lang/String;

    iget v13, v10, Lcom/android/phone/SimContacts$NamePhoneTypePair;->phoneType:I
    ...
    invoke-virtual {v2, v14, v15}, Landroid/content/ContentProviderOperation$Builder;->withValueBackReference(Ljava/lang/String;I)Landroid/content/ContentProviderOperation$Builder;
    ...
    invoke-virtual {v2, v14, v9}, Landroid/content/ContentProviderOperation$Builder;->withValue(Ljava/lang/String;Ljava/lang/Object;)Landroid/content/ContentProviderOperation$Builder;
    ...
    :cond_1
    sget-object v14, Lcom/android/phone/SimContacts;->sEmptyContentValues:Landroid/content/ContentValues;
    ...
    invoke-virtual {v0, v14, v11}, Landroid/content/ContentResolver;->applyBatch(Ljava/lang/String;Ljava/util/ArrayList;)[Landroid/content/ContentProviderResult;
    :try_end_0
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    const-string v8, ".activities.PeopleActivity"
    ...
    iput-object v7, p0, Lcom/android/phone/SimContacts;->mProgressDialog:Landroid/app/ProgressDialog;
    ...
    invoke-virtual {v7, v6}, Landroid/app/ProgressDialog;->setProgressStyle(I)V
    ...
    invoke-virtual {p0, v9}, Lcom/android/phone/SimContacts;->getString(I)Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v7, v8, v9, v4}, Landroid/app/ProgressDialog;->setButton(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    iget-object v8, p0, Lcom/android/phone/SimContacts;->mCursor:Landroid/database/Cursor;
...
.method protected resolveIntent()Landroid/net/Uri;
    ...
    const-string v5, "content://icc/adn/subId/"
