...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/android/phone/photoring/PhotoringUtil;->contentUrl:Ljava/lang/String;

    sput-object v1, Lcom/android/phone/photoring/PhotoringUtil;->chgUrl:Ljava/lang/String;

    sput-object v1, Lcom/android/phone/photoring/PhotoringUtil;->mcms_server_uri:Ljava/lang/String;
...
.method public static copyFile(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_1
    const-string v10, "PhotoringUtil"

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string v12, "copyFile is : "
    ...
    invoke-virtual {v7, v0, v10, v11}, Ljava/io/FileInputStream;->read([BII)I
...
.method public static createAttachMenuDialog(Landroid/content/Context;Landroid/view/View$OnClickListener;)Landroid/app/AlertDialog;
    ...
    sput-object v4, Lcom/android/phone/photoring/PhotoringUtil;->mAttachMenuDialog:Landroid/app/AlertDialog;

    sget-object v4, Lcom/android/phone/photoring/PhotoringUtil;->mAttachMenuDialog:Landroid/app/AlertDialog;
...
.method public static getB2C()Z
    .locals 1

    invoke-static {}, Lcom/android/services/telephony/common/SystemDBInterface;->getMcidB2C()Z
...
.method public static getChgUrl()Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/phone/photoring/PhotoringUtil;->chgUrl:Ljava/lang/String;
...
.method public static getContentUrl()Ljava/lang/String;
    ...
    sget-object v0, Lcom/android/phone/photoring/PhotoringUtil;->contentUrl:Ljava/lang/String;
...
.method public static getServiceType()I
    ...
    invoke-static {}, Lcom/android/services/telephony/common/SystemDBInterface;->getMcidServiveType()I
...
.method public static isNeedProcessTrim(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    :cond_2
    const-string v3, "PhotoringUtil"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "isNeedProcessTrim - "
...
.method public static isPhotoringBlockNumber(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    sput-boolean v0, Lcom/android/phone/photoring/PhotoringUtil;->mblockedNumber:Z

    sput-boolean v0, Lcom/android/phone/photoring/PhotoringUtil;->modifiedblocked:Z
...
.method public static refleshAlertInfoValue(Ljava/lang/String;)Z
    ...
    const-string v10, "refleshAlertInfoValue="
    ...
    const-string v7, "PhotoringUtil"

    const-string v8, "refleshAlertInfoValue : isB2C is null "
    ...
    const-string v6, "PhotoringUtil"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "contentURLValues="
...
.method public static setB2C(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/android/services/telephony/common/SystemDBInterface;->setMcidB2C(I)V
...
.method public static setDownloadableValue(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/android/services/telephony/common/SystemDBInterface;->setMcidDownloadable(I)V
...
.method public static setServicetypeValue(Ljava/lang/String;)V
    ...
    :goto_0
    invoke-static {v0}, Lcom/android/services/telephony/common/SystemDBInterface;->setMcidServiceType(I)V
...
.method public static setVideo(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)J
    ...
    :cond_2
    sget v6, Lcom/android/phone/photoring/PhotoringUtil;->outputX:I

    sget v7, Lcom/android/phone/photoring/PhotoringUtil;->outputY:I
    ...
    invoke-static {v4, v1}, Lcom/android/phone/photoring/PhotoringUtil;->overlay(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;

    move-result-object v4

    invoke-static {p0, v4, p2}, Lcom/android/phone/photoring/PhotoringUtil;->saveBitmap(Landroid/content/Context;Landroid/graphics/Bitmap;Ljava/lang/String;)V
...
.method public static setVideoFromFile(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    sget v2, Lcom/android/phone/photoring/PhotoringUtil;->outputX:I

    sget v3, Lcom/android/phone/photoring/PhotoringUtil;->outputY:I
    ...
    invoke-static {v1, v0}, Lcom/android/phone/photoring/PhotoringUtil;->overlay(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;

    move-result-object v1

    invoke-static {p0, v1, p2}, Lcom/android/phone/photoring/PhotoringUtil;->saveBitmap(Landroid/content/Context;Landroid/graphics/Bitmap;Ljava/lang/String;)V
