...
.method static createObject(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;
    ...
    sget-boolean v15, Lmf/org/apache/xerces/parsers/ObjectFactory;->DEBUG:Z

    if-eqz v15, :cond_0

    const-string v15, "debug is on"

    invoke-static {v15}, Lmf/org/apache/xerces/parsers/ObjectFactory;->debugPrintln(Ljava/lang/String;)V
    ...
    invoke-static {v13, v2, v15}, Lmf/org/apache/xerces/parsers/ObjectFactory;->newInstance(Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/lang/Object;
    :try_end_0
    ...
    invoke-static {v15}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getSystemProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_2
    invoke-static {v9}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getFileExists(Ljava/io/File;)Z
    :try_end_2
    ...
    :goto_1
    const-class v16, Lmf/org/apache/xerces/parsers/ObjectFactory;
    ...
    :try_start_3
    sget-wide v18, Lmf/org/apache/xerces/parsers/ObjectFactory;->fLastModified:J
    ...
    invoke-static {v8}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getLastModified(Ljava/io/File;)J

    move-result-wide v20

    sput-wide v20, Lmf/org/apache/xerces/parsers/ObjectFactory;->fLastModified:J
    ...
    sput-object v15, Lmf/org/apache/xerces/parsers/ObjectFactory;->fXercesProperties:Ljava/util/Properties;

    invoke-static {v8}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;

    move-result-object v5

    sget-object v15, Lmf/org/apache/xerces/parsers/ObjectFactory;->fXercesProperties:Ljava/util/Properties;
    ...
    invoke-static {v4, v2, v15}, Lmf/org/apache/xerces/parsers/ObjectFactory;->newInstance(Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/lang/Object;
    ...
    sput-wide v16, Lmf/org/apache/xerces/parsers/ObjectFactory;->fLastModified:J
    ...
    :try_start_6
    sput-wide v18, Lmf/org/apache/xerces/parsers/ObjectFactory;->fLastModified:J
    ...
    invoke-static {v15}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getFileInputStream(Ljava/io/File;)Ljava/io/FileInputStream;
    ...
    new-instance v15, Lmf/org/apache/xerces/parsers/ObjectFactory$ConfigurationError;
    ...
    invoke-direct/range {v15 .. v17}, Lmf/org/apache/xerces/parsers/ObjectFactory$ConfigurationError;-><init>(Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-static {v0, v2, v15}, Lmf/org/apache/xerces/parsers/ObjectFactory;->newInstance(Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/lang/Object;
...
.method private static findJarServiceProvider(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v0, v6}, Lmf/org/apache/xerces/parsers/SecuritySupport;->getResourceAsStream(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    sget-boolean v8, Lmf/org/apache/xerces/parsers/ObjectFactory;->DEBUG:Z
    ...
    invoke-static {v8}, Lmf/org/apache/xerces/parsers/ObjectFactory;->debugPrintln(Ljava/lang/String;)V

    :cond_4
    const/4 v8, 0x0

    invoke-static {v3, v0, v8}, Lmf/org/apache/xerces/parsers/ObjectFactory;->newInstance(Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/lang/Object;
...
.method static newInstance(Ljava/lang/String;Ljava/lang/ClassLoader;Z)Ljava/lang/Object;
    ...
    new-instance v3, Lmf/org/apache/xerces/parsers/ObjectFactory$ConfigurationError;
    ...
    invoke-direct {v3, v4, v2}, Lmf/org/apache/xerces/parsers/ObjectFactory$ConfigurationError;-><init>(Ljava/lang/String;Ljava/lang/Exception;)V
