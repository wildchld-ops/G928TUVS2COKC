...
.method public run()V
    ...
    # getter for: Lcom/sec/epdg/smartwifi/SmartWifiAdapter;->mHandler:Landroid/os/Handler;
    invoke-static {v4}, Lcom/sec/epdg/smartwifi/SmartWifiAdapter;->access$300(Lcom/sec/epdg/smartwifi/SmartWifiAdapter;)Landroid/os/Handler;

    move-result-object v4

    iget-object v5, p0, Lcom/sec/epdg/smartwifi/SmartWifiAdapter$WifiToLteRunnable;->mSuccess:Ljava/lang/Runnable;

    iget-object v6, p0, Lcom/sec/epdg/smartwifi/SmartWifiAdapter$WifiToLteRunnable;->mFailure:Ljava/lang/Runnable;

    invoke-direct {v3, v4, v5, v6}, Lcom/sec/epdg/smartwifi/SmartWifiAdapter$ResultRunnable;-><init>(Landroid/os/Handler;Ljava/lang/Runnable;Ljava/lang/Runnable;)V
