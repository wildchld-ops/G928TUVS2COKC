...
.method private mapIwlanSettingToIPsecConnection(Lcom/sec/epdg/IWlanApnSetting;Ljava/lang/String;Ljava/lang/String;I)Lcom/ipsec/client/IPsecConnection;
    ...
    const-string v19, "[IPSECADAPTER]"

    const-string/jumbo v20, "mapIwlanSettingToIPsecConnection()"

    invoke-static/range {v19 .. v20}, Lcom/sec/epdg/Log;->d(Ljava/lang/String;Ljava/lang/String;)V

    const/4 v15, 0x0

    new-instance v5, Lcom/ipsec/client/IPsecConnection;

    invoke-direct {v5}, Lcom/ipsec/client/IPsecConnection;-><init>()V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setName(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setVirtualAdapterName(Ljava/lang/String;)V
    ...
    :cond_1
    invoke-virtual {v5, v10}, Lcom/ipsec/client/IPsecConnection;->setGateway(Ljava/lang/String;)V

    const/16 v19, 0x0

    move/from16 v0, v19

    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setUserAuthentication(Z)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setSubnetType(Lcom/ipsec/client/IPsecConnection$IPVersion;)V
    ...
    invoke-virtual {v5, v0, v1}, Lcom/ipsec/client/IPsecConnection;->setOwnIdentity(Lcom/ipsec/client/IPsecConnection$IdentityType;Ljava/lang/String;)V
    ...
    sget v19, Lcom/sec/epdg/IPSecAdapter;->INSIDE_SECURE:I

    sput v19, Lcom/sec/epdg/IPSecAdapter;->TESTING_TYPE:I

    :goto_1
    sget v19, Lcom/sec/epdg/IPSecAdapter;->TESTING_TYPE:I

    sget v20, Lcom/sec/epdg/IPSecAdapter;->CISCO_TESTING:I
    ...
    invoke-virtual {v5, v0, v1}, Lcom/ipsec/client/IPsecConnection;->setRemoteIdentity(Lcom/ipsec/client/IPsecConnection$IdentityType;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setUsername(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->addEapMethod(Lcom/ipsec/client/IPsecConnection$EapMethod;)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setPerfectForwardSecrecy(Z)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setHostAuthentication(Lcom/ipsec/client/IPsecConnection$HostAuthentication;)V

    sget v19, Lcom/sec/epdg/IPSecAdapter;->TESTING_TYPE:I

    sget v20, Lcom/sec/epdg/IPSecAdapter;->INSIDE_SECURE:I
    ...
    const-string/jumbo v20, "self@ipsec.com"
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setPreSharedKey(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setGlobalDnsConfiguration(Z)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setTunnelMode(Lcom/ipsec/client/IPsecConnection$TunnelMode;)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setIPsecEncryption(Lcom/ipsec/client/IPsecConnection$IPsecEncryption;)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setIPsecIntegrity(Lcom/ipsec/client/IPsecConnection$IPsecIntegrity;)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setIPsecGroup(Lcom/ipsec/client/IPsecConnection$IPsecGroup;)V

    const/16 v19, 0x1

    move/from16 v0, v19

    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setIPsecAntiReplay(Z)V
    ...
    invoke-virtual {v5, v0, v1}, Lcom/ipsec/client/IPsecConnection;->setIPsecLife(Lcom/ipsec/client/IPsecConnection$IPsecLifeType;I)V
    ...
    const-string v19, "/system/etc/ca.crt"
    ...
    :try_start_3
    invoke-virtual {v5, v3}, Lcom/ipsec/client/IPsecConnection;->setCaCertificate(Ljava/security/cert/X509Certificate;)V

    const-string v19, "[IPSECADAPTER]"

    const-string v20, "Success to setCaCertificate"
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setIkeVersion(Lcom/ipsec/client/IPsecConnection$IkeVersion;)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setIkeIntegrity(Lcom/ipsec/client/IPsecConnection$IkeIntegrity;)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setIkeEncryption(Lcom/ipsec/client/IPsecConnection$IkeEncryption;)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setGroup(Lcom/ipsec/client/IPsecConnection$IkeGroup;)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setIkeLife(I)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setIkeWindowSize(I)V

    sget v19, Lcom/sec/epdg/IPSecAdapter;->TESTING_TYPE:I

    sget v20, Lcom/sec/epdg/IPSecAdapter;->SETCOM_TESTING:I
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setConnectTimeout(I)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setDpdTimeout(I)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setNattKeepaliveTimeout(I)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setVirtualAdapterConfiguration(Lcom/ipsec/client/IPsecConnection$VirtualAdapterConfigurationMethod;)V
    ...
    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setRequestedRacIPv4Address(Ljava/lang/String;)V

    move-object/from16 v0, p3

    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->setRequestedRacIPv6Address(Ljava/lang/String;)V
    ...
    new-instance v19, Lcom/ipsec/client/IPsecIkeCfgAttribute;

    invoke-static {}, Lcom/sec/epdg/EpdgUtils;->getPcscfv4VendorAttr()I

    move-result v20

    invoke-direct/range {v19 .. v20}, Lcom/ipsec/client/IPsecIkeCfgAttribute;-><init>(I)V

    move-object/from16 v0, v19

    invoke-virtual {v5, v0}, Lcom/ipsec/client/IPsecConnection;->addRequestIkeCfgAttribute(Lcom/ipsec/client/IPsecIkeCfgAttribute;)V
    ...
    invoke-direct {v0, v12, v1}, Lcom/ipsec/client/IPsecIkeCfgAttribute;-><init>(I[B)V
    ...
    new-instance v11, Lcom/ipsec/client/IPsecNetworkInterface;
    ...
    invoke-direct {v11, v0}, Lcom/ipsec/client/IPsecNetworkInterface;-><init>(Ljava/lang/String;)V

    invoke-virtual {v5, v11}, Lcom/ipsec/client/IPsecConnection;->addInterface(Lcom/ipsec/client/IPsecNetworkInterface;)V
    ...
    sget v19, Lcom/sec/epdg/IPSecAdapter;->SETCOM_TESTING:I
    ...
    sget v19, Lcom/sec/epdg/IPSecAdapter;->CISCO_TESTING:I
    ...
    const-string/jumbo v20, "south@ipsec.com"
    ...
    const-string/jumbo v19, "hostelrybumped"
    ...
    const-string/jumbo v19, "harrowedregularizes"
    ...
    const-string/jumbo v21, "mapIwlanSettingToIPsecConnection(): IOException "
    ...
    const-string/jumbo v21, "mapIwlanSettingToIPsecConnection(): CertificateException "
    ...
    const-string/jumbo v22, "mapIwlanSettingToIPsecConnection(): IOException "
    ...
    const-string/jumbo v21, "mapIwlanSettingToIPsecConnection(): CertificateEncodingException "
