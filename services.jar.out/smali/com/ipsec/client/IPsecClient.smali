...
.method static constructor <clinit>()V
    ...
    const-string v1, "Starting. Package version is 939-23012-001-quicksec-vpnclient-for-android-3.3.1-2811-b2567729009d-2015-01-30_13-36-53"
...
.method private decodeConnectionStateBundle(Landroid/os/Bundle;Lcom/ipsec/client/IPsecConnectionState;)Z
    ...
    const-string/jumbo v14, "gateway-ip"
    ...
    const-string/jumbo v14, "local-ip"
    ...
    :cond_0
    const-string/jumbo v14, "own-identity"
    ...
    const-string/jumbo v14, "own-identity-type"
    ...
    const-string/jumbo v16, "invalid rac-ip: "
    ...
    const-string/jumbo v16, "invalid rac-dns: "
    ...
    const-string/jumbo v16, "invalid rac-subnet: "
...
.method private decodeRelayDataBundle(Landroid/os/Bundle;Lcom/ipsec/client/IPsecRelayData;)Z
    ...
    invoke-virtual {p2, v6}, Lcom/ipsec/client/IPsecRelayData;->setSignature([B)V
    ...
    invoke-virtual {p2, v6}, Lcom/ipsec/client/IPsecRelayData;->setSignatureInput([B)V
    ...
    invoke-virtual {p2, v6}, Lcom/ipsec/client/IPsecRelayData;->setSignatureScheme(Ljava/lang/String;)V
...
.method private doStopService()Lcom/ipsec/client/IPsecError;
    ...
    iget-object v11, p0, Lcom/ipsec/client/IPsecClient;->mCallback:Lcom/ipsec/client/IPsecServiceCallbackBinder;
...
.method private encodeConnectBundle(Lcom/ipsec/client/IPsecConnection;Ljava/lang/StringBuilder;)Landroid/os/Bundle;
    ...
    invoke-virtual/range {v35 .. v35}, Lcom/ipsec/client/IPsecError;->name()Ljava/lang/String;
    ...
    :cond_1
    const-string/jumbo v35, "gateway"
    ...
    invoke-virtual/range {v36 .. v36}, Lcom/ipsec/client/IPsecConnection$IPVersion;->name()Ljava/lang/String;
    ...
    :cond_2
    :goto_2
    const-string/jumbo v35, "internal-subnet"
    ...
    const-string/jumbo v35, "interface"
    ...
    :cond_b
    const-string/jumbo v35, "host-authentication"

    invoke-virtual/range {p1 .. p1}, Lcom/ipsec/client/IPsecConnection;->getHostAuthentication()Lcom/ipsec/client/IPsecConnection$HostAuthentication;

    move-result-object v36

    invoke-virtual/range {v36 .. v36}, Lcom/ipsec/client/IPsecConnection$HostAuthentication;->name()Ljava/lang/String;
    ...
    invoke-virtual/range {v36 .. v36}, Lcom/ipsec/client/IPsecConnection$TunnelMode;->name()Ljava/lang/String;
    ...
    invoke-virtual/range {v35 .. v35}, Lcom/ipsec/client/IPsecConnection$IPsecGroup;->name()Ljava/lang/String;
    ...
    :cond_d
    const-string/jumbo v35, "ipsec-group"
    ...
    :cond_f
    const-string/jumbo v35, "ipsec-life-type"

    invoke-virtual/range {p1 .. p1}, Lcom/ipsec/client/IPsecConnection;->getIPsecLifeType()Lcom/ipsec/client/IPsecConnection$IPsecLifeType;

    move-result-object v36

    invoke-virtual/range {v36 .. v36}, Lcom/ipsec/client/IPsecConnection$IPsecLifeType;->name()Ljava/lang/String;
    ...
    const-string/jumbo v35, "ipsec-life-value"
    ...
    invoke-virtual/range {v35 .. v35}, Lcom/ipsec/client/IPsecConnection$IPsecEncryption;->name()Ljava/lang/String;
    ...
    :cond_10
    const-string/jumbo v35, "ipsec-encryption"
    ...
    invoke-virtual/range {v35 .. v35}, Lcom/ipsec/client/IPsecConnection$IPsecIntegrity;->name()Ljava/lang/String;
    ...
    :cond_11
    const-string/jumbo v35, "ipsec-integrity"
    ...
    invoke-virtual/range {v35 .. v35}, Lcom/ipsec/client/IPsecConnection$IkeGroup;->name()Ljava/lang/String;
    ...
    const-string/jumbo v35, "ike-life"
    ...
    const-string/jumbo v35, "ike-version"

    invoke-virtual/range {p1 .. p1}, Lcom/ipsec/client/IPsecConnection;->getIkeVersion()Lcom/ipsec/client/IPsecConnection$IkeVersion;

    move-result-object v36

    invoke-virtual/range {v36 .. v36}, Lcom/ipsec/client/IPsecConnection$IkeVersion;->name()Ljava/lang/String;
    ...
    invoke-virtual/range {v35 .. v35}, Lcom/ipsec/client/IPsecConnection$IkeEncryption;->name()Ljava/lang/String;
    ...
    :cond_13
    const-string/jumbo v35, "ike-encryption"
    ...
    invoke-virtual/range {v35 .. v35}, Lcom/ipsec/client/IPsecConnection$IkeIntegrity;->name()Ljava/lang/String;
    ...
    :cond_14
    const-string/jumbo v35, "ike-integrity"
    ...
    const-string/jumbo v35, "ike-window-size"
    ...
    :cond_15
    const-string/jumbo v35, "own-identity-type"

    invoke-virtual/range {p1 .. p1}, Lcom/ipsec/client/IPsecConnection;->getOwnIdentityType()Lcom/ipsec/client/IPsecConnection$IdentityType;

    move-result-object v36

    invoke-virtual/range {v36 .. v36}, Lcom/ipsec/client/IPsecConnection$IdentityType;->name()Ljava/lang/String;
    ...
    const-string/jumbo v35, "own-identity"
    ...
    const-string/jumbo v35, "remote-identity-enforce"
    ...
    const-string/jumbo v35, "password"
    ...
    const-string/jumbo v35, "hybrid-mode"
    ...
    const-string/jumbo v35, "natt-keepalive-timeout"
    ...
    const-string/jumbo v35, "pmtu-limit"
    ...
    :cond_1b
    const-string/jumbo v35, "im-certificate"
    ...
    invoke-virtual/range {v36 .. v36}, Lcom/ipsec/client/IPsecConnection$VirtualAdapterConfigurationMethod;->name()Ljava/lang/String;
    ...
    const-string/jumbo v35, "global-dns-conf"
    ...
    const-string v35, "algorithm-security-strength"
...
.method public clearLog()V
    ...
    const-string v3, "IPSC/IPsecClient"
    ...
    const-string v4, "clearLog(): failed (service not started)"
    ...
    const-string v4, "clearLog(): failed (no result available)"
    ...
    const-string v5, "clearLog(): failed (remote exception "
    ...
    const-string v5, "clearLog(): failed (error: "
...
.method public connect(Lcom/ipsec/client/IPsecConnection;Lcom/ipsec/client/IPsecEventData;)Lcom/ipsec/client/IPsecError;
    ...
    const-string/jumbo v10, "ike-error-value"
...
.method public continueConnect(Lcom/ipsec/client/IPsecConnection;Lcom/ipsec/client/IPsecEventData;Lcom/ipsec/client/IPsecRelayData;)Lcom/ipsec/client/IPsecError;
    ...
    invoke-virtual/range {p3 .. p3}, Lcom/ipsec/client/IPsecRelayData;->getSignature()[B
    ...
    const-string/jumbo v14, "signature-input"

    invoke-virtual/range {p3 .. p3}, Lcom/ipsec/client/IPsecRelayData;->getSignatureInput()[B
    ...
    const-string/jumbo v14, "signature-scheme"

    invoke-virtual/range {p3 .. p3}, Lcom/ipsec/client/IPsecRelayData;->getSignatureScheme()Ljava/lang/String;
    ...
    const-string/jumbo v17, "ike-error-value"
    ...
    const-string/jumbo v14, "ike-error-value"
...
.method public getIPsecConnectionState(Lcom/ipsec/client/IPsecConnection;)Lcom/ipsec/client/IPsecConnectionState;
    ...
    const-string/jumbo v7, "getIPsecConnectionState():  (no return value)"
    ...
    const-string/jumbo v9, "getIPsecConnectionState():  (remote exception: "
    ...
    const-string/jumbo v8, "getIPsecConnectionState(): result version: "
    ...
    const-string/jumbo v8, "getIPsecConnectionState() =  (error: "
    ...
    const-string/jumbo v7, "getIPsecConnectionState(): failed to decode result bundle"
    ...
    const-string/jumbo v7, "getIPsecConnectionState(): "
...
.method public getLogReader()Lcom/ipsec/client/IPsecLogReader;
    ...
    const-string/jumbo v8, "getLogReader()"
    ...
    const-string/jumbo v8, "getLogReader(): no log available"
    ...
    const-string/jumbo v9, "getLogReader() failed (error: "
    ...
    const-string/jumbo v8, "getLogReader(): log-content null"
...
.method public getServiceConnection()Landroid/content/ServiceConnection;
    ...
    const-string/jumbo v2, "getServiceConnection() = "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p0, Lcom/ipsec/client/IPsecClient;->mIPsecServiceConnection:Lcom/ipsec/client/IPsecClient$IPsecServiceConnection;
...
.method public getServiceIntent()Landroid/content/Intent;
    ...
    const-string/jumbo v3, "getServiceIntent() = "
...
.method public isServiceStarted()Z
    ...
    const-string/jumbo v3, "isServiceStarted() = "
...
.method public queryData(Lcom/ipsec/client/IPsecConnection;Lcom/ipsec/client/IPsecRelayData;)Lcom/ipsec/client/IPsecError;
    ...
    const-string/jumbo v5, "getIPsecConnectionState(): failed to decode result bundle"
