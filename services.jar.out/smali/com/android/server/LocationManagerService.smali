...
.method private removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/server/LocationManagerService;->saveLocationRequestString(Ljava/lang/String;)V
...
.method private requestLocationUpdatesLocked(Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;IILjava/lang/String;)V
    ...
    :cond_2
    new-instance v5, Lcom/android/server/LocationManagerService$UpdateRecord;

    invoke-direct {v5, p0, v2, p1, p2}, Lcom/android/server/LocationManagerService$UpdateRecord;-><init>(Lcom/android/server/LocationManagerService;Ljava/lang/String;Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;)V
    ...
    invoke-virtual {v3, v9}, Lcom/android/server/LocationManagerService$UpdateRecord;->disposeLocked(Z)V
    ...
    const-string v6, "com.android.angryGps"
    ...
    const-string/jumbo v8, "stack dump"

    invoke-direct {v7, v8}, Ljava/lang/Throwable;-><init>(Ljava/lang/String;)V

    invoke-static {v7}, Lcom/android/server/LocationManagerService;->getStringStackTrace(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    :cond_5
    invoke-virtual {p2, v2, v9}, Lcom/android/server/LocationManagerService$Receiver;->callProviderEnabledLocked(Ljava/lang/String;Z)Z
...
.method public systemRunning()V
    ...
    invoke-interface {v10, v0}, Lcom/samsung/location/ISLocationManager;->setGpsGeofenceHardware(Landroid/location/IGpsGeofenceHardware;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-virtual {v0, v1, v11, v2, v5}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
    ...
    invoke-virtual {v0, v1, v2, v11}, Lcom/android/internal/content/PackageMonitor;->register(Landroid/content/Context;Landroid/os/Looper;Z)V
