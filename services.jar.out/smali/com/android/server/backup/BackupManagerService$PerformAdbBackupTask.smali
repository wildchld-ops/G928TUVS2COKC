...
.method private emitAesBackupHeader(Ljava/lang/StringBuilder;Ljava/io/OutputStream;)Ljava/io/OutputStream;
    ...
    invoke-static/range {v19 .. v20}, Lcom/android/server/backup/BackupManagerService;->access$2200(Lcom/android/server/backup/BackupManagerService;I)[B
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lcom/android/server/backup/BackupManagerService;->access$2300(Lcom/android/server/backup/BackupManagerService;Ljava/lang/String;Ljava/lang/String;[BI)Ljavax/crypto/SecretKey;
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/server/backup/BackupManagerService;->access$2400(Lcom/android/server/backup/BackupManagerService;)Ljava/security/SecureRandom;
    ...
    invoke-static {v0, v1}, Lcom/android/server/backup/BackupManagerService;->access$2500(Lcom/android/server/backup/BackupManagerService;[B)Ljava/lang/String;
    ...
    # invokes: Lcom/android/server/backup/BackupManagerService;->byteArrayToHex([B)Ljava/lang/String;
    invoke-static {v0, v9}, Lcom/android/server/backup/BackupManagerService;->access$2500(Lcom/android/server/backup/BackupManagerService;[B)Ljava/lang/String;
    ...
    # invokes: Lcom/android/server/backup/BackupManagerService;->byteArrayToHex([B)Ljava/lang/String;
    invoke-static {v0, v5}, Lcom/android/server/backup/BackupManagerService;->access$2500(Lcom/android/server/backup/BackupManagerService;[B)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v2, v9, v3}, Lcom/android/server/backup/BackupManagerService;->access$2600(Lcom/android/server/backup/BackupManagerService;Ljava/lang/String;[B[BI)[B
    ...
    # invokes: Lcom/android/server/backup/BackupManagerService;->byteArrayToHex([B)Ljava/lang/String;
    invoke-static {v0, v10}, Lcom/android/server/backup/BackupManagerService;->access$2500(Lcom/android/server/backup/BackupManagerService;[B)Ljava/lang/String;
...
.method addPackagesToSet(Ljava/util/TreeMap;Ljava/util/List;)V
    ...
    invoke-static {v5}, Lcom/android/server/backup/BackupManagerService;->access$900(Lcom/android/server/backup/BackupManagerService;)Z
    ...
    invoke-static {v7}, Lcom/android/server/backup/BackupManagerService;->access$2100(Lcom/android/server/backup/BackupManagerService;)I
...
.method public run()V
    ...
    # getter for: Lcom/android/server/backup/BackupManagerService;->isEdmBackupRequest:Z
    invoke-static/range {v25 .. v25}, Lcom/android/server/backup/BackupManagerService;->access$900(Lcom/android/server/backup/BackupManagerService;)Z
    ...
    invoke-static/range {v25 .. v26}, Lcom/android/server/backup/BackupManagerService;->access$2700(Lcom/android/server/backup/BackupManagerService;Ljava/lang/String;)Z
    ...
    invoke-static/range {v25 .. v26}, Lcom/android/server/backup/BackupManagerService;->access$2002(Lcom/android/server/backup/BackupManagerService;Z)Z
    :try_end_18
