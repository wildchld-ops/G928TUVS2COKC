...
.field mChildCoupledTask:Lcom/android/server/am/TaskRecord;

.field private final mFilename:Ljava/lang/String;

.field mFinishWithCoupledTask:Z
...
.field mParentCoupledTask:Lcom/android/server/am/TaskRecord;
...
.field mTmpDisplayVisibleObscuredArray:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;ILandroid/content/Intent;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Landroid/content/ComponentName;Landroid/content/ComponentName;ZZZIIILjava/lang/String;Ljava/util/ArrayList;JJJZLandroid/app/ActivityManager$TaskDescription;IIIIILjava/lang/String;Lcom/samsung/android/multiwindow/MultiWindowStyle;)V
    ...
    iput-object v2, p0, Lcom/android/server/am/TaskRecord;->mTmpDisplayVisibleObscuredArray:Landroid/util/SparseArray;
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Landroid/app/ActivityManager$TaskDescription;)V
    ...
    iput-boolean v4, p0, Lcom/android/server/am/TaskRecord;->mFinishWithCoupledTask:Z
    ...
    iput-object v0, p0, Lcom/android/server/am/TaskRecord;->mTmpDisplayVisibleObscuredArray:Landroid/util/SparseArray;
...
.method static restoreFromXml(Lorg/xmlpull/v1/XmlPullParser;Lcom/android/server/am/ActivityStackSupervisor;I)Lcom/android/server/am/TaskRecord;
    ...
    const-string v52, "TaskRecord: Unknown attribute="
    ...
    const-string/jumbo v52, "restoreTask: Unexpected name="
    ...
    const-string v52, "Updating task #"
...
.method getDisplayObscuredZone()I
    .locals 5
...
.method getDisplayVisibleObscuredZones(Z)Landroid/util/SparseArray;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z)",
    ...
    iget-object v5, p0, Lcom/android/server/am/TaskRecord;->mTmpDisplayVisibleObscuredArray:Landroid/util/SparseArray;
...
.method getObscuredDisplayIds(Lcom/android/server/am/ActivityRecord;)Ljava/util/ArrayList;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v5}, Lcom/android/server/am/ActivityStackSupervisor;->convertDisplayIdToObscuredZone(I)I
...
.method public getOppositeTask()Lcom/android/server/am/TaskRecord;
    .locals 2
...
.method public setOppositeTask(Lcom/android/server/am/TaskRecord;)V
    .locals 2
    ...
    iput-object v1, p0, Lcom/android/server/am/TaskRecord;->mParentCoupledTask:Lcom/android/server/am/TaskRecord;
    ...
    iput-object v1, p0, Lcom/android/server/am/TaskRecord;->mChildCoupledTask:Lcom/android/server/am/TaskRecord;
