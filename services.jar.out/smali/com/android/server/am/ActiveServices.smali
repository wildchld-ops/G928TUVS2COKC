...
# instance fields
.field UpdateServiceTransFlag:Z
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput-boolean v1, p0, Lcom/android/server/am/ActiveServices;->UpdateServiceTransFlag:Z
...
.method private final bringUpServiceLocked(Lcom/android/server/am/ServiceRecord;IZZ)Ljava/lang/String;
    ...
    invoke-virtual {v4, v15, v6}, Lcom/android/server/am/ActivityManagerService;->updateHotnessAdj(Lcom/android/server/am/ProcessRecord;I)V
...
.method private final realStartServiceLocked(Lcom/android/server/am/ServiceRecord;Lcom/android/server/am/ProcessRecord;Z)V
    ...
    invoke-virtual {v0, p2, v9, v10}, Lcom/android/server/am/ActivityManagerService;->updateLruProcessLocked(Lcom/android/server/am/ProcessRecord;ZLcom/android/server/am/ProcessRecord;)V
    ...
    iput-object v10, p1, Lcom/android/server/am/ServiceRecord;->app:Lcom/android/server/am/ProcessRecord;

    invoke-direct {p0, p1, v9}, Lcom/android/server/am/ActiveServices;->scheduleServiceRestartLocked(Lcom/android/server/am/ServiceRecord;Z)Z
    ...
    invoke-direct {p0, p2, v10, v11}, Lcom/android/server/am/ActiveServices;->updateServiceClientActivitiesLocked(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ConnectionRecord;Z)Z
    ...
    iput-boolean v9, p1, Lcom/android/server/am/ServiceRecord;->delayed:Z
    ...
    iput-boolean v9, p1, Lcom/android/server/am/ServiceRecord;->delayedStop:Z
...
.method bindServiceLocked(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/app/IServiceConnection;II)I
    ...
    invoke-virtual {v6, v7}, Lcom/android/server/am/ActivityManagerService;->getShortPackageName(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/android/server/am/ActivityManagerService;->isActivePackage(Landroid/content/ComponentName;Landroid/app/IApplicationThread;IILjava/lang/String;)Z
    ...
    const-string v5, "SPM+UI bind service blocked-- not in active list."
    ...
    iput-boolean v5, v4, Lcom/android/server/am/IntentBindRecord;->hasBoundbyOther:Z
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method getPackageServiceScore(Lcom/android/server/am/ActivityManagerService$PackageTable;[Landroid/content/pm/ServiceInfo;)I
    .locals 2
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lcom/android/server/am/ActiveServices;->getPackageServiceScore(Lcom/android/server/am/ActivityManagerService$PackageTable;[Landroid/content/pm/ServiceInfo;J)I
...
.method getPackageServiceScore(Lcom/android/server/am/ActivityManagerService$PackageTable;[Landroid/content/pm/ServiceInfo;J)I
    .locals 23
    ...
    iget-wide v4, v0, Lcom/android/server/am/ActivityManagerService$PackageTable;->lastServiceActivityTime:J
    ...
    iget-object v12, v10, Landroid/content/pm/ServiceInfo;->name:Ljava/lang/String;

    iget-object v7, v10, Landroid/content/pm/ServiceInfo;->packageName:Ljava/lang/String;

    iget-object v8, v10, Landroid/content/pm/ServiceInfo;->processName:Ljava/lang/String;
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/content/Context;->getUserId()I
    ...
    invoke-direct {v6, v7, v12}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, v13, Lcom/android/server/am/ActiveServices$ServiceMap;->mServicesByName:Landroid/util/ArrayMap;
    ...
    iget v14, v9, Lcom/android/server/am/ServiceRecord;->reducedTrans:I
...
.method public getPackageServiceTransactions(Lcom/android/server/am/ActivityManagerService$PackageTable;)I
    .locals 12

    iget-object v4, p1, Lcom/android/server/am/ActivityManagerService$PackageTable;->info:Landroid/content/pm/PackageInfo;
    ...
    const-string/jumbo v11, "updatePackageServicesTransationStatsLocked---package = "
    ...
    invoke-virtual {p0, v9}, Lcom/android/server/am/ActiveServices;->updatePackageServicesTransationStatsLocked([Landroid/content/pm/ServiceInfo;)V
    ...
    invoke-virtual {p0, v9}, Lcom/android/server/am/ActiveServices;->getServices(I)Landroid/util/ArrayMap;
    ...
    invoke-direct {v9, p0}, Lcom/android/server/am/ActiveServices$3;-><init>(Lcom/android/server/am/ActiveServices;)V
    ...
    iget v9, v6, Lcom/android/server/am/ServiceRecord;->transactions:I

    if-lez v9, :cond_2

    iput v1, v6, Lcom/android/server/am/ServiceRecord;->reducedTrans:I
    ...
    :cond_1
    iget v9, v6, Lcom/android/server/am/ServiceRecord;->reducedTrans:I
    ...
    const-string/jumbo v11, "getServiceTotalTransactions  package = "
    ...
    const-string v11, " and package\'s services is null !!! "
...
.method public getServiceTotalTransactions()I
    .locals 14
    ...
    iput-boolean v12, v10, Lcom/android/server/am/ServiceRecord;->updateServiceTrans:Z
    ...
    const-string/jumbo v13, "getServiceTotalTransactions---init all servicerecord updateServiceTrans = "
    ...
    iget-boolean v10, v10, Lcom/android/server/am/ServiceRecord;->updateServiceTrans:Z

    invoke-virtual {v13, v10}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v10

    const-string v13, " , and servicerecord name = "
    ...
    iget-object v10, v10, Lcom/android/server/am/ServiceRecord;->shortName:Ljava/lang/String;
    ...
    :goto_2
    iget-boolean v10, p0, Lcom/android/server/am/ActiveServices;->UpdateServiceTransFlag:Z
    ...
    const-string/jumbo v13, "getServiceTotalTransactions---UpdateServiceTransFlag = "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    iget-boolean v13, p0, Lcom/android/server/am/ActiveServices;->UpdateServiceTransFlag:Z

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v12

    const-string v13, " ,and go into updateServicesTransationStatsLocked"
    ...
    invoke-virtual {p0}, Lcom/android/server/am/ActiveServices;->updateServicesTransationStatsLocked()V
    ...
    iput-boolean v10, p0, Lcom/android/server/am/ActiveServices;->UpdateServiceTransFlag:Z
    ...
    invoke-direct {v10, p0}, Lcom/android/server/am/ActiveServices$2;-><init>(Lcom/android/server/am/ActiveServices;)V
    ...
    iget v10, v5, Lcom/android/server/am/ServiceRecord;->transactions:I

    if-lez v10, :cond_6

    iput v1, v5, Lcom/android/server/am/ServiceRecord;->reducedTrans:I
    ...
    :cond_5
    iget v10, v5, Lcom/android/server/am/ServiceRecord;->reducedTrans:I
...
.method publishServiceLocked(Lcom/android/server/am/ServiceRecord;Landroid/content/Intent;Landroid/os/IBinder;)V
    ...
    iput-boolean v10, v7, Lcom/android/server/am/IntentBindRecord;->hasBoundbyOther:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;III)Landroid/content/ComponentName;
    ...
    invoke-virtual/range {v0 .. v8}, Lcom/android/server/am/ActiveServices;->startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;IIILandroid/os/IBinder;I)Landroid/content/ComponentName;
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;IIILandroid/os/IBinder;I)Landroid/content/ComponentName;
    .locals 21
    ...
    iget-boolean v2, v2, Lcom/android/server/am/ActivityManagerService;->SPCM_ENABLE:Z
    ...
    sget-boolean v2, Lcom/android/server/am/ActivityManagerService;->DEBUG_SPCM:Z
    ...
    invoke-virtual {v4, v5}, Lcom/android/server/am/ActivityManagerService;->getShortPackageName(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v3, "SPM+UI start service blocked-- not in active list."
    ...
    iput-object v0, v13, Lcom/android/server/am/ServiceRecord;->callerActivityToken:Landroid/os/IBinder;

    move/from16 v0, p8

    iput v0, v13, Lcom/android/server/am/ServiceRecord;->displayId:I
...
.method final updatePackageServicesTransationStatsLocked([Landroid/content/pm/ServiceInfo;)V
    .locals 9
    ...
    iget-object v3, v5, Landroid/content/pm/ServiceInfo;->processName:Ljava/lang/String;
    ...
    invoke-direct {p0, v8}, Lcom/android/server/am/ActiveServices;->getServiceMap(I)Lcom/android/server/am/ActiveServices$ServiceMap;
    ...
    iget-object v8, v7, Lcom/android/server/am/ActiveServices$ServiceMap;->mServicesByName:Landroid/util/ArrayMap;
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/am/ActiveServices;->updateServiceTransationStats(Lcom/android/server/am/ServiceRecord;)V
...
.method final updateServiceTransationStats(Lcom/android/server/am/ServiceRecord;)V
    .locals 7
    ...
    iget-boolean v5, v0, Lcom/android/server/am/IntentBindRecord;->hasBoundbyOther:Z
    ...
    iget-object v5, v0, Lcom/android/server/am/IntentBindRecord;->binder:Landroid/os/IBinder;

    if-eqz v5, :cond_0

    :try_start_0
    iget-object v4, v0, Lcom/android/server/am/IntentBindRecord;->binder:Landroid/os/IBinder;
    ...
    iput v5, p1, Lcom/android/server/am/ServiceRecord;->transactions:I
    ...
    iget v6, p1, Lcom/android/server/am/ServiceRecord;->transactions:I

    iput v6, v5, Lcom/android/server/am/ProcessRecord;->transactions:I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method final updateServicesTransationStatsLocked()V
    .locals 7
    ...
    invoke-virtual {v4}, Lcom/android/server/am/ActivityManagerService;->getUsersLocked()[I
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/am/ActiveServices;->getServices(I)Landroid/util/ArrayMap;
    ...
    iget-boolean v4, v4, Lcom/android/server/am/ServiceRecord;->updateServiceTrans:Z
    ...
    iput-boolean v5, v4, Lcom/android/server/am/ServiceRecord;->updateServiceTrans:Z
    ...
    const-string/jumbo v6, "updateServiceTransationStats---the service record name =  "
    ...
    const-string v6, " , updateServiceTrans = "
    ...
    :cond_2
    iput-boolean v5, p0, Lcom/android/server/am/ActiveServices;->UpdateServiceTransFlag:Z
    ...
    const-string/jumbo v6, "updateServicesTransationStatsLocked---after finish for(), UpdateServiceTransFlag = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-boolean v6, p0, Lcom/android/server/am/ActiveServices;->UpdateServiceTransFlag:Z
