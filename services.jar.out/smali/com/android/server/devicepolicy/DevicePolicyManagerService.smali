...
.field private static final MONITORING_CERT_NOTIFICATION_ID:I = 0x10400f4
...
.method static synthetic access$1000(Lcom/android/server/devicepolicy/DevicePolicyManagerService;I)Z
    .locals 1
...
.method static synthetic access$1400(Lcom/android/server/devicepolicy/DevicePolicyManagerService;)Lcom/android/server/devicepolicy/DeviceOwner;
    .locals 1
...
.method static synthetic access$500(Lcom/android/server/devicepolicy/DevicePolicyManagerService;Ljava/lang/String;)Z
    .locals 1
...
.method static synthetic access$700(Lcom/android/server/devicepolicy/DevicePolicyManagerService;Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;)V
    .locals 0
...
.method static synthetic access$800(Lcom/android/server/devicepolicy/DevicePolicyManagerService;IZ)V
    .locals 0
...
.method static synthetic access$900(Lcom/android/server/devicepolicy/DevicePolicyManagerService;)Landroid/app/NotificationManager;
    .locals 1
...
.method private formatExternSdCard()V
    ...
    const-string/jumbo v6, "formatExternSdCard() called"
...
.method private handlePasswordExpirationNotification(I)V
    ...
    const-string v13, "edm.intent.action.internal.NOTIFICATION_PASSWORD_EXPIRED"
...
.method private isOpenThemePkg(Landroid/content/pm/IPackageManager;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-interface {p1, v0, p2}, Landroid/content/pm/IPackageManager;->checkPermission(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :cond_1
    invoke-interface {p1, v1, p2}, Landroid/content/pm/IPackageManager;->checkPermission(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private loadSettingsLocked(Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;I)Z
    ...
    :try_start_5
    const-string/jumbo v22, "permission-provider"
    ...
    const-string/jumbo v22, "setup-complete"
    ...
    invoke-virtual {v3, v11}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;->readFromXml(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    :cond_8
    :try_start_9
    const-string/jumbo v21, "failed-password-attempts"
    ...
    :cond_a
    :try_start_b
    const-string/jumbo v21, "password-owner"
    ...
    const-string/jumbo v22, "uppercase"
    ...
    const-string/jumbo v22, "lowercase"
    ...
    const-string/jumbo v22, "letters"
    ...
    const-string/jumbo v22, "symbols"
    ...
    const-string/jumbo v22, "nonletter"
    ...
    const-string/jumbo v22, "recoverable"
    ...
    const-string v21, "alternative-password"
    ...
    :cond_1f
    :try_start_10
    const-string/jumbo v21, "lock-task-component"
...
.method private setActiveAdmin(Landroid/content/ComponentName;ZILandroid/os/Bundle;)V
    ...
    check-cast v20, Lcom/android/server/enterprise/restriction/RestrictionPolicy;
    ...
    :cond_2
    :try_start_3
    new-instance v16, Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;

    move-object/from16 v0, v16

    invoke-direct {v0, v13}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;-><init>(Landroid/app/admin/DeviceAdminInfo;)V
    ...
    check-cast v17, Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;
...
.method private wipeDataLocked(ILjava/lang/String;)V
    .locals 10
...
.method private wipeDeviceOrUserLocked(IILjava/lang/String;Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;)V
    ...
    :cond_1
    invoke-direct {p0, p1, p3}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->wipeDataLocked(ILjava/lang/String;)V
...
.method public addCrossProfileWidgetProvider(Landroid/content/ComponentName;Ljava/lang/String;)Z
    ...
    invoke-static {v5, v4, v1}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$LocalService;->access$1100(Lcom/android/server/devicepolicy/DevicePolicyManagerService$LocalService;ILjava/util/List;)V
...
.method disableThirdPartyApps(ZI)V
    ...
    invoke-static {v12}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->access$1200(Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;)Ljava/util/HashSet;
...
.method enableAllBlockedListApps(I)V
    ...
    invoke-static {v8}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->access$1300(Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;)Ljava/util/HashSet;
...
.method public getPermittedInputMethodsForCurrentUser()Ljava/util/List;
    ...
    const-string/jumbo v27, "input_method"
...
.method handleAllowUnsignedApp(ZI)V
    ...
    # getter for: Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->mAllowListRecord:Ljava/util/HashSet;
    invoke-static {v13}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->access$1200(Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;)Ljava/util/HashSet;
...
.method initiateTempList(ILcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;)V
    ...
    # getter for: Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->mAllowListRecord:Ljava/util/HashSet;
    invoke-static {p2}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->access$1200(Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;)Ljava/util/HashSet;

    move-result-object v6

    # getter for: Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->mBlockListRecordInRom:Ljava/util/HashSet;
    invoke-static {p2}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->access$1300(Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;)Ljava/util/HashSet;
...
.method manageAllowThirdPartyApps(I)V
    ...
    # getter for: Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->mAllowListRecord:Ljava/util/HashSet;
    invoke-static {v11}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->access$1200(Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;)Ljava/util/HashSet;
...
.method manageBlockedApplications(I)V
    ...
    # getter for: Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->mBlockListRecordInRom:Ljava/util/HashSet;
    invoke-static {v12}, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->access$1300(Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;)Ljava/util/HashSet;
...
.method public recoverPassword(I)V
    ...
    invoke-direct {v4, v9}, Lcom/android/internal/widget/LockPatternUtils;-><init>(Landroid/content/Context;)V
    ...
    invoke-static {v9, v10}, Lcom/android/internal/widget/LockPatternUtils;->getProfiles(Landroid/content/Context;I)Ljava/util/List;
    ...
    invoke-virtual {v1, v7}, Landroid/security/KeyStore;->resetUid(I)Z
    ...
    const-string/jumbo v11, "resetPassword :resetUid "
    ...
    :try_start_3
    invoke-virtual {v4, v5, v9}, Lcom/android/internal/widget/LockPatternUtils;->saveLockPassword(Ljava/lang/String;I)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method public resetPassword(Ljava/lang/String;II)Z
    ...
    invoke-static/range {v27 .. v27}, Lcom/android/internal/widget/LockPatternUtils;->computePasswordQuality(Ljava/lang/String;)I
    ...
    const-string/jumbo v40, "resetPassword: current password quality is smartcard numeric and can\'t set reset password"
    ...
    check-cast v29, Landroid/os/PersonaManager;
    ...
    const-string/jumbo v40, "resetPassword: not supported for MDFPP sdp !!!"
    ...
    sget-object v40, Landroid/content/pm/PersonaAttribute;->PASSWORD_CHANGE_REQUEST:Landroid/content/pm/PersonaAttribute;

    const/16 v41, 0x0

    invoke-virtual/range {v39 .. v41}, Landroid/os/PersonaManager$StateManager;->setAttribute(Landroid/content/pm/PersonaAttribute;Z)Z
    ...
    sget-object v40, Landroid/content/pm/PersonaAttribute;->PASSWORD_CHANGE_REQUEST_ENFORCED:Landroid/content/pm/PersonaAttribute;
    ...
    invoke-static/range {v39 .. v40}, Landroid/os/UserHandle;->getUid(II)I
    ...
    const-string/jumbo v41, "resetPassword :resetUid "
    ...
    invoke-virtual/range {v38 .. v39}, Lcom/android/internal/widget/LockPatternUtils;->requireCredentialEntry(I)V
...
.method public setKeyguardDisabledFeatures(Landroid/content/ComponentName;II)V
    ...
    const-string v4, "It is KnoxWorkspace skip enforceNotManagedProfile: disable keyguard features"
...
.method public setPasswordExpirationTimeout(Landroid/content/ComponentName;JI)V
    ...
    invoke-virtual {p0, p1, v2, p4}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->getActiveAdminForCallerLocked(Landroid/content/ComponentName;II)Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;
    ...
    :goto_1
    iput-wide v8, v7, Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;->passwordExpirationDate:J

    iput-wide p2, v7, Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;->passwordExpirationTimeout:J
    ...
    const-string/jumbo v2, "setPasswordExpiration(): password will expire on "
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->setExpirationAlarmCheckLocked(Landroid/content/Context;Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;)V
    ...
    const-string v6, " has changed password expiration time out to "
...
.method public setPasswordQuality(Landroid/content/ComponentName;II)V
    ...
    invoke-virtual {v10}, Lcom/android/internal/widget/LockPatternUtils;->isCACCardRegistered()Z
...
.method public setStorageEncryption(Landroid/content/ComponentName;ZI)I
    ...
    const-string v2, "Only owner is allowed to set storage encryption. User "
    ...
    :cond_4
    iget-boolean v0, v8, Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;->encryptionRequested:Z

    if-eq v0, p2, :cond_5

    iput-boolean p2, v8, Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;->encryptionRequested:Z
    ...
    const-string v6, " has requested storage encryption."
    ...
    iget-boolean v0, v0, Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;->encryptionRequested:Z
    ...
    :cond_6
    invoke-direct {p0, v10}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->setEncryptionRequested(Z)V
...
.method public setTrustAgentConfiguration(Landroid/content/ComponentName;Landroid/content/ComponentName;Landroid/os/PersistableBundle;I)V
    ...
    const-string/jumbo v1, "set trust agent configuration"
...
.method public setUserRestriction(Landroid/content/ComponentName;Ljava/lang/String;Z)V
    ...
    const-string/jumbo v17, "no_unmute_microphone"
    ...
    const-string/jumbo v17, "no_adjust_volume"
    ...
    :try_start_4
    const-string/jumbo v17, "no_config_wifi"
    ...
    const-string/jumbo v20, "wifi_networks_available_notification_on"
    ...
    const-string/jumbo v12, "sys.settings_secure_version"

    const-string/jumbo v17, "sys.settings_secure_version"
    ...
    const-string/jumbo v11, "location_providers_allowed"

    sget-object v17, Landroid/provider/Settings$Secure;->CONTENT_URI:Landroid/net/Uri;

    const-string/jumbo v20, "location_providers_allowed"
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->sendChangedNotification(IZ)V
    ...
    :cond_9
    :try_start_a
    const-string/jumbo v17, "no_usb_file_transfer"
    ...
    const-string/jumbo v20, "package_verifier_enable"
    ...
    const-string/jumbo v20, "verifier_verify_adb_installs"
    ...
    :cond_d
    const-string/jumbo v17, "no_install_unknown_sources"
    ...
    const-string/jumbo v20, "install_non_market_apps"
...
.method public uninstallCaCert(Landroid/content/ComponentName;Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "from CaCertUninstaller: "
...
.method public wipeData(II)V
    ...
    :goto_1
    invoke-virtual {v2, v11, v12, v8}, Lcom/samsung/android/sagearpolicymanager/SAGearPolicyManager;->SetBooleanTypePolicy(Ljava/lang/String;Ljava/lang/String;Z)I

    const-string v8, "DevicePolicyManagerService"

    const-string v11, "SetBooleanTypePolicy wipeDevice"
    ...
    :try_start_0
    invoke-virtual {p0, v8, v11}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->getActiveAdminForCallerLocked(Landroid/content/ComponentName;I)Lcom/android/server/devicepolicy/DevicePolicyManagerService$ActiveAdmin;
