...
.field private static final TAG:Ljava/lang/String; = "ClipboardServiceEx"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v4, p0, Lcom/android/server/clipboardex/ClipboardExService;->KNOX_FOR_EXIST_COPY:Z
    ...
    iput-object v3, p0, Lcom/android/server/clipboardex/ClipboardExService;->mClipboardWorkingFormUiInterface:Landroid/sec/clipboard/IClipboardWorkingFormUiInterface;

    iput-object v3, p0, Lcom/android/server/clipboardex/ClipboardExService;->mScrapWorkingFormUiInterface:Landroid/sec/clipboard/IClipboardWorkingFormUiInterface;
    ...
    iput v4, p0, Lcom/android/server/clipboardex/ClipboardExService;->mContainerID:I
...
.method static synthetic access$1000(Lcom/android/server/clipboardex/ClipboardExService;)Z
    .locals 1
...
.method static synthetic access$1100(Lcom/android/server/clipboardex/ClipboardExService;)Landroid/content/Context;
    .locals 1
...
.method static synthetic access$1200(Lcom/android/server/clipboardex/ClipboardExService;ILandroid/sec/clipboard/data/ClipboardData;)Landroid/sec/clipboard/data/ClipboardData;
    .locals 1
...
.method static synthetic access$1300(Lcom/android/server/clipboardex/ClipboardExService;)Landroid/sec/clipboard/ClipboardUIManager;
    .locals 1
...
.method static synthetic access$1302(Lcom/android/server/clipboardex/ClipboardExService;Landroid/sec/clipboard/ClipboardUIManager;)Landroid/sec/clipboard/ClipboardUIManager;
    .locals 0
...
.method static synthetic access$1500(Lcom/android/server/clipboardex/ClipboardExService;)Landroid/sec/clipboard/IClipboardDataPasteEvent;
    .locals 1
...
.method static synthetic access$702(Lcom/android/server/clipboardex/ClipboardExService;Z)Z
    .locals 0
...
.method static synthetic access$900(Lcom/android/server/clipboardex/ClipboardExService;)Landroid/sec/clipboard/data/ClipboardDataMgr;
    .locals 1
...
.method private checkEquals(Landroid/sec/clipboard/data/ClipboardData;)Z
    ...
    const-string/jumbo v12, "isKnoxTwoEnabled getPersonaId "
...
.method public GetClipboardData(I)Landroid/sec/clipboard/data/ClipboardData;
    ...
    const-string/jumbo v7, "getItem id : "
    ...
    const-string v7, "GetClipboardData() mSharedclipMgr : "
    ...
    const-string v7, "GetClipboardData() mDataList : "
    ...
    const-string v7, "GetClipboardData() nothing : "
...
.method public SetClipboardData(ILandroid/sec/clipboard/data/ClipboardData;Ljava/lang/String;)Z
    ...
    const-string/jumbo v6, "not enabled! SetClipboardData()"
    ...
    const-string/jumbo v6, "in synchronized"
...
.method public getPersonaId()I
    ...
    iput-object v1, p0, Lcom/android/server/clipboardex/ClipboardExService;->mPersonaManager:Landroid/os/PersonaManager;
...
.method isKnoxTwoEnabled()Z
    ...
    const-string/jumbo v8, "isKnoxTwoEnabled getPersonaId "
    ...
    const-string v7, "Current user is BBC, hence return false"
...
.method public iscalledPasteMenuFromApp()Z
    ...
    const-string/jumbo v2, "iscalledPasteMenuFromApp() in service. mIsCalledPasteApp :"
...
.method public setData(ILandroid/sec/clipboard/data/ClipboardData;Z)Z
    ...
    const-string v5, "disallow cross profile copy & paste!"
    ...
    invoke-direct {v3, p0, p2, p1}, Lcom/android/server/clipboardex/ClipboardExService$3;-><init>(Lcom/android/server/clipboardex/ClipboardExService;Landroid/sec/clipboard/data/ClipboardData;I)V
...
.method public updateScrapData(Landroid/sec/clipboard/data/ClipboardData;)V
    .locals 4

    move-object v1, p1

    check-cast v1, Landroid/sec/clipboard/data/list/ClipboardDataSmartClip;
    ...
    const-string/jumbo v3, "updateScrapData : ScrapData is Null"
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/server/clipboardex/ClipboardExService;->mScrapDataList:Landroid/sec/clipboard/data/ClipboardDataMgr;

    invoke-virtual {v2}, Landroid/sec/clipboard/data/ClipboardDataMgr;->getLastScrapDataIndex()I

    move-result v0

    iget-object v2, p0, Lcom/android/server/clipboardex/ClipboardExService;->mScrapDataList:Landroid/sec/clipboard/data/ClipboardDataMgr;

    invoke-virtual {v2, v0, v1}, Landroid/sec/clipboard/data/ClipboardDataMgr;->updateData(ILandroid/sec/clipboard/data/ClipboardData;)Z
