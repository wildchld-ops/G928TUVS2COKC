...
.method static synthetic access$2500(Lcom/android/server/InputMethodManagerService;I)V
    .locals 0
...
.method static synthetic access$2600(Lcom/android/server/InputMethodManagerService;)V
    .locals 0
...
.method static synthetic access$3100(Lcom/android/server/InputMethodManagerService;)V
    .locals 0
...
.method static synthetic access$3206()I
    .locals 1
...
.method static synthetic access$3306()I
    .locals 1
...
.method static synthetic access$3400(Lcom/android/server/InputMethodManagerService;)Ljava/lang/String;
    .locals 1
...
.method static synthetic access$3402(Lcom/android/server/InputMethodManagerService;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method private refreshImeWindowVisibilityLocked()V
    ...
    iget-boolean v11, p0, Lcom/android/server/InputMethodManagerService;->mIsFolderModel:Z
    ...
    const-string/jumbo v10, "haveHardKeyboard = "
...
.method private showInputMethodMenuInternal(Z)V
    ...
    :cond_2
    const-string v32, "InputMethodManagerService"

    new-instance v34, Ljava/lang/StringBuilder;

    invoke-direct/range {v34 .. v34}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v35, "showInputMethodMenuInternal : mSecureKeypadEnabled: "
    ...
    check-cast v22, Lcom/android/internal/inputmethod/InputMethodSubtypeSwitchingController$ImeSubtypeListItem;
    ...
    invoke-virtual/range {v32 .. v32}, Landroid/view/inputmethod/InputMethodInfo;->getPackageName()Ljava/lang/String;

    move-result-object v32

    aput-object v32, v27, v16

    aget-object v32, v27, v16

    const-string v34, "com.sec.android.inputmethod"
    ...
    const-string v34, "com.google.android.googlequicksearchbox"
    ...
    const-string v35, "IMMS: showInputMethodMenuInternal() -checkitem : "
    ...
    const-string v35, "IMMS: showInputMethodMenuInternal() checkedItem==i -checkitem : "
    ...
    sget-object v34, Lcom/android/internal/R$styleable;->DialogPreference:[I
    ...
    const-string v35, "CscFeature_Sip_DisplayOnScreenKeyboardMenu"
    ...
    invoke-virtual/range {v32 .. v32}, Lcom/android/internal/inputmethod/InputMethodUtils$InputMethodSettings;->isShowImeWithHardKeyboardEnabled()Z
    ...
    new-instance v28, Lcom/android/server/InputMethodManagerService$10;
    ...
    invoke-virtual/range {v32 .. v32}, Landroid/app/AlertDialog;->getWindow()Landroid/view/Window;
    ...
    const-string v34, "Select input method"
    ...
    const-string v35, "ACTION_SWITCHING_DIALOG_SHOWN"
...
.method private switchUserLocked(I)V
    ...
    const-string/jumbo v5, "switchUserLocked: Switch user: "
    ...
    invoke-static {v3, v4}, Lcom/android/internal/inputmethod/InputMethodUtils;->setNonSelectedSystemImesDisabledUntilUsed(Landroid/content/pm/PackageManager;Ljava/util/List;)V
...
.method public changeFullInputMethod(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wm/WindowManagerService;->changeFullInputMethodLocked(Z)V
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    :goto_a
    invoke-direct {p0, v9}, Lcom/android/server/InputMethodManagerService;->setSpellCheckerEnabled(Z)V
    ...
    :cond_7
    invoke-virtual {v9, v10}, Lcom/android/server/InputMethodManagerService$HardKeyboardListener;->handleHardKeyboardStatusChange(Z)V
...
.method hideCurrentInputLocked(ILandroid/os/ResultReceiver;)Z
    ...
    invoke-virtual {v4, v3}, Lcom/android/server/InputMethodManagerService$KeyboardDetect;->setKeyboardState(I)V
    ...
    invoke-interface {v4, v5}, Landroid/view/IWindowManager;->setCurrentInputMethodClient(Landroid/os/IBinder;)V
    :try_end_1
    ...
    invoke-virtual {v4, v3, v5}, Lcom/android/server/wm/WindowManagerService;->moveInputMethodWindowsToDisplayIfNeededLocked(ZZ)V
...
.method registerSamsungAdditionalReceviers()V
    ...
    const-string v9, "android.permission.MANAGE_USB"

    invoke-virtual {v7, v8, v5, v9, v11}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    const-string v9, "com.sec.android.permission.SIDESYNC_RECEIVER_PERMISSION"

    invoke-virtual {v7, v8, v3, v9, v11}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    invoke-virtual {v7, v8, v2, v9, v11}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    iget-object v9, p0, Lcom/android/server/InputMethodManagerService;->mUniversalSwitchChangeObserver:Lcom/android/server/InputMethodManagerService$SwitchControlChangeObserver;
    ...
    iget-object v9, p0, Lcom/android/server/InputMethodManagerService;->mMobileKeyboardChangeObserver:Lcom/android/server/InputMethodManagerService$MobileKeyboardChangeObserver;
    ...
    iget-object v9, p0, Lcom/android/server/InputMethodManagerService;->mAccessControlEnableChangeObserver:Lcom/android/server/InputMethodManagerService$AccessControlEnableChangeObserver;
    ...
    iget-object v9, p0, Lcom/android/server/InputMethodManagerService;->mAccessControlKeyboardEnableChangeObserver:Lcom/android/server/InputMethodManagerService$AccessControlKeyboardEnableChangeObserver;
...
.method setInputMethodLocked(Ljava/lang/String;I)V
    ...
    iget-boolean v12, v0, Lcom/android/server/InputMethodManagerService;->mShowRequested:Z
    ...
    iput-boolean v12, v0, Lcom/android/server/InputMethodManagerService;->mNeedToExplicitallyCall:Z
    ...
    iget-object v12, v0, Lcom/android/server/InputMethodManagerService;->mCurClient:Lcom/android/server/InputMethodManagerService$ClientState;
    ...
    iget v11, v12, Lcom/android/server/InputMethodManagerService$ClientState;->uid:I

    move-object/from16 v0, p0

    iget-object v12, v0, Lcom/android/server/InputMethodManagerService;->mCurAttribute:Landroid/view/inputmethod/EditorInfo;

    iget-object v9, v12, Landroid/view/inputmethod/EditorInfo;->packageName:Ljava/lang/String;

    invoke-static {}, Lcom/android/server/SystemConfig;->getInstance()Lcom/android/server/SystemConfig;

    move-result-object v12

    invoke-virtual {v12}, Lcom/android/server/SystemConfig;->getFixedImeApps()Landroid/util/ArraySet;
    ...
    iget-object v12, v0, Lcom/android/server/InputMethodManagerService;->mAppOpsManager:Landroid/app/AppOpsManager;

    invoke-static {v12, v11, v9}, Lcom/android/internal/inputmethod/InputMethodUtils;->checkIfPackageBelongsToUid(Landroid/app/AppOpsManager;ILjava/lang/String;)Z
    ...
    const-string v14, "Ignoring FixedImeApps due to the validation failure. uid="
    ...
    const-string v14, "Illegal subtype state: old subtype = "
    ...
    invoke-direct {v0, v3, v1, v12}, Lcom/android/server/InputMethodManagerService;->setSelectedInputMethodAndSubtypeLocked(Landroid/view/inputmethod/InputMethodInfo;IZ)V

    move-object/from16 v0, p0

    iget-object v12, v0, Lcom/android/server/InputMethodManagerService;->mCurMethod:Lcom/android/internal/view/IInputMethod;
    ...
    invoke-interface {v12, v7}, Lcom/android/internal/view/IInputMethod;->changeInputMethodSubtype(Landroid/view/inputmethod/InputMethodSubtype;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v13, "Failed to call changeInputMethodSubtype"
    ...
    const-string/jumbo v12, "input_method_id"
    ...
    const-string v12, "com.samsung.inputmethod/.SamsungIME"
    ...
    iget-object v13, v0, Lcom/android/server/InputMethodManagerService;->mCaller:Lcom/android/internal/os/HandlerCaller;
    ...
    invoke-virtual/range {v13 .. v16}, Lcom/android/internal/os/HandlerCaller;->obtainMessageIO(IILjava/lang/Object;)Landroid/os/Message;

    move-result-object v13

    move-object/from16 v0, p0

    invoke-virtual {v0, v12, v13}, Lcom/android/server/InputMethodManagerService;->executeOrSendMessage(Landroid/os/IInterface;Landroid/os/Message;)V
