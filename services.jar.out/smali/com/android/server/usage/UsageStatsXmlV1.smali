...
.method private static loadPpmStats(Lorg/xmlpull/v1/XmlPullParser;Lcom/android/server/usage/IntervalStats;)V
    ...
    const-string/jumbo v9, "no package attribute present"
    ...
    :cond_0
    invoke-virtual {p1, v5}, Lcom/android/server/usage/IntervalStats;->getOrCreatePpmUsageStats(Ljava/lang/String;)Landroid/app/usage/UsageStats;
    ...
    iput-object v1, v6, Landroid/app/usage/UsageStats;->mPackageName:Ljava/lang/String;
    ...
    iput-wide v8, v6, Landroid/app/usage/UsageStats;->mLaunchCount:J

    goto :goto_3

    :cond_5
    const-string/jumbo v8, "timeActive"
    ...
    iput-wide v8, v6, Landroid/app/usage/UsageStats;->mTotalTimeInForeground:J
    ...
    iput-wide v8, v6, Landroid/app/usage/UsageStats;->mLastTimePaused:J
    ...
    iput-object v1, v6, Landroid/app/usage/UsageStats;->mScoreListString:Ljava/lang/String;
...
.method private static writePpmInfo(Lorg/xmlpull/v1/XmlSerializer;Lcom/android/server/usage/IntervalStats;Landroid/app/usage/UsageStats;)V
    ...
    iget-wide v2, p2, Landroid/app/usage/UsageStats;->mLaunchCount:J
    ...
    iget-wide v2, p2, Landroid/app/usage/UsageStats;->mLastTimePaused:J

    invoke-static {p0, v0, v2, v3}, Lcom/android/internal/util/XmlUtils;->writeLongAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;J)V

    const-string/jumbo v0, "score"

    iget-object v1, p2, Landroid/app/usage/UsageStats;->mScoreListString:Ljava/lang/String;
