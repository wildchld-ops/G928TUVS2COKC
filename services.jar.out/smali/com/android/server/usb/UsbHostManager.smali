...
.method private beginUsbDeviceAdded(Ljava/lang/String;IIIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v4, "+ device :: %s [%04xh:%04xh] [%02xh,%02xh,%02xh] %s (%s/%s/%s)"
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;)V
    ...
    iget-object v14, v0, Lcom/android/server/usb/UsbHostManager;->mLock:Ljava/lang/Object;

    monitor-enter v14

    :try_start_0
    const-string v13, "  USB Host State:"
    ...
    iget-object v13, v0, Lcom/android/server/usb/UsbHostManager;->mDevices:Ljava/util/HashMap;
    ...
    sget-object v15, Lcom/android/server/usb/UsbHostManager;->mStringConverter:Lcom/android/server/usb/UsbStringTable;
    ...
    invoke-virtual {v13}, Landroid/hardware/usb/UsbDevice;->getDeviceClass()I
    ...
    invoke-virtual {v13}, Landroid/hardware/usb/UsbDevice;->getDeviceSubclass()I
    ...
    invoke-virtual {v13}, Landroid/hardware/usb/UsbDevice;->getDeviceProtocol()I
    ...
    invoke-virtual {v15, v0, v1, v13}, Lcom/android/server/usb/UsbStringTable;->findString(III)Ljava/lang/String;
    ...
    invoke-direct {v10, v8, v13}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    const-string v13, "  USB Host black list:"
    ...
    iget-object v13, v0, Lcom/android/server/usb/UsbHostManager;->mUsbAudioManager:Lcom/android/server/usb/UsbAudioManager;

    move-object/from16 v0, p1

    move-object/from16 v1, p2

    invoke-virtual {v13, v0, v1}, Lcom/android/server/usb/UsbAudioManager;->dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;)V
