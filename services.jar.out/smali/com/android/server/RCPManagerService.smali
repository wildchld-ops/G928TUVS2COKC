...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v10, p0, Lcom/android/server/RCPManagerService;->mBridgeProviderUserMap:Ljava/util/HashMap;

    new-instance v10, Ljava/util/HashMap;

    invoke-direct {v10}, Ljava/util/HashMap;-><init>()V

    iput-object v10, p0, Lcom/android/server/RCPManagerService;->mBridgeSyncUserMap:Ljava/util/HashMap;

    new-instance v10, Ljava/util/HashMap;

    invoke-direct {v10}, Ljava/util/HashMap;-><init>()V

    iput-object v10, p0, Lcom/android/server/RCPManagerService;->mRCPGlobalContactsDirMap:Ljava/util/HashMap;

    new-instance v10, Ljava/util/HashMap;

    invoke-direct {v10}, Ljava/util/HashMap;-><init>()V

    iput-object v10, p0, Lcom/android/server/RCPManagerService;->mBridgeCommandExeUserMap:Ljava/util/HashMap;

    new-instance v10, Ljava/util/HashMap;

    invoke-direct {v10}, Ljava/util/HashMap;-><init>()V

    iput-object v10, p0, Lcom/android/server/RCPManagerService;->mRCPInterfaceMap:Ljava/util/HashMap;

    new-instance v10, Ljava/util/ArrayList;

    invoke-direct {v10}, Ljava/util/ArrayList;-><init>()V

    iput-object v10, p0, Lcom/android/server/RCPManagerService;->mRCPProxyAliveList:Ljava/util/List;
    ...
    iput v10, p0, Lcom/android/server/RCPManagerService;->currentUserId:I

    new-instance v10, Ljava/util/HashMap;

    invoke-direct {v10}, Ljava/util/HashMap;-><init>()V

    iput-object v10, p0, Lcom/android/server/RCPManagerService;->mCommandQueue:Ljava/util/Map;

    new-instance v10, Lcom/android/server/RCPManagerService$1;

    invoke-direct {v10, p0}, Lcom/android/server/RCPManagerService$1;-><init>(Lcom/android/server/RCPManagerService;)V

    iput-object v10, p0, Lcom/android/server/RCPManagerService;->mBtReceiver:Landroid/content/BroadcastReceiver;

    new-instance v10, Ljava/util/ArrayList;

    invoke-direct {v10}, Ljava/util/ArrayList;-><init>()V

    iput-object v10, p0, Lcom/android/server/RCPManagerService;->mExchangeDataInfos:Ljava/util/List;
    ...
    const-string v11, "RCPManagerService() registering receiver for package added and user switch"
    ...
    new-instance v10, Lcom/android/server/RCPManagerService$PackageReceiver;

    invoke-direct {v10, p0}, Lcom/android/server/RCPManagerService$PackageReceiver;-><init>(Lcom/android/server/RCPManagerService;)V

    iput-object v10, p0, Lcom/android/server/RCPManagerService;->receiver:Lcom/android/server/RCPManagerService$PackageReceiver;

    iget-object v10, p0, Lcom/android/server/RCPManagerService;->receiver:Lcom/android/server/RCPManagerService$PackageReceiver;
    ...
    new-instance v11, Lcom/android/server/RCPManagerService$BootReceiver;

    invoke-direct {v11, p0}, Lcom/android/server/RCPManagerService$BootReceiver;-><init>(Lcom/android/server/RCPManagerService;)V
    ...
    const-string v10, "com.samsung.knox.clipboard.clipremoved"

    invoke-virtual {v3, v10}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string v10, "com.samsung.knox.clipboard.clipscleared"

    invoke-virtual {v3, v10}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    new-instance v10, Lcom/android/server/RCPManagerService$ClipboardReceiver;

    invoke-direct {v10, p0}, Lcom/android/server/RCPManagerService$ClipboardReceiver;-><init>(Lcom/android/server/RCPManagerService;)V
    ...
    const-string v10, "com.samsung.knox.fmc_incoming_call"

    invoke-virtual {v5, v10}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    new-instance v10, Lcom/android/server/RCPManagerService$ModeSwitcherReceiver;

    const/4 v11, 0x0

    invoke-direct {v10, p0, v11}, Lcom/android/server/RCPManagerService$ModeSwitcherReceiver;-><init>(Lcom/android/server/RCPManagerService;Lcom/android/server/RCPManagerService$1;)V

    iput-object v10, p0, Lcom/android/server/RCPManagerService;->modeSwitchReceiver:Lcom/android/server/RCPManagerService$ModeSwitcherReceiver;

    iget-object v10, p0, Lcom/android/server/RCPManagerService;->modeSwitchReceiver:Lcom/android/server/RCPManagerService$ModeSwitcherReceiver;
    ...
    const-string v10, "com.samsung.android.plugin.ACTION_PLUGIN_CHANGE_NOTI"

    invoke-direct {v0, v10}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    iget-object v10, p0, Lcom/android/server/RCPManagerService;->mBtReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {p1, v10, v0}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    new-instance v10, Lcom/android/server/RCPManagerService$EmergencyModeReceiver;

    invoke-direct {v10, p0}, Lcom/android/server/RCPManagerService$EmergencyModeReceiver;-><init>(Lcom/android/server/RCPManagerService;)V

    iput-object v10, p0, Lcom/android/server/RCPManagerService;->mEmergencyModeReceiver:Lcom/android/server/RCPManagerService$EmergencyModeReceiver;

    iget-object v10, p0, Lcom/android/server/RCPManagerService;->mEmergencyModeReceiver:Lcom/android/server/RCPManagerService$EmergencyModeReceiver;
    ...
    const-string v11, " registered the receiver "
    ...
    new-instance v11, Lcom/android/server/RCPManagerService$2;

    invoke-direct {v11, p0}, Lcom/android/server/RCPManagerService$2;-><init>(Lcom/android/server/RCPManagerService;)V

    invoke-interface {v10, v11}, Landroid/app/IActivityManager;->registerUserSwitchObserver(Landroid/app/IUserSwitchObserver;)V
    :try_end_0
    ...
    :try_start_1
    new-instance v10, Lcom/android/server/RCPManagerService$3;

    invoke-direct {v10, p0}, Lcom/android/server/RCPManagerService$3;-><init>(Lcom/android/server/RCPManagerService;)V

    invoke-virtual {v7, v10}, Landroid/os/PersonaManager;->registerSystemPersonaObserver(Landroid/content/pm/ISystemPersonaObserver;)Z
    :try_end_1
    ...
    invoke-virtual {v7, v10}, Landroid/os/PersonaManager;->getPersonas(Z)Ljava/util/List;
    ...
    iget-boolean v10, v9, Landroid/content/pm/PersonaInfo;->partial:Z

    const/4 v11, 0x1

    if-eq v10, v11, :cond_0

    iget-boolean v10, v9, Landroid/content/pm/PersonaInfo;->removePersona:Z

    const/4 v11, 0x1

    if-eq v10, v11, :cond_0

    iget-boolean v10, v9, Landroid/content/pm/PersonaInfo;->resetPersonaOnReboot:Z
    ...
    const-string/jumbo v11, "kiosk_enabled"
    ...
    const-string v11, " Error registering with Persona service via registerSystemPersonaObserver"
...
.method static synthetic access$1000(Lcom/android/server/RCPManagerService;I)[I
    .locals 1
...
.method static synthetic access$1100()Ljava/lang/Integer;
    .locals 1
...
.method static synthetic access$1200(Lcom/android/server/RCPManagerService;)Landroid/content/SharedPreferences;
    .locals 1
...
.method static synthetic access$1202(Lcom/android/server/RCPManagerService;Landroid/content/SharedPreferences;)Landroid/content/SharedPreferences;
    .locals 0
...
.method static synthetic access$1300(Lcom/android/server/RCPManagerService;)[I
    .locals 1
...
.method static synthetic access$1400(Lcom/android/server/RCPManagerService;)Ljava/util/List;
    .locals 1
...
.method static synthetic access$700(Lcom/android/server/RCPManagerService;)V
    .locals 0
...
.method static synthetic access$800(Lcom/android/server/RCPManagerService;)Z
    .locals 1
...
.method public copyClipboardFile(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    const-string/jumbo v9, "failed to copy from "
...
.method public getUsersToSyncFrom(Ljava/lang/String;)[I
    ...
    const-string/jumbo v10, "getUsersToSyncFrom"
    ...
    const-string/jumbo v12, "getUsersToSyncFrom() for providerName = "
    ...
    const-string/jumbo v11, "getUsersToSyncFrom() - personaList was null, or empty"
    ...
    const-string/jumbo v12, "getUsersToSyncFrom: perosnalist.length = "
    ...
    const-string/jumbo v11, "getUsersToSyncFrom() - Current user is USER/OWNER, hence disabling syncing for it"
