...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, v5}, Lcom/android/server/cocktailbar/CocktailBarManagerServiceContainer;->createCocktailBarManagerServiceImpl(I)V
...
.method private bootCompleted()V
    ...
    invoke-virtual {v3}, Lcom/android/server/cocktailbar/CocktailBarManagerServiceImpl;->initialize()V
    ...
    const-string v5, "Incorrect user handle supplied in "
...
.method private createCocktailBarManagerServiceImpl(I)V
    ...
    invoke-direct {v0, v1, v2, v3, p1}, Lcom/android/server/cocktailbar/CocktailBarManagerServiceImpl;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/cocktailbar/mode/CocktailBarModeManager;I)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/cocktailbar/CocktailBarManagerServiceImpl;->setCocktailHostCallbacks(Lcom/samsung/android/cocktailbar/ICocktailHost;Ljava/lang/String;)V
...
.method private ensureGroupStateLoaded(I)V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/cocktailbar/CocktailBarManagerServiceContainer;->createCocktailBarManagerServiceImpl(I)V
...
.method private getImplForUser(I)Lcom/android/server/cocktailbar/CocktailBarManagerServiceImpl;
    ...
    iget-object v5, p0, Lcom/android/server/cocktailbar/CocktailBarManagerServiceContainer;->mModeManager:Lcom/android/server/cocktailbar/mode/CocktailBarModeManager;
...
.method public getCocktaiBarVisibilityIfChangeLock(IZ)I
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/cocktailbar/policy/state/CocktailBarStatePolicyController;->getCocktaiBarVisibilityIfChangeLock(IZ)I
...
.method public getEnabledCocktailIds()[I
    ...
    invoke-virtual {v6, v3}, Lcom/android/server/cocktailbar/CocktailBarManagerServiceImpl;->getEnabledCocktailIds(Ljava/util/ArrayList;)V
...
.method public startListening(Lcom/samsung/android/cocktailbar/ICocktailHost;Ljava/lang/String;Ljava/util/List;)[I
    ...
    iput-object v6, p0, Lcom/android/server/cocktailbar/CocktailBarManagerServiceContainer;->mHost:Landroid/util/Pair;
    ...
    invoke-virtual {v6, p1, p2, v4, p3}, Lcom/android/server/cocktailbar/CocktailBarManagerServiceImpl;->startListening(Lcom/samsung/android/cocktailbar/ICocktailHost;Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
...
.method public systemRunning(Z)V
    ...
    new-instance v0, Lcom/android/server/cocktailbar/settings/CocktailBarSettingObserver;

    iget-object v1, p0, Lcom/android/server/cocktailbar/CocktailBarManagerServiceContainer;->mContext:Landroid/content/Context;

    iget-object v2, p0, Lcom/android/server/cocktailbar/CocktailBarManagerServiceContainer;->mCocktailBarHandler:Landroid/os/Handler;

    invoke-direct {v0, v1, v2}, Lcom/android/server/cocktailbar/settings/CocktailBarSettingObserver;-><init>(Landroid/content/Context;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/server/cocktailbar/CocktailBarManagerServiceContainer;->mCocktailBarSettingObserver:Lcom/android/server/cocktailbar/settings/CocktailBarSettingObserver;

    iget-object v0, p0, Lcom/android/server/cocktailbar/CocktailBarManagerServiceContainer;->mCocktailBarSettingObserver:Lcom/android/server/cocktailbar/settings/CocktailBarSettingObserver;

    invoke-virtual {v0}, Lcom/android/server/cocktailbar/settings/CocktailBarSettingObserver;->observe()V
