...
.method public setStorageCardEncryptionPolicy(III)I
    ...
    invoke-direct {v12, v0, v1, v2}, Landroid/dirEncryption/SDCardEncryptionPolicies;-><init>(III)V
    ...
    invoke-virtual {v11, v4}, Landroid/app/admin/DevicePolicyManager;->getRequireStorageCardEncryption(Landroid/content/ComponentName;)Z
    ...
    iput v4, v12, Landroid/dirEncryption/SDCardEncryptionPolicies;->mEnc:I

    const/4 v4, 0x4

    iput v4, v12, Landroid/dirEncryption/SDCardEncryptionPolicies;->mFullEnc:I

    :cond_8
    invoke-virtual {v13, v12}, Landroid/dirEncryption/SDCardEncryptionPolicies;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {v0, v15}, Lcom/android/server/DirEncryptService;->authByUid(I)Z
    ...
    invoke-virtual {v4, v12}, Lcom/android/server/DirEncryptPrefs;->savePrefs(Landroid/dirEncryption/SDCardEncryptionPolicies;)Z
    ...
    :cond_b
    iget v4, v12, Landroid/dirEncryption/SDCardEncryptionPolicies;->mEnc:I
    ...
    invoke-direct {v0, v1}, Lcom/android/server/DirEncryptService;->getCallingProcessPkg(I)Ljava/lang/String;

    move-result-object v10

    if-eqz v10, :cond_e

    const-string v4, "com.odetest.js.gm"
