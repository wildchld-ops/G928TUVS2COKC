...
.method static synthetic access$100(Lcom/android/server/SdpServiceKeeper$SdpPolicyDatabase;Lcom/sec/sdp/engine/SdpEngineInfo;Lcom/android/server/sdp/engine/SdpPolicy;)I
    .locals 1

    invoke-direct {p0, p1, p2}, Lcom/android/server/SdpServiceKeeper$SdpPolicyDatabase;->putPolicyLocked(Lcom/sec/sdp/engine/SdpEngineInfo;Lcom/android/server/sdp/engine/SdpPolicy;)I
...
.method static synthetic access$200(Lcom/android/server/SdpServiceKeeper$SdpPolicyDatabase;Lcom/sec/sdp/engine/SdpEngineInfo;)Lcom/android/server/sdp/engine/SdpPolicy;
    .locals 1

    invoke-direct {p0, p1}, Lcom/android/server/SdpServiceKeeper$SdpPolicyDatabase;->getPolicyLocked(Lcom/sec/sdp/engine/SdpEngineInfo;)Lcom/android/server/sdp/engine/SdpPolicy;
...
.method static synthetic access$300(Lcom/android/server/SdpServiceKeeper$SdpPolicyDatabase;Lcom/sec/sdp/engine/SdpEngineInfo;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/server/SdpServiceKeeper$SdpPolicyDatabase;->removePolicyLocked(Lcom/sec/sdp/engine/SdpEngineInfo;)V
...
.method private generateSalt(Lcom/sec/sdp/engine/SdpEngineInfo;)[B
    .locals 2
...
.method private getPolicyLocked(Lcom/sec/sdp/engine/SdpEngineInfo;)Lcom/android/server/sdp/engine/SdpPolicy;
    .locals 9
    ...
    invoke-direct {v2, p0, p1}, Lcom/android/server/SdpServiceKeeper$SdpPolicyDatabase$PolicyXmlHandler;-><init>(Lcom/android/server/SdpServiceKeeper$SdpPolicyDatabase;Lcom/sec/sdp/engine/SdpEngineInfo;)V

    const/4 v1, 0x0

    invoke-direct {p0, p1}, Lcom/android/server/SdpServiceKeeper$SdpPolicyDatabase;->loadHashFromTima(Lcom/sec/sdp/engine/SdpEngineInfo;)[B

    move-result-object v4

    :try_start_0
    invoke-direct {p0, p1}, Lcom/android/server/SdpServiceKeeper$SdpPolicyDatabase;->getPolicyXmlFile(Lcom/sec/sdp/engine/SdpEngineInfo;)Ljava/io/File;
    :try_end_0
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcom/android/server/SdpServiceKeeper$SdpPolicyDatabase;->generateSalt(Lcom/sec/sdp/engine/SdpEngineInfo;)[B
...
.method private getPolicyXmlFile(Lcom/sec/sdp/engine/SdpEngineInfo;)Ljava/io/File;
    .locals 3
...
.method private loadHashFromTima(Lcom/sec/sdp/engine/SdpEngineInfo;)[B
    .locals 6
...
.method private putPolicyLocked(Lcom/sec/sdp/engine/SdpEngineInfo;Lcom/android/server/sdp/engine/SdpPolicy;)I
    .locals 24

    const/4 v11, 0x0

    :try_start_0
    invoke-direct/range {p0 .. p1}, Lcom/android/server/SdpServiceKeeper$SdpPolicyDatabase;->getPolicyXmlFile(Lcom/sec/sdp/engine/SdpEngineInfo;)Ljava/io/File;
    :try_end_0
    ...
    invoke-virtual/range {p2 .. p2}, Lcom/android/server/sdp/engine/SdpPolicy;->getOwner()Lcom/sec/sdp/engine/SdpDomain;

    move-result-object v22

    invoke-virtual/range {v22 .. v22}, Lcom/sec/sdp/engine/SdpDomain;->getPackageName()Ljava/lang/String;
    ...
    check-cast v8, Lcom/sec/sdp/engine/SdpDomain;
    ...
    invoke-virtual {v8}, Lcom/sec/sdp/engine/SdpDomain;->getPackageName()Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v11}, Lcom/android/server/SdpServiceKeeper$SdpPolicyDatabase;->storeHashToTima(Lcom/sec/sdp/engine/SdpEngineInfo;Ljava/io/File;)Z
...
.method private removePolicyLocked(Lcom/sec/sdp/engine/SdpEngineInfo;)V
    .locals 7
...
.method private storeHashToTima(Lcom/sec/sdp/engine/SdpEngineInfo;Ljava/io/File;)Z
    .locals 7
