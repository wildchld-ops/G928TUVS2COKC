...
.field private final mDndSchedule:Lcom/android/server/notification/DndScheduleConditionProvider;
...
.method static constructor <clinit>()V
    ...
    sget-boolean v0, Landroid/service/notification/ZenModeConfig;->SUPPROT_TOUCHWIZ_DND:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/notification/ManagedServices$UserProfiles;Lcom/android/server/notification/ZenModeHelper;)V
    ...
    invoke-direct {p0, p1, p2, v4, p3}, Lcom/android/server/notification/ManagedServices;-><init>(Landroid/content/Context;Landroid/os/Handler;Ljava/lang/Object;Lcom/android/server/notification/ManagedServices$UserProfiles;)V

    new-instance v4, Landroid/util/ArrayMap;

    invoke-direct {v4}, Landroid/util/ArrayMap;-><init>()V

    iput-object v4, p0, Lcom/android/server/notification/ConditionProviders;->mListeners:Landroid/util/ArrayMap;

    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    iput-object v4, p0, Lcom/android/server/notification/ConditionProviders;->mRecords:Ljava/util/ArrayList;
    ...
    new-instance v6, Lcom/android/server/notification/ConditionProviders$ZenModeHelperCallback;

    invoke-direct {v6, p0, v5}, Lcom/android/server/notification/ConditionProviders$ZenModeHelperCallback;-><init>(Lcom/android/server/notification/ConditionProviders;Lcom/android/server/notification/ConditionProviders$1;)V

    invoke-virtual {v4, v6}, Lcom/android/server/notification/ZenModeHelper;->addCallback(Lcom/android/server/notification/ZenModeHelper$Callback;)V

    sget-boolean v4, Lcom/android/server/notification/ConditionProviders;->mIsTouchwizDnd:Z
    ...
    const-string v7, "dnd_schedule"

    aput-object v7, v4, v6

    invoke-static {v4}, Lcom/android/server/notification/ConditionProviders;->safeSet([Ljava/lang/Object;)Landroid/util/ArraySet;

    move-result-object v4

    iput-object v4, p0, Lcom/android/server/notification/ConditionProviders;->mSystemConditionProviders:Landroid/util/ArraySet;

    :goto_0
    iget-object v4, p0, Lcom/android/server/notification/ConditionProviders;->mSystemConditionProviders:Landroid/util/ArraySet;
    ...
    const-string/jumbo v6, "next_alarm"
    ...
    :cond_0
    new-instance v4, Lcom/android/server/notification/NextAlarmTracker;

    iget-object v6, p0, Lcom/android/server/notification/ConditionProviders;->mContext:Landroid/content/Context;

    invoke-direct {v4, v6}, Lcom/android/server/notification/NextAlarmTracker;-><init>(Landroid/content/Context;)V

    :goto_1
    iput-object v4, p0, Lcom/android/server/notification/ConditionProviders;->mNextAlarmTracker:Lcom/android/server/notification/NextAlarmTracker;

    if-eqz v0, :cond_4

    new-instance v4, Lcom/android/server/notification/CountdownConditionProvider;

    invoke-direct {v4}, Lcom/android/server/notification/CountdownConditionProvider;-><init>()V

    :goto_2
    iput-object v4, p0, Lcom/android/server/notification/ConditionProviders;->mCountdown:Lcom/android/server/notification/CountdownConditionProvider;

    if-eqz v2, :cond_5

    new-instance v4, Lcom/android/server/notification/DowntimeConditionProvider;

    iget-object v6, p0, Lcom/android/server/notification/ConditionProviders;->mNextAlarmTracker:Lcom/android/server/notification/NextAlarmTracker;
    ...
    invoke-direct {v4, p0, v6, v7}, Lcom/android/server/notification/DowntimeConditionProvider;-><init>(Lcom/android/server/notification/ConditionProviders;Lcom/android/server/notification/NextAlarmTracker;Lcom/android/server/notification/ZenModeHelper;)V

    :goto_3
    iput-object v4, p0, Lcom/android/server/notification/ConditionProviders;->mDowntime:Lcom/android/server/notification/DowntimeConditionProvider;
    ...
    invoke-direct {v4, v6}, Lcom/android/server/notification/NextAlarmConditionProvider;-><init>(Lcom/android/server/notification/NextAlarmTracker;)V
    ...
    new-instance v5, Lcom/android/server/notification/DndScheduleConditionProvider;

    iget-object v4, p0, Lcom/android/server/notification/ConditionProviders;->mNextAlarmTracker:Lcom/android/server/notification/NextAlarmTracker;
    ...
    invoke-direct {v5, p0, v4, v6}, Lcom/android/server/notification/DndScheduleConditionProvider;-><init>(Lcom/android/server/notification/ConditionProviders;Lcom/android/server/notification/NextAlarmTracker;Lcom/android/server/notification/ZenModeHelper;)V

    :cond_1
    iput-object v5, p0, Lcom/android/server/notification/ConditionProviders;->mDndSchedule:Lcom/android/server/notification/DndScheduleConditionProvider;
    ...
    const-string/jumbo v6, "system.condition.providers"

    const v7, 0x1070042

    invoke-static {v4, v6, v7}, Lcom/android/server/notification/PropConfig;->getStringArray(Landroid/content/Context;Ljava/lang/String;I)[Ljava/lang/String;
...
.method private loadZenConfig()V
    ...
    const-string/jumbo v8, "loadZenConfig: no config"
    ...
    :cond_4
    iget-object v7, p0, Lcom/android/server/notification/ConditionProviders;->mDndSchedule:Lcom/android/server/notification/DndScheduleConditionProvider;

    if-eqz v7, :cond_5

    iget-object v7, p0, Lcom/android/server/notification/ConditionProviders;->mDndSchedule:Lcom/android/server/notification/DndScheduleConditionProvider;

    invoke-virtual {v7, v3}, Lcom/android/server/notification/DndScheduleConditionProvider;->setConfig(Landroid/service/notification/ZenModeConfig;)V
    ...
    const-string/jumbo v9, "loadZenConfig: no conditions"
    ...
    const-string/jumbo v10, "loadZenConfig: N="
...
.method public dump(Ljava/io/PrintWriter;Lcom/android/server/notification/NotificationManagerService$DumpFilter;)V
    ...
    :cond_7
    iget-object v3, p0, Lcom/android/server/notification/ConditionProviders;->mDndSchedule:Lcom/android/server/notification/DndScheduleConditionProvider;

    if-eqz v3, :cond_8

    iget-object v3, p0, Lcom/android/server/notification/ConditionProviders;->mDndSchedule:Lcom/android/server/notification/DndScheduleConditionProvider;

    invoke-virtual {v3, p1, p2}, Lcom/android/server/notification/DndScheduleConditionProvider;->dump(Ljava/io/PrintWriter;Lcom/android/server/notification/NotificationManagerService$DumpFilter;)V
...
.method public notifyConditions(Ljava/lang/String;Lcom/android/server/notification/ManagedServices$ManagedServiceInfo;[Landroid/service/notification/Condition;)V
    ...
    const-string/jumbo v16, "notifyConditions pkg="
    ...
    const-string/jumbo v16, "manualConditionExit"
...
.method public onBootPhaseAppsCanStart()V
    ...
    :cond_3
    iget-object v0, p0, Lcom/android/server/notification/ConditionProviders;->mDndSchedule:Lcom/android/server/notification/DndScheduleConditionProvider;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/notification/DndScheduleConditionProvider;->attachBase(Landroid/content/Context;)V

    iget-object v0, p0, Lcom/android/server/notification/ConditionProviders;->mDndSchedule:Lcom/android/server/notification/DndScheduleConditionProvider;

    invoke-virtual {v0}, Lcom/android/server/notification/DndScheduleConditionProvider;->asInterface()Landroid/service/notification/IConditionProvider;

    move-result-object v0

    sget-object v1, Lcom/android/server/notification/DndScheduleConditionProvider;->COMPONENT:Landroid/content/ComponentName;
...
.method protected onServiceRemovedLocked(Lcom/android/server/notification/ManagedServices$ManagedServiceInfo;)V
    ...
    const-string/jumbo v3, "manualServiceRemoved"
