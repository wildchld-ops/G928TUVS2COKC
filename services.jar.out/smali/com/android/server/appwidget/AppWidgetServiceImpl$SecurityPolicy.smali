...
.method private isCallerBindAppWidgetWhiteListedLocked(Ljava/lang/String;)Z
    ...
    invoke-static {v3, p1, v2}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$2100(Lcom/android/server/appwidget/AppWidgetServiceImpl;Ljava/lang/String;I)I
    ...
    invoke-static {v3}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$2200(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Ljava/lang/Object;
    ...
    invoke-static {v3, v2}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$2300(Lcom/android/server/appwidget/AppWidgetServiceImpl;I)V
    ...
    invoke-static {v3}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$2400(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Landroid/util/ArraySet;
...
.method private isProfileEnabled(I)Z
    ...
    invoke-static {v3}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$1800(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Landroid/os/UserManager;
...
.method public canAccessAppWidget(Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;ILjava/lang/String;)Z
    ...
    invoke-static {v2}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$1200(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Landroid/content/Context;
...
.method public enforceCallFromPackage(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$2000(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Landroid/app/AppOpsManager;
...
.method public enforceModifyAppWidgetBindPermissions(Ljava/lang/String;)V
    ...
    # getter for: Lcom/android/server/appwidget/AppWidgetServiceImpl;->mContext:Landroid/content/Context;
    invoke-static {v0}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$1200(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Landroid/content/Context;
...
.method public enforceServiceExistsAndRequiresBindRemoteViewsPermission(Landroid/content/ComponentName;I)V
    ...
    invoke-static {v3}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$1900(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Landroid/content/pm/IPackageManager;
...
.method public getEnabledGroupProfileIds(I)[I
    ...
    # getter for: Lcom/android/server/appwidget/AppWidgetServiceImpl;->mUserManager:Landroid/os/UserManager;
    invoke-static {v10}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$1800(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Landroid/os/UserManager;
...
.method public getGroupParent(I)I
    ...
    invoke-static {v1}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$2500(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Lcom/android/server/appwidget/AppWidgetServiceImpl$SecurityPolicy;
...
.method public hasCallerBindPermissionOrBindWhiteListedLocked(Ljava/lang/String;)Z
    ...
    # getter for: Lcom/android/server/appwidget/AppWidgetServiceImpl;->mContext:Landroid/content/Context;
    invoke-static {v1}, Lcom/android/server/appwidget/AppWidgetServiceImpl;->access$1200(Lcom/android/server/appwidget/AppWidgetServiceImpl;)Landroid/content/Context;
