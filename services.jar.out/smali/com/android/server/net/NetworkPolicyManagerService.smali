...
.field private syncAppMap:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/IActivityManager;Landroid/os/IPowerManager;Landroid/net/INetworkStatsService;Landroid/os/INetworkManagementService;Landroid/util/TrustedTime;Ljava/io/File;Z)V
    ...
    iput-object v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->syncAppMap:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->syncAppMap:Ljava/util/HashMap;
...
.method static synthetic access$600(Lcom/android/server/net/NetworkPolicyManagerService;)Landroid/net/IConnectivityManager;
    .locals 1
...
.method static synthetic access$700(Lcom/android/server/net/NetworkPolicyManagerService;)Landroid/util/ArraySet;
    .locals 1
...
.method static synthetic access$800(Lcom/android/server/net/NetworkPolicyManagerService;)Landroid/net/INetworkStatsService;
    .locals 1
...
.method private ensureActiveMobilePolicyLocked(Ljava/lang/String;)V
    ...
    const-string v13, "; generating default policy"
    ...
    const-string v12, "CscFeature_RIL_ConfigDefDataUsageValue"

    const-string v13, ""

    invoke-virtual {v3, v12, v13}, Lcom/sec/android/app/CscFeature;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v13, " by CscFeature"
    ...
    const-string v13, "edm.intent.action.internal.sec.DEFAULT_NETWORK_POLICY_APPLIED"
...
.method private isAllNAVendor()Z
    .locals 4
...
.method public setNetworkPolicies([Landroid/net/NetworkPolicy;)V
    ...
    const-string v3, "IllegalArgumentException: the template is "
...
.method public systemReady()V
    ...
    new-instance v12, Lcom/android/server/net/NetworkPolicyManagerService$VideoCallBroadcastReceiver;

    move-object/from16 v0, p0

    invoke-direct {v12, v0}, Lcom/android/server/net/NetworkPolicyManagerService$VideoCallBroadcastReceiver;-><init>(Lcom/android/server/net/NetworkPolicyManagerService;)V
...
.method updateRulesForUidLocked(I)V
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/android/server/net/NetworkPolicyManagerService;->getUidAllowedForData(I)I
    ...
    iget-boolean v15, v0, Lcom/android/server/net/NetworkPolicyManagerService;->mLimitBackground:Z
    ...
    invoke-direct {v0, v1, v7}, Lcom/android/server/net/NetworkPolicyManagerService;->setUidNetworkRules(IZ)V

    invoke-direct/range {p0 .. p0}, Lcom/android/server/net/NetworkPolicyManagerService;->isAllNAVendor()Z
    ...
    iget-object v15, v0, Lcom/android/server/net/NetworkPolicyManagerService;->syncAppMap:Ljava/util/HashMap;
    ...
    const-string/jumbo v17, "updateRulesForUidLocked() basic app : "
    ...
    :try_start_0
    invoke-virtual {v6, v8, v15}, Landroid/content/pm/PackageManager;->getPackageUid(Ljava/lang/String;I)I

    move-result v9

    move-object/from16 v0, p0

    invoke-direct {v0, v9, v7}, Lcom/android/server/net/NetworkPolicyManagerService;->setUidNetworkRules(IZ)V
    ...
    invoke-virtual {v15, v9}, Landroid/util/SparseIntArray;->delete(I)V
    ...
    invoke-virtual {v15, v0, v9, v13}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
    ...
    const-string/jumbo v17, "updateRulesForUidLocked() Not found syncApp : "
    ...
    invoke-virtual {v15, v0, v13}, Landroid/util/SparseIntArray;->put(II)V
    ...
    invoke-virtual {v15, v9, v13}, Landroid/util/SparseIntArray;->put(II)V
    :try_end_1
    ...
    invoke-virtual {v15, v0, v1, v13}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
    ...
    iget-object v15, v0, Lcom/android/server/net/NetworkPolicyManagerService;->mNetworkStats:Landroid/net/INetworkStatsService;

    move/from16 v0, p1

    invoke-interface {v15, v0, v11}, Landroid/net/INetworkStatsService;->setUidForeground(IZ)V
    :try_end_2
