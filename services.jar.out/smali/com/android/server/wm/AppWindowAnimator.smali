...
.method stepAnimationLocked(J)Z
    ...
    iget-boolean v3, v3, Lcom/android/server/wm/AppWindowToken;->mLaunchTaskBehind:Z
    ...
    invoke-interface {v3, v5}, Landroid/app/IActivityManager;->notifyLaunchTaskBehindComplete(Landroid/os/IBinder;)V
    :try_end_0
    ...
    iput-boolean v4, v3, Lcom/android/server/wm/AppWindowToken;->mLaunchTaskBehind:Z
    ...
    iget-boolean v3, v3, Lcom/android/server/wm/AppWindowToken;->mEnteringAnimation:Z

    if-eqz v3, :cond_b

    iget-object v3, p0, Lcom/android/server/wm/AppWindowAnimator;->mAppToken:Lcom/android/server/wm/AppWindowToken;

    iput-boolean v4, v3, Lcom/android/server/wm/AppWindowToken;->mEnteringAnimation:Z
    ...
    invoke-interface {v3, v5}, Landroid/app/IActivityManager;->notifyEnterAnimationComplete(Landroid/os/IBinder;)V
    :try_end_1
...
.method updateLayers()V
    ...
    iput v7, p0, Lcom/android/server/wm/AppWindowAnimator;->thumbnailLayer:I
    ...
    iget v7, v6, Lcom/android/server/wm/WindowStateAnimator;->mAnimLayer:I

    iget-object v8, p0, Lcom/android/server/wm/AppWindowAnimator;->mAppToken:Lcom/android/server/wm/AppWindowToken;

    iget v8, v8, Lcom/android/server/wm/AppWindowToken;->startingAnimLayerAdjustment:I
    ...
    invoke-virtual {v7, v1}, Lcom/android/server/wm/WindowManagerService;->setInputMethodAnimLayerAdjustment(I)V

    :cond_2
    iget-object v7, p0, Lcom/android/server/wm/AppWindowAnimator;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v4, v7, Lcom/android/server/wm/WindowManagerService;->mWallpaperTarget:Lcom/android/server/wm/WindowState;

    iget-object v7, p0, Lcom/android/server/wm/AppWindowAnimator;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v3, v7, Lcom/android/server/wm/WindowManagerService;->mLowerWallpaperTarget:Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual {v7, v1}, Lcom/android/server/wm/WindowManagerService;->setWallpaperAnimLayerAdjustmentLocked(I)V
