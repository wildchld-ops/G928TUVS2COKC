...
.method applyAnimationLocked()Z
    ...
    iget-object v6, p0, Lcom/android/server/wm/DragStateAnimator;->mTargetWin:Lcom/android/server/wm/WindowState;

    invoke-virtual {v6}, Lcom/android/server/wm/WindowState;->getDisplayId()I

    move-result v6

    invoke-virtual {v3, v6}, Lcom/android/server/wm/WindowManagerService;->okToDisplay(I)Z
    ...
    iput v6, v3, Lcom/android/server/wm/DragState;->mLastX:F

    iget-object v3, p0, Lcom/android/server/wm/DragStateAnimator;->mState:Lcom/android/server/wm/DragState;

    iget-object v6, p0, Lcom/android/server/wm/DragStateAnimator;->mState:Lcom/android/server/wm/DragState;

    iget v6, v6, Lcom/android/server/wm/DragState;->mCurrentY:F

    iput v6, v3, Lcom/android/server/wm/DragState;->mLastY:F
