...
# direct methods
.method constructor <init>(Lcom/android/server/wm/WindowState;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZLandroid/content/res/Configuration;Landroid/graphics/Rect;)V
    .locals 0
    ...
    iput-object p9, p0, Lcom/android/server/wm/WindowState$2;->val$cocktailBarFrame:Landroid/graphics/Rect;
...
.method public run()V
    ...
    iget-object v8, p0, Lcom/android/server/wm/WindowState$2;->val$cocktailBarFrame:Landroid/graphics/Rect;

    invoke-interface/range {v0 .. v8}, Landroid/view/IWindow;->resized(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZLandroid/content/res/Configuration;Landroid/graphics/Rect;)V
    :try_end_0
