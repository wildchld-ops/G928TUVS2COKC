...
.method private doWorkForUSBState(Ljava/lang/String;)V
    ...
    const-string v6, "Mount Decrypted SDcard in first booting when Fingerprint is set as Lockscreen"
    ...
    const-string/jumbo v7, "looks like encryption policies were received while SD card decryption was on going!!"
...
.method public onEventInner(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v15}, Lcom/android/server/DirEncryptServiceHelper;->doWorkForPassword(Ljava/lang/String;)V
    ...
    const-string v19, "com.sec.app.action.START_SDCARD_ENCRYPTION"
    ...
    const-string/jumbo v19, "required"
    ...
    const-string v21, "Failed to start intent activity"
    ...
    const-string/jumbo v19, "security.ode.knox.migration"
    ...
    const-string v21, "RESP_KNOX_REVERT_SS extra data recvd["
