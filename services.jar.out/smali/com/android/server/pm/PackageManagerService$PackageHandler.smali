...
.method doHandleMessage(Landroid/os/Message;)V
    ...
    const-string v8, "INIT_COPY: observer{"
    ...
    iget-object v8, v0, Lcom/android/server/pm/PackageManagerService$PackageHandler;->this$0:Lcom/android/server/pm/PackageManagerService;
    ...
    invoke-static {v8, v0}, Lcom/android/server/pm/PackageManagerService;->access$700(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/PackageManagerService$HandlerParams;)Ljava/lang/String;
    ...
    const-string v8, "          for_user{"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    invoke-virtual/range {v47 .. v47}, Lcom/android/server/pm/PackageManagerService$HandlerParams;->getUser()Landroid/os/UserHandle;
    ...
    const-string v8, "MCS_BOUND: observer{"
    ...
    const-string v7, "SEND_PENDING_BROADCAST"
    ...
    const-string v8, "START_CLEANING_PACKAGE packageName{"
    ...
    check-cast v28, Lcom/android/server/pm/PackageManagerService$PostInstallData;
    ...
    const-string v8, "POST_INSTALL: observer{"
    ...
    const-string v8, "          Handling post-install for "
    ...
    invoke-static {v7, v4}, Lcom/android/server/pm/PackageManagerService;->logFormat(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v16 .. v21}, Lcom/android/server/pm/PackageManagerService;->access$1100(Lcom/android/server/pm/PackageManagerService;ZZLjava/util/ArrayList;[ILandroid/content/IIntentReceiver;)V

    :cond_1e
    sget-object v4, Lcom/android/server/pm/PackageManagerService;->mOverlays:Landroid/util/ArrayMap;
    ...
    const-string/jumbo v7, "updatgeoverlaymap for "
    ...
    const-string v7, " newly installed app"
    ...
    # invokes: Lcom/android/server/pm/PackageManagerService;->updateOverlayMap(Ljava/lang/String;Landroid/content/pm/PackageParser$Package;Z)V
    invoke-static {v5, v0, v4, v7}, Lcom/android/server/pm/PackageManagerService;->access$1200(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;Landroid/content/pm/PackageParser$Package;Z)V
    ...
    const-string/jumbo v7, "result of install: "
    ...
    const-string v7, "UPDATED_MEDIA_STATUS"
    ...
    const-string/jumbo v7, "reportStatus="
    ...
    const-string v7, "WRITE_PACKAGE_RESTRICTIONS"
    ...
    const-string v8, "CHECK_PENDING_VERIFICATION: observer{"
    ...
    const-string/jumbo v7, "timeout extended.. wait.."
    ...
    const-string v8, "CHECK_PENDING_VERIFICATION: id="
    ...
    :cond_31
    :try_start_d
    invoke-virtual/range {v57 .. v57}, Lcom/android/server/pm/PackageVerificationState;->setTimeout()V
    ...
    const-string v8, "Invalid verification token "
    ...
    const-string v8, "PACKAGE_VERIFIED: observer{"
    ...
    const-string v8, "SUFFICIENT_VERIFICATION_TIMEOUT: observer{"
    ...
    const-string v8, "SUFFICIENT_VERIFICATION_TIMEOUT: \n"
    ...
    :try_start_10
    invoke-virtual/range {v57 .. v57}, Lcom/android/server/pm/PackageVerificationState;->clearSufficientVerifiers()V
    ...
    check-cast v57, Lcom/android/server/pm/PackageScanState;

    if-eqz v57, :cond_0

    invoke-virtual/range {v57 .. v57}, Lcom/android/server/pm/PackageScanState;->getInstallArgs()Lcom/android/server/pm/PackageManagerService$InstallArgs;
    ...
    invoke-virtual/range {v57 .. v57}, Lcom/android/server/pm/PackageScanState;->getTempPackage()Ljava/io/File;
    ...
    invoke-virtual/range {v58 .. v58}, Ljava/io/File;->getAbsolutePath()Ljava/lang/String;
