...
.method private prepareNativeDaemon()V
    ...
    :goto_0
    const-string/jumbo v10, "net.qtaguid_enabled"
...
.method public startAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v9}, Lcom/android/server/NetworkManagementService;->wifiFirmwareReload(Ljava/lang/String;Ljava/lang/String;)V

    if-nez p1, :cond_0

    iget-object v9, p0, Lcom/android/server/NetworkManagementService;->mConnector:Lcom/android/server/NativeDaemonConnector;

    const-string/jumbo v10, "softap"
    ...
    const-string/jumbo v13, "startap"
    ...
    iget v9, v0, Landroid/net/wifi/WifiConfiguration;->vendorIE:I
    ...
    iput v9, v0, Landroid/net/wifi/WifiConfiguration;->maxclient:I
    ...
    const-string/jumbo v11, "maxClient = "
    ...
    const-string/jumbo v11, "wifiConfig.vendorIE = "
    ...
    const-string/jumbo v11, "vendorIE = "
    ...
    iput v9, v0, Landroid/net/wifi/WifiConfiguration;->wpsStatus:I
    ...
    invoke-direct {v13, v14}, Lcom/android/server/NativeDaemonConnector$SensitiveArg;-><init>(Ljava/lang/Object;)V
    ...
    iget v13, v0, Landroid/net/wifi/WifiConfiguration;->channel:I
    ...
    iget v13, v0, Landroid/net/wifi/WifiConfiguration;->macaddrAcl:I
    ...
    iget v13, v0, Landroid/net/wifi/WifiConfiguration;->apIsolate:I
    ...
    iget v13, v0, Landroid/net/wifi/WifiConfiguration;->txPowerMode:I
    ...
    const-string v10, "CscFeature_Wifi_MaxClient4MobileApNetExtension"
