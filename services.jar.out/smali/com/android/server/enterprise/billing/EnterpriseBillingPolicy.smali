...
# instance fields
.field public changeContainerOwnerReceiver:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->changeContainerOwnerReceiver:Landroid/content/BroadcastReceiver;

    new-instance v0, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy$3;

    invoke-direct {v0, p0}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy$3;-><init>(Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;)V
...
.method static synthetic access$200(Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;)Lcom/android/server/enterprise/billing/EnterpriseBillingEngine;
    .locals 1
...
.method static synthetic access$300(Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic access$400(Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->deactivateEnterpriseBilling(Ljava/lang/String;)V
...
.method private enableProfileForAppsInternal(Ljava/lang/String;Ljava/util/List;II)Z
    ...
    invoke-direct {p0, v2, p4}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->isApplicationPackageAvailable(Ljava/lang/String;I)Z
...
.method private isApplicationPackageAvailable(Ljava/lang/String;I)Z
    .locals 10

    const-string v7, "EnterpriseBillingPolicy"

    const-string/jumbo v8, "isApplicationPacakgeAvailable App - Start"
    ...
    :try_start_0
    iget-object v7, p0, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->mContext:Landroid/content/Context;
    ...
    const-string/jumbo v9, "isApplicationPacakgeAvailable App - End + returnValue = "
...
.method public disableProfileForApps(Landroid/app/enterprise/ContextInfo;Ljava/util/List;)Z
    ...
    invoke-direct {p0, p2, v0, v1}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->disableProfileForAppsInternal(Ljava/util/List;II)Z
...
.method public enableProfileForApps(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;Ljava/util/List;)Z
    ...
    :cond_0
    invoke-direct {p0, p2, p3, v1, v2}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->enableProfileForAppsInternal(Ljava/lang/String;Ljava/util/List;II)Z
...
.method public enableProfileForContainer(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v4, v2, v3}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->disableProfileForAppsInternal(Ljava/util/List;II)Z
    ...
    invoke-direct {p0, p2, v3, v2}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->enableProfileForContainerInternal(Ljava/lang/String;II)Z
...
.method public getProfileForApplication(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;)Lcom/sec/enterprise/knox/billing/EnterpriseBillingProfile;
    ...
    const-string/jumbo v5, "getProfileForApplication - start "
    ...
    invoke-virtual {v3, p2, v1}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicyStorageHelper;->getProfileForApplication(Ljava/lang/String;I)Lcom/sec/enterprise/knox/billing/EnterpriseBillingProfile;
    ...
    const-string/jumbo v5, "getProfileForApplication - "
    ...
    const-string/jumbo v5, "getProfileForApplication - Error invalid parameter"
...
.method public systemReady()V
    ...
    iget-object v1, p0, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->changeContainerOwnerReceiver:Landroid/content/BroadcastReceiver;
...
.method public updateProfile(Landroid/app/enterprise/ContextInfo;Lcom/sec/enterprise/knox/billing/EnterpriseBillingProfile;)Z
    ...
    const-string/jumbo v13, "updateProfile - start - "
    ...
    invoke-direct/range {p0 .. p1}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->enforceActiveAdminEnterpriseBillingPermission(Landroid/app/enterprise/ContextInfo;)Landroid/app/enterprise/ContextInfo;
    ...
    invoke-direct {p0, v12}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->isContainerAvailable(I)Z
    ...
    invoke-direct {p0, v12, v4}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->disableProfileForContainerInternal(II)Z
    ...
    invoke-direct {p0, v1, v4, v12}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->disableProfileForAppsInternal(Ljava/util/List;II)Z
    ...
    invoke-direct {p0, v10, v12, v4}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->enableProfileForContainerInternal(Ljava/lang/String;II)Z
    ...
    invoke-direct {p0, v10, v1, v4, v12}, Lcom/android/server/enterprise/billing/EnterpriseBillingPolicy;->enableProfileForAppsInternal(Ljava/lang/String;Ljava/util/List;II)Z
    ...
    const-string/jumbo v14, "updateProfile - end - "
