...
.method private _setAuthenticationConfig(ILcom/sec/enterprise/identity/AuthenticationConfig;)I
    ...
    const-string v14, "In _setAuthenticationConfig Element newSolution PackageName:   "
    ...
    const-string v14, "In _setAuthenticationConfig Element newSolution FORCE_ENTERPRISE_IDENTITY_LOCK:   "
    ...
    const-string v14, "In _setAuthenticationConfig Element newSolution IS_CONFIGURED_BY_MDM:  "
    ...
    const-string v14, "In _setAuthenticationConfig Element e PackageName:   "
    ...
    const-string v14, "In _setAuthenticationConfig Element e FORCE_ENTERPRISE_IDENTITY_LOCK:   "
    ...
    const-string v14, "In _setAuthenticationConfig Element e IS_CONFIGURED_BY_MDM:  "
...
.method private bindToEnterpriseIdAuthenticator(ILjava/lang/String;)Landroid/app/enterprise/sso/GenericSSOSupportSolution;
    ...
    const-string v5, "In bindToExchangeAuthenticator: NullPointerException"
    ...
    const-string v5, "In bindToExchangeAuthenticator: Exception"
...
.method private clearEnterpriseIdentityConfigForAuthenticator(I)I
    .locals 6

    :try_start_0
    sget-object v4, Lcom/android/server/enterprise/sso/EnterpriseIdentity;->authenticationConfigXMLDocs:Landroid/util/SparseArray;
    ...
    const-string v5, "clearEnterpriseIdentityConfigForAuthenticator: Exception"
...
.method private getPackageCertForPkgname(ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v15, "in getPackageCertForPkgname: pkgInfo is null"
...
.method private isAuthenticatorApplicationInstalled(Ljava/lang/String;I)Z
    ...
    const-string v4, "In performUserAuthentication: Authenticator not installed"
...
.method private removeFileAndCacheEntry(I)V
    ...
    const-string v4, "In remove file and cache : file is not removed"
...
.method public getAuthenticationConfig(I)Lcom/sec/enterprise/identity/AuthenticationConfig;
    ...
    const-string v14, "SSO_PROVIDER_PACKAGE_SIGNATURE=null in XML"
    ...
    const-string v14, "Error to look up. ENFORCE_REMOTE_AUTH_ALWAYS=null in XML"
    ...
    const-string v14, "Error to look up. FORCE_ENTERPRISE_IDENTITY_LOCK=null in XML"
    ...
    const-string v14, "Error to look up. HIDE_ENTERPRISE_ID_LOCK=null in XML"
    ...
    const-string v14, "Error to look up. isConfiguredByMDM=null in XML"
    ...
    const-string v14, "In getEnterpriseIDLockConfig: Exception"
...
.method public onAdminRemoved(I)V
    ...
    const-string v8, "OnAdminRemoved for app uid = "
    ...
    const-string v8, "OnAdminRemoved for userId = "
    ...
    const-string v7, "OnAdminRemoved for uid == adminUid"
    ...
    const-string v7, "In Admin is removed : file is not removed"
...
.method public performUserAuthentication(Landroid/app/enterprise/ContextInfo;Lcom/sec/enterprise/identity/AuthenticationConfig;)Landroid/app/enterprise/sso/TokenInfo;
    ...
    const-string v3, "Performing user authentication is failed : request :"
    ...
    const-string v3, "In Performing user authentication is calling _setAuthenticationConfig"
    ...
    const-string v3, "In performExchangeAuthentication: The authenticator value is null"
    ...
    const-string v2, "In performExchangeAuthentication: RemoteException"
...
.method public setUpdatedAuthenticationConfig(Landroid/app/enterprise/ContextInfo;Lcom/sec/enterprise/identity/AuthenticationConfig;)Z
    ...
    const-string v3, "In performExchangeAuthentication: authenticationInfoManager.isSSOConfigurationEnabled = true"
    ...
    const-string v4, "In performExchangeAuthentication: authenticationInfoManager.isSSOConfigurationEnabled = true adminUID = "
