...
.method public resetData(Landroid/app/enterprise/ContextInfo;I)V
    ...
    const-string/jumbo v3, "resetData("
    ...
    const-string v5, " has reset banner settings."
...
.method public resetWallpaper(Landroid/app/enterprise/ContextInfo;)V
    ...
    const-string v5, " has reset banner wallpaper."
...
.method public declared-synchronized setData(Landroid/app/enterprise/ContextInfo;Landroid/app/enterprise/lso/LSOItemData;I)I
    ...
    :cond_4
    invoke-virtual {p0, v9, p2, p3}, Lcom/android/server/enterprise/lso/LSOService;->copyFiles(ILandroid/app/enterprise/lso/LSOItemData;I)Z
    ...
    const-string v10, " has changed banner settings."
...
.method public setPreferences(Landroid/app/enterprise/ContextInfo;Landroid/app/enterprise/lso/LSOAttributeSet;)I
    ...
    const-string v5, " has changed banner settings."
...
.method public setWallpaper(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;)I
    ...
    const-string v4, "/data/data/com.sec.android.gallery3d"
    ...
    const-string v4, "/data/data/com.sec.android.gallery3d does not exists"
    ...
    invoke-static {v3}, Landroid/app/enterprise/lso/LSOUtils;->mkDir(Ljava/lang/String;)Z
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :cond_2
    :try_start_2
    const-string v3, "/data/system/enterprise/lso"
    ...
    invoke-virtual {v3}, Lcom/android/server/enterprise/lso/LSOStorageProvider;->resetWallpaperData()V

    sget-object v3, Landroid/graphics/Bitmap$CompressFormat;->JPEG:Landroid/graphics/Bitmap$CompressFormat;

    const-string v4, "/data/system/enterprise/lso/lockscreen_wallpaper.jpg"

    iget-object v5, p0, Lcom/android/server/enterprise/lso/LSOService;->screenDimesions:Landroid/graphics/Point;

    invoke-static {p2, v3, v4, v5}, Landroid/app/enterprise/lso/LSOUtils;->convertImageFormat(Ljava/lang/String;Landroid/graphics/Bitmap$CompressFormat;Ljava/lang/String;Landroid/graphics/Point;)Z
    ...
    const-string v4, "Create Ripple image"
    ...
    const-string v5, "/data/system/enterprise/lso/lockscreen_wallpaper_ripple.jpg"

    invoke-static {v3, v4, v5}, Landroid/app/enterprise/lso/LSOUtils;->createRippleImage(Ljava/lang/String;Landroid/graphics/Bitmap$CompressFormat;Ljava/lang/String;)Z
    :try_end_3
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_3} :catch_0
    ...
    const-string v1, "Error in copying file"
    ...
    invoke-virtual {v3, v4, v5, p2}, Lcom/android/server/enterprise/lso/LSOStorageProvider;->setWallpaperData(JLjava/lang/String;)Z
    ...
    :cond_6
    iput v12, p0, Lcom/android/server/enterprise/lso/LSOService;->mWallpaperAdminUid:I
