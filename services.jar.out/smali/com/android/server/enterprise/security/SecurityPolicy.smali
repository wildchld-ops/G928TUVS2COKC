...
.method static synthetic access$1400(Lcom/android/server/enterprise/security/SecurityPolicy;)Landroid/security/KeyStore;
    .locals 1
...
.method private formatExternalStorageCard()Z
    ...
    const-string/jumbo v12, "formatStorageCard - InterruptedException"
    ...
    const-string/jumbo v12, "formatStorageCard fail"
...
.method public deleteCertificateFromKeystore(Landroid/app/enterprise/ContextInfo;Landroid/app/enterprise/CertificateInfo;I)Z
    ...
    invoke-static {v13}, Lcom/android/server/enterprise/security/SecurityPolicy;->isCa(Ljava/security/cert/Certificate;)Z
    ...
    invoke-direct {v0, v13, v2, v3}, Lcom/android/server/enterprise/security/SecurityPolicy;->deleteCertificateFromNativeKeystore(Ljava/security/cert/Certificate;Ljava/lang/String;I)Z
    ...
    invoke-direct {v0, v13, v2, v3, v8}, Lcom/android/server/enterprise/security/SecurityPolicy;->deleteCertificateFromNativeKeystoreAsUser(Ljava/security/cert/Certificate;Ljava/lang/String;II)Z
    ...
    const-string v15, " has deleted certificate "
    ...
    invoke-interface {v12, v2}, Landroid/security/IKeyChainService;->getCertificateAlias([B)Ljava/lang/String;

    move-result-object v9

    if-eqz v9, :cond_8

    invoke-interface {v12, v9}, Landroid/security/IKeyChainService;->deleteCaCertificate(Ljava/lang/String;)Z
    :try_end_1
    ...
    invoke-virtual {v10}, Ljava/security/cert/CertificateEncodingException;->toString()Ljava/lang/String;
...
.method public enableRebootBanner(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    invoke-direct {p0, p1, p2, v2}, Lcom/android/server/enterprise/security/SecurityPolicy;->enableRebootBannerInternal(Landroid/app/enterprise/ContextInfo;ZLjava/lang/String;)Z
    ...
    const-string v5, " has enabled reboot banner."
    ...
    const-string v5, " has disabled reboot banner."
...
.method public enableRebootBannerWithText(Landroid/app/enterprise/ContextInfo;ZLjava/lang/String;)Z
    ...
    const-string v5, " has enabled reboot banner with text "
...
.method public formatStorageCard(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/server/enterprise/adapterlayer/StorageManagerAdapter;->getVolumeList()[Landroid/os/storage/StorageVolume;
...
.method public installCertificateToKeystore(Landroid/app/enterprise/ContextInfo;Ljava/lang/String;[BLjava/lang/String;Ljava/lang/String;I)Z
    ...
    invoke-direct {v0, v1}, Lcom/android/server/enterprise/security/SecurityPolicy;->getValidStr(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v8}, Lcom/android/server/enterprise/security/SecurityPolicy;->isNativeKeyStoreUnlockedAsUser(I)Z
    ...
    const-string v4, " has installed certificate "
...
.method public powerOffDevice(Landroid/app/enterprise/ContextInfo;)V
    ...
    const-string/jumbo v4, "powerOffDevice"

    const/4 v5, 0x1

    invoke-virtual {v0, v1, v4, v5}, Lcom/samsung/android/sagearpolicymanager/SAGearPolicyManager;->SetBooleanTypePolicy(Ljava/lang/String;Ljava/lang/String;Z)I

    const-string v1, "SecurityPolicy"

    const-string/jumbo v4, "powerOffDevice():EDM power off device start..."
    ...
    invoke-static {v1}, Lcom/android/server/power/ShutdownThread;->systemShutdown(Landroid/content/Context;)V
...
.method public setInternalStorageEncryption(Landroid/app/enterprise/ContextInfo;Z)V
    ...
    invoke-virtual {v7, v0}, Landroid/app/admin/DevicePolicyManager;->getStorageEncryption(Landroid/content/ComponentName;)Z
    ...
    const-string/jumbo v1, "setInternalStorageEncryption : Not encrypted"
    ...
    const-string/jumbo v1, "setInternalStorageEncryption : device is already encrypted"
    ...
    const-string/jumbo v1, "setInternalStorageEncryption : Launching Encrption activity"
    ...
    const-string v6, " has requested encryption of internal storage"
    ...
    const-string/jumbo v1, "is Internal Storage Encrypted?"
...
.method public wipeDevice(Landroid/app/enterprise/ContextInfo;I)Z
    ...
    const-string/jumbo v2, "wipeDevice"
    ...
    const-string v2, "SetBooleanTypePolicy wipeDevice"
