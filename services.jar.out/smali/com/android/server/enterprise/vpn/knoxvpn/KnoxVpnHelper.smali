...
.method public addVpnProfileToDatabase(Lcom/sec/enterprise/knox/KnoxVpnContext;Ljava/lang/String;)Z
    ...
    const-string/jumbo v29, "jsonProfile value is <-->"
    ...
    const-string v28, "Inside addVpnProfileToDatabase <-->"
    ...
    const-string v28, "Inside knox specific AttrObj != null <-->"
    ...
    const-string v29, "Value for pacurl <-->"
    ...
    const-string v29, "Admin has enabled id tracking feature "
    ...
    const-string v29, "Value for vpnConnectionType <-->"
    ...
    const-string/jumbo v27, "personaId"
    ...
    const-string/jumbo v27, "vendorName"
    ...
    const-string/jumbo v27, "protocolType"
    ...
    const-string v27, "activateState"
    ...
    const-string/jumbo v27, "vpnServiceType"
    ...
    const-string v27, "chainingEnabled"
    ...
    const-string/jumbo v27, "uidPidSearch"
    ...
    const-string/jumbo v27, "vpnConnectionType"
    ...
    const-string/jumbo v27, "proxyServer"
    ...
    const-string v28, "VpnProfileInfo"
    ...
    const-string v29, "add profile in database : status is "
    ...
    const-string/jumbo v29, "profile Name is"
...
.method public addVpnProfileToMap(Lcom/sec/enterprise/knox/KnoxVpnContext;Ljava/lang/String;)Z
    ...
    :cond_0
    const-string/jumbo v25, "proxy-server"

    sget-object v26, Lcom/android/server/enterprise/vpn/knoxvpn/KnoxVpnConstants;->DEFAULT_PROXY_SERVER:Ljava/lang/String;
    ...
    const-string v27, "Value for proxyServer <-->"
    ...
    :cond_1
    const-string/jumbo v25, "proxy-port"
    ...
    const-string v27, "Value for proxyPort <-->"
    ...
    :cond_2
    const-string/jumbo v25, "proxy-username"

    sget-object v26, Lcom/android/server/enterprise/vpn/knoxvpn/KnoxVpnConstants;->DEFAULT_PROXY_CREDENTIALS:Ljava/lang/String;
    ...
    const-string/jumbo v25, "proxy-password"
    ...
    const-string/jumbo v25, "pac-url"

    sget-object v26, Lcom/android/server/enterprise/vpn/knoxvpn/KnoxVpnConstants;->DEFAULT_PAC_URL:Ljava/lang/String;
    ...
    const-string v27, "Admin has enabled id tracking feature in addVpnProfileToMap"
    ...
    :cond_8
    :try_start_3
    const-string/jumbo v25, "ondemand"
    ...
    const-string/jumbo v27, "get profilename from json : Error parsing JSON \n"
...
.method protected declared-synchronized sendPacConfigBroadcast(Ljava/util/HashMap;ILjava/lang/String;I)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected declared-synchronized sendknoxVpnProxyBroadcast(Ljava/util/HashMap;Ljava/lang/String;II)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
