...
.method static synthetic access$800(Lcom/android/server/enterprise/certificate/CertificatePolicy;I)V
    ...
    invoke-direct {p0, p1}, Lcom/android/server/enterprise/certificate/CertificatePolicy;->sendIntentToSettings(I)V
...
.method private addListAsStringOnDatabase(ILjava/util/List;Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v0, v3, v1}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->getString(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v14, v3}, Ljava/lang/StringBuilder;->lastIndexOf(Ljava/lang/String;)I

    move-result v3

    invoke-virtual {v14, v2, v3}, Ljava/lang/StringBuilder;->substring(II)Ljava/lang/String;
    ...
    invoke-virtual {v2, v0, v3, v1, v10}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->putString(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v8, " has added the following certificates to the trusted DB: "
    ...
    const-string v8, " has added the following certificates to the untrusted DB: "
...
.method private removeListFromDatabase(ILjava/util/List;Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v14}, Lcom/android/server/enterprise/certificate/CertificatePolicy;->convertStringToList(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v2, v0, v3, v1, v12}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->putString(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v8, " has removed the following certificates from the trusted DB: "
    ...
    const-string v8, " has removed the following certificates from the untrusted DB: "
...
.method public allowUserRemoveCertificates(Landroid/app/enterprise/ContextInfo;Z)Z
    ...
    invoke-direct {p0, v1}, Lcom/android/server/enterprise/certificate/CertificatePolicy;->sendIntentToSettings(I)V
...
.method public isCaCertificateTrusted(Landroid/app/enterprise/ContextInfo;Landroid/app/enterprise/CertificateInfo;Z)Z
    ...
    const-string v4, " isCaCertificateTrusted calls from Profile return default value"
...
.method public isCertificateFailureNotificationEnabled(Landroid/app/enterprise/ContextInfo;)Z
    ...
    const-string v5, " isCertificateFailureNotificationEnabled calls from Profile return default value"
    ...
    const-string/jumbo v6, "notificateSignatureFailureToUser"

    invoke-virtual {v3, v5, v6}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->getBooleanList(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
...
.method public notifyCertificateFailure(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-static {v8, v9}, Lcom/android/server/enterprise/EnterpriseDeviceManagerService;->isManagedProfileUser(Landroid/content/Context;Landroid/app/enterprise/ContextInfo;)Z
    ...
    const-string v9, " notifyCertificateFailure calls from Profile return default value"
    ...
    invoke-direct {v1, p0, v0}, Lcom/android/server/enterprise/certificate/CertificatePolicy$3;-><init>(Lcom/android/server/enterprise/certificate/CertificatePolicy;Landroid/content/Intent;)V
...
.method public notifyCertificateRemoved(Ljava/lang/String;)V
    ...
    const-string v0, "certificate_removed_subject"
    ...
    invoke-static {v0, v2, v3}, Lcom/android/server/enterprise/content/SecContentProvider;->notifyPolicyChangesAsUser(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    const-string/jumbo v5, "has been removed."
