...
.field private mEncryptCheckReceiver:Landroid/content/BroadcastReceiver;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, v0, Lcom/android/server/MountService;->mEncryptCheckReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v2, v0, Lcom/android/server/MountService;->mPendingIntentLock:Ljava/lang/Object;
    ...
    iput-object v2, v0, Lcom/android/server/MountService;->mPendingIntent:Ljava/util/ArrayList;

    new-instance v2, Lcom/android/server/MountService$10;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Lcom/android/server/MountService$10;-><init>(Lcom/android/server/MountService;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/MountService;->mPolicyReceiver:Landroid/content/BroadcastReceiver;

    const/4 v2, 0x0

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/MountService;->mDirEncryptListner:Lcom/android/server/MountService$DirEncryptListner;

    const/4 v2, 0x0

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/MountService;->mDem:Landroid/dirEncryption/DirEncryptionManager;

    new-instance v2, Lcom/android/server/MountService$11;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Lcom/android/server/MountService$11;-><init>(Lcom/android/server/MountService;)V
    ...
    invoke-virtual {v2, v3, v11, v4, v5}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/MountService;->registerDeviceRestriction()V
    ...
    iget-object v3, v0, Lcom/android/server/MountService;->mEncryptCheckReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-direct {v14, v9, v2}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V
...
.method static synthetic access$1200(Lcom/android/server/MountService;Landroid/os/UserHandle;Z)V
    .locals 0
...
.method static synthetic access$1900(Lcom/android/server/MountService;Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    .locals 0
...
.method static synthetic access$3600(Lcom/android/server/MountService;)Ljava/lang/Object;
    .locals 1
...
.method private doUnmountVolume(Ljava/lang/String;ZZ)I
    ...
    const-string/jumbo v7, "force_and_revert"
...
.method private notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-virtual {v4, p2, v5}, Ljava/util/LinkedHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v3, v9, v4}, Lcom/android/server/MountService;->sendStorageIntent(Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    ...
    const-string/jumbo v5, "notifyVolumeStateChanged:: path = "
    ...
    const-string v5, "Removable Media Event : External SD Card Mounted"
    ...
    invoke-direct {p0, v6, v9, v0}, Lcom/android/server/MountService;->sendStorageIntent(Ljava/lang/String;Landroid/os/storage/StorageVolume;Landroid/os/UserHandle;)V
    ...
    const-string/jumbo v4, "updating volume state for media bad removal nofs and unmountable"

    invoke-static {v3, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string/jumbo v3, "unmounted"

    invoke-direct {p0, v9, v3}, Lcom/android/server/MountService;->updatePublicVolumeState(Landroid/os/storage/StorageVolume;Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "updating volume state checking"
    ...
    const-string/jumbo v4, "updating volume state mounted"
    ...
    const-string/jumbo v4, "updating volume state move mounted"

    invoke-static {v3, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string v3, "MoveMount"
    ...
    const-string v5, "Removable Media Event : USB HOST Memory Mounted"
    ...
    const-string v5, "Removable Media Event : External SD Card Unmounted"
    ...
    const-string v5, "Removable Media Event : USB HOST Memory Unmounted"
...
.method private readStorageListLocked()V
    ...
    invoke-static/range {v28 .. v28}, Landroid/util/Xml;->asAttributeSet(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;
    ...
    const-string v12, "Not Support PRIVATE MODE"
    ...
    const-string/jumbo v13, "got storage path: "
    ...
    const-string/jumbo v12, "multiple secure container volumes in storage list"
...
.method private warnOnNotMounted()V
    ...
    const-string/jumbo v3, "getSecureContainerList() called when storage not mounted"
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :try_start_0
    const-string/jumbo v23, "mObbMounts:"
    ...
    const-string/jumbo v23, "mObbPathToStateMap:"
    ...
    const-string/jumbo v23, "mVolumes:"
    ...
    const-string v25, "Current state: "
    ...
    const-string/jumbo v25, "mListeners: count = "
    ...
    :try_start_6
    const-string/jumbo v23, "mAsecMountSet: "
    ...
    const-string/jumbo v23, "mConnection:"
    ...
    const-string v23, "Last maintenance: "
...
.method public getPasswordType()I
    ...
    const-string/jumbo v7, "getpwtype"
...
.method public getSecureContainerPath(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v6, "getSecureContainerPath : (no media) return = "
...
.method public getStorageUsers(Ljava/lang/String;)[I
    ...
    const-string/jumbo v8, "getStorageUsers :: Error parsing pid %s"
    ...
    const-string/jumbo v8, "getStorageUsers :: out of bounds"
    ...
    const-string/jumbo v8, "getStorageUsers :: Failed to retrieve storage users list"
...
.method public isUsbMassStorageConnected()Z
    ...
    const-string/jumbo v3, "isUsbMassStorageConnected :: ret = "
...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    new-instance v24, Lcom/android/server/MountService$5;
    ...
    invoke-virtual/range {v24 .. v24}, Lcom/android/server/MountService$5;->start()V
...
.method public setUsbMassStorageEnabled(Z)V
    ...
    invoke-direct {p0, v3}, Lcom/android/server/MountService;->validateDeviceRestriction(Ljava/lang/String;)V
    ...
    invoke-direct {v10, p0, v8, v7, v2}, Lcom/android/server/MountService$UmsEnableCallBack;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;Z)V

    iget-object v3, p0, Lcom/android/server/MountService;->mHandler:Landroid/os/Handler;

    iget-object v4, p0, Lcom/android/server/MountService;->mHandler:Landroid/os/Handler;

    invoke-virtual {v4, v2, v10}, Landroid/os/Handler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    const-string v5, "USB Mass storage has been enabled"
    ...
    invoke-direct {p0, v8, v7, p1}, Lcom/android/server/MountService;->doShareUnshareVolume(Ljava/lang/String;Ljava/lang/String;Z)V

    invoke-direct {p0, v8}, Lcom/android/server/MountService;->doMountVolume(Ljava/lang/String;)I
    ...
    const-string v5, "USB Mass storage has been disabled"
