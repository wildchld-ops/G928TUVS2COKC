...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-wide v6, p0, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->touchDownTime:J

    iput-wide v6, p0, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->touchMoveDiffTime:J
    ...
    iput-boolean v4, p0, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->isSystemSoundChecked:Z
    ...
    invoke-direct {p0, p1, v3, v4}, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->init(Landroid/content/Context;Lcom/android/keyguard/sec/wallpaper/KeyguardWallpaperMediator$KeyguardWindowCallback;Z)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/keyguard/sec/wallpaper/KeyguardWallpaperMediator$KeyguardWindowCallback;)V
    ...
    invoke-direct {p0, p1, p2, v4}, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->init(Landroid/content/Context;Lcom/android/keyguard/sec/wallpaper/KeyguardWallpaperMediator$KeyguardWindowCallback;Z)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/keyguard/sec/wallpaper/KeyguardWallpaperMediator$KeyguardWindowCallback;Z)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->init(Landroid/content/Context;Lcom/android/keyguard/sec/wallpaper/KeyguardWallpaperMediator$KeyguardWindowCallback;Z)V
...
.method private checkSound()V
    ...
    iput-boolean v5, p0, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->isSystemSoundChecked:Z
    ...
    iput-boolean v3, p0, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->isSystemSoundChecked:Z
...
.method private init(Landroid/content/Context;Lcom/android/keyguard/sec/wallpaper/KeyguardWallpaperMediator$KeyguardWindowCallback;Z)V
    ...
    invoke-virtual {p0, v7}, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->setEffect(I)V
    ...
    iput-boolean v6, p0, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->useGPUMaxClock:Z
    ...
    :cond_0
    iput-boolean v6, p0, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->useCPUMinClock:Z
    ...
    invoke-static {v3, v7, v4, v8}, Lcom/samsung/android/visualeffect/utils/VisualEffectDVFS;->setLimit(Landroid/content/Context;III)V
...
.method private playSound(I)V
    ...
    invoke-direct {p0}, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->checkSound()V
    ...
    iget-boolean v2, p0, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->isSystemSoundChecked:Z
    ...
    iget-boolean v0, p0, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->isSystemSoundChecked:Z
...
.method protected onSizeChanged(IIII)V
    ...
    const-string v2, "WaterDroplet_Keyguard"
    ...
    iget v2, p0, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->windowHeight:I
    ...
    invoke-virtual {p0, v2, v0}, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->handleCustomEvent(ILjava/util/HashMap;)V
    ...
    iget-boolean v4, p0, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->mTouchFlagForMobileKeyboard:Z
...
.method public setContextualWallpaper(Landroid/graphics/Bitmap;)V
    ...
    const-string v4, "WaterDroplet_Keyguard"
    ...
    invoke-direct {p0, v1, v3}, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->update(Landroid/graphics/Bitmap;I)V
    ...
    :cond_2
    invoke-direct {p0, p1, v3}, Lcom/android/keyguard/sec/effect/KeyguardEffectViewWaterDroplet;->update(Landroid/graphics/Bitmap;I)V
