...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/SnowView;->mPaint:Landroid/graphics/Paint;

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/SnowView;->refresh:Z

    iput-object p1, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/SnowView;->mContext:Landroid/content/Context;

    sget v1, Lcom/android/keyguard/sec/opentheme/xmlparser/SnowView;->MAX_POOL_SIZE:I

    new-array v1, v1, [Lcom/android/keyguard/sec/opentheme/xmlparser/Snow;

    iput-object v1, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/SnowView;->mSnowPool:[Lcom/android/keyguard/sec/opentheme/xmlparser/Snow;

    iget-object v1, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/SnowView;->mPaint:Landroid/graphics/Paint;
    ...
    invoke-direct {v2, p1}, Lcom/android/keyguard/sec/opentheme/xmlparser/Snow;-><init>(Landroid/content/Context;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/SnowView;->mSnowPool:[Lcom/android/keyguard/sec/opentheme/xmlparser/Snow;
    ...
    :cond_0
    iget-boolean v4, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/SnowView;->refresh:Z
