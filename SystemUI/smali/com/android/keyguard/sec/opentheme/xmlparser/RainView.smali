...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/RainView;->list:Ljava/util/Vector;

    const/4 v2, 0x1

    iput-boolean v2, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/RainView;->refresh:Z

    new-instance v2, Landroid/graphics/Paint;

    invoke-direct {v2}, Landroid/graphics/Paint;-><init>()V

    iput-object v2, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/RainView;->mPaint:Landroid/graphics/Paint;

    iput-object p1, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/RainView;->mContext:Landroid/content/Context;

    sget v2, Lcom/android/keyguard/sec/opentheme/xmlparser/RainView;->MAX_POOL_SIZE:I

    new-array v2, v2, [Lcom/android/keyguard/sec/opentheme/xmlparser/Rain;

    iput-object v2, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/RainView;->mRainPool:[Lcom/android/keyguard/sec/opentheme/xmlparser/Rain;

    const/4 v0, 0x0

    :goto_0
    iget-object v2, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/RainView;->mRainPool:[Lcom/android/keyguard/sec/opentheme/xmlparser/Rain;
    ...
    new-instance v3, Lcom/android/keyguard/sec/opentheme/xmlparser/Rain;

    invoke-direct {v3, p1}, Lcom/android/keyguard/sec/opentheme/xmlparser/Rain;-><init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/RainView;->rainline:Landroid/graphics/Bitmap;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/RainView;->mRainPool:[Lcom/android/keyguard/sec/opentheme/xmlparser/Rain;
    ...
    :cond_0
    iget-boolean v4, p0, Lcom/android/keyguard/sec/opentheme/xmlparser/RainView;->refresh:Z
